...
- 2026-06-29 UTC Admin Docker previous MVP candidate refresh：候选 `be81398b3ade1b591122ee36a0a9566a889b1b2a` 曾作为上一轮 target，tag `admin-docker-candidate-be81398b3ade1b591122ee36a0a9566a889b1b2a` 已推送到 origin；GitHub Actions run `28361098922` 使用 `push_images=false` 成功，未推送 GHCR 镜像。该候选已被后续 `8a7939c1e8b2220d45d52c5fe329692516c32e4d` 覆盖为当前 target。
- 2026-06-29 UTC Admin Docker current MVP candidate refresh：当前候选为 `8a7939c1e8b2220d45d52c5fe329692516c32e4d`，tag `admin-docker-candidate-8a7939c1e8b2220d45d52c5fe329692516c32e4d` 已推送到 origin。GitHub Actions run `28362489637` 使用 `push_images=false` 成功，`Log in to GHCR` skipped，typecheck、searchd tests、evidence kit、Docker MVP smoke、runtime/web image build、release gate artifact 上传均通过；candidate-ref proof `docs/acceptance/artifacts/admin-docker-candidate-ref-proof-20260629T093721Z.json` accepted。当前 release inputs 使用 current/rollback `9c015b9105e97954240020781f79daae3f954bde`、target `8a7939c1e8b2220d45d52c5fe329692516c32e4d`；latest readiness `docs/acceptance/artifacts/admin-docker-release-readiness-summary-20260629T094133Z.json` 为 `13/14` pass，唯一 blocker 是显式 `push_images=true` release-owner approval。最新 release-owner runbook `docs/acceptance/artifacts/admin-docker-release-owner-runbook-20260629T094146Z.json` 为 `ready-for-release-owner-review` 且 `runbook_blockers=[]`，但 `push_execution_allowed=false`、`docker_deploy_allowed=false`、`preprocess_execution_allowed=false`、`mvp_completion_allowed=false` 仍保持关闭。未执行 `push_images=true`，未启停 NAS 容器，未推送/拉取镜像，未写 NAS runtime，未写 `PublicLibrary`，未启动预处理。
