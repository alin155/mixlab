...
更新时间：2026-06-21 / 2026-06-22 / 2026-06-28 UTC
...
- 2026-06-28 UTC 最新 GET-only live readonly：`http://192.168.1.27:18080/` 仍可达，`/api/admin/library/status` 返回 `/data/PublicLibrary`、`11394` 总视频、`10471` ready、`904` queued、`19` index-required、当前索引 `v010471`；`/api/admin/auth/status`、`/api/admin/release-gates`、`/api/admin/data-loading/plan` 仍返回 `404`，`/api/admin/dashboard/metrics` 约 `5672.9ms`，磁盘仍 `98% blocked`。证据：`docs/acceptance/artifacts/admin-docker-release-live-readonly-20260628T185228Z.json`；汇总：`docs/acceptance/artifacts/admin-docker-release-readiness-summary-20260628T185327Z.json`，`release_review_ready=false`，`docker_upload_allowed=false`。
