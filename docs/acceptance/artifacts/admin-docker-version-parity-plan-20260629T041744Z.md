...
Generated: 2026-06-29T04:17:44.578Z
...
- Artifact: docs/acceptance/artifacts/admin-docker-release-live-readonly-20260629T041744Z.json
...
admin-web-root-observed | live-evidence | pass | no | HTTP 200, ok, 68.1ms | Admin Web root must be reachable before comparing API/image parity.
admin-api-proxy-observed | live-evidence | pass | no | auth=HTTP 404, not_found 路由不存在, 29.2ms; library=HTTP 200, ok, 744.9ms; supervisor=HTTP 200, ok, 17.8ms | At least one Admin API JSON endpoint must respond through Admin Web before diagnosing image/API parity.
...
nas-disk-risk | nas-risk | pass | no | disk_status=healthy, usage_percent=65 | Free space or prove write-block behavior with live release gates before enabling preprocessing in Docker.
...
- JSON: docs/acceptance/artifacts/admin-docker-version-parity-plan-20260629T041744Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-version-parity-plan-20260629T041744Z.md
