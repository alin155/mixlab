...
Generated: 2026-06-29T15:52:20.003Z
...
- Artifact: docs/acceptance/artifacts/admin-docker-release-live-readonly-20260629T155219Z.json
...
admin-web-root-observed | live-evidence | pass | no | HTTP 200, ok, 30.3ms | Admin Web root must be reachable before comparing API/image parity.
admin-api-proxy-observed | live-evidence | pass | no | auth=HTTP 200, ok, 15.7ms; library=HTTP 200, ok, 9.7ms; supervisor=HTTP 200, ok, 9.1ms | At least one Admin API JSON endpoint must respond through Admin Web before diagnosing image/API parity.
...
version-health-parity-contract | api-contract | pass | no | version_health_parity status=ready, image_tag=5a50922bc82f1b6728f247ed33e5885ab8cf6bef. | Deploy or stage an Admin image exposing version_health_parity from /api/admin/release-gates, then rerun the GET-only live-readonly probe.
...
nas-disk-risk | nas-risk | pass | no | disk_status=healthy, usage_percent=68 | Free space or prove write-block behavior with live release gates before enabling preprocessing in Docker.
...
- JSON: docs/acceptance/artifacts/admin-docker-version-parity-plan-20260629T155220Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-version-parity-plan-20260629T155220Z.md
