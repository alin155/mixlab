...
Generated: 2026-06-27T15:37:37.321Z
...
- Base URL: http://192.168.1.27:9999/desktop
- Normalized base URL: http://192.168.1.27:9999/desktop
- Target kind: nas-desktop-url
- Safe to probe: no
- Target classification: Target path looks like the NAS desktop UI, not the Docker admin-web root.
- Target notes: A URL such as http://192.168.1.27:9999/desktop/ opens NAS desktop, not MixLab admin-web.; Use the configured Docker admin-web port from deploy/nas/mixlab/.env, commonly http://<nas-ip>:8080.
...
target-url-admin-web-shape | Target URL is the NAS Docker admin-web root | target | blocked | yes | nas-desktop-url: Target path looks like the NAS desktop UI, not the Docker admin-web root. | Set MIXLAB_ADMIN_DOCKER_LIVE_BASE_URL to the NAS Docker admin-web root, not Mac localhost, NAS desktop, or a subpath.
...
- JSON: docs/acceptance/artifacts/admin-docker-release-live-readonly-20260627T153737Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-release-live-readonly-20260627T153737Z.md
