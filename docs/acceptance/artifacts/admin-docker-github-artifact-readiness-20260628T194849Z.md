...
Generated: 2026-06-28T19:48:49.122Z
...
- Admin Docker local smoke: .local-dev/admin-docker-github-runs/28333837849/mixlab-admin-docker-release-gates/admin-docker-local-smoke-20260628T194615Z.json
- Admin Docker candidate contract proof: .local-dev/admin-docker-github-runs/28333837849/mixlab-admin-docker-release-gates/admin-docker-candidate-contract-proof-20260628T194715Z.json
- Admin Docker live read-only probe: .local-dev/admin-docker-github-runs/28333837849/mixlab-admin-docker-release-gates/admin-docker-release-live-readonly-20260628T194716Z.json
- Admin Docker version parity plan: .local-dev/admin-docker-github-runs/28333837849/mixlab-admin-docker-release-gates/admin-docker-version-parity-plan-20260628T194716Z.json
- Admin worker env proof: .local-dev/admin-docker-github-runs/28333837849/mixlab-admin-docker-release-gates/admin-worker-env-proof-20260628T194716Z.json
- Cutter compatibility proof: .local-dev/admin-docker-github-runs/28333837849/mixlab-admin-docker-release-gates/admin-cutter-compatibility-proof-20260628T194717Z.json
- Admin Docker NAS release-inputs intake: .local-dev/admin-docker-github-runs/28333837849/mixlab-admin-docker-release-gates/admin-docker-nas-release-inputs-intake-20260628T194811Z.json
- Admin Docker staging runbook: .local-dev/admin-docker-github-runs/28333837849/mixlab-admin-docker-release-gates/admin-docker-staging-runbook-20260628T194812Z.json
- Admin Docker release readiness summary: .local-dev/admin-docker-github-runs/28333837849/mixlab-admin-docker-release-gates/admin-docker-release-readiness-summary-20260628T194812Z.json

## Observations

- Local smoke: accepted, passed=true
- Smoked image tag: f9aa9bc7dea187dc3029c90389d5c3c08938dd58
- Smoked build sha: f9aa9bc7dea187dc3029c90389d5c3c08938dd58
- Candidate: ready-for-candidate-review, ready=true
- Candidate source: local-smoke-report, local_smoke_passed=true
- Candidate observed image tag: f9aa9bc7dea187dc3029c90389d5c3c08938dd58
...
| artifact-admin-docker-local-smoke-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28333837849/mixlab-admin-docker-release-gates/admin-docker-local-smoke-20260628T194615Z.json |
| artifact-admin-docker-candidate-contract-proof-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28333837849/mixlab-admin-docker-release-gates/admin-docker-candidate-contract-proof-20260628T194715Z.json |
| artifact-admin-docker-release-live-readonly-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28333837849/mixlab-admin-docker-release-gates/admin-docker-release-live-readonly-20260628T194716Z.json |
| artifact-admin-docker-version-parity-plan-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28333837849/mixlab-admin-docker-release-gates/admin-docker-version-parity-plan-20260628T194716Z.json |
| artifact-admin-worker-env-proof-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28333837849/mixlab-admin-docker-release-gates/admin-worker-env-proof-20260628T194716Z.json |
| artifact-admin-cutter-compatibility-proof-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28333837849/mixlab-admin-docker-release-gates/admin-cutter-compatibility-proof-20260628T194717Z.json |
| artifact-admin-docker-nas-release-inputs-intake-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28333837849/mixlab-admin-docker-release-gates/admin-docker-nas-release-inputs-intake-20260628T194811Z.json |
| artifact-admin-docker-staging-runbook-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28333837849/mixlab-admin-docker-release-gates/admin-docker-staging-runbook-20260628T194812Z.json |
| artifact-admin-docker-release-readiness-summary-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28333837849/mixlab-admin-docker-release-gates/admin-docker-release-readiness-summary-20260628T194812Z.json |
...
| local-smoke-build-identity-current | candidate | pass | yes | yes | yes | image_tag=f9aa9bc7dea187dc3029c90389d5c3c08938dd58, build_sha=f9aa9bc7dea187dc3029c90389d5c3c08938dd58 |
...
| candidate-build-matches-smoke | candidate | pass | yes | yes | yes | candidate.image_tag=f9aa9bc7dea187dc3029c90389d5c3c08938dd58, smoke.image_tag=f9aa9bc7dea187dc3029c90389d5c3c08938dd58, candidate.build_sha=f9aa9bc7dea187dc3029c90389d5c3c08938dd58, smoke.build_sha=f9aa9bc7dea187dc3029c90389d5c3c08938dd58 |
| target-tag-matches-smoked-image | image | pass | yes | yes | yes | target=f9aa9bc7dea187dc3029c90389d5c3c08938dd58, smoke.image_tag=f9aa9bc7dea187dc3029c90389d5c3c08938dd58, runbook.target_tag_matches_local_smoke=true |
...
- JSON: docs/acceptance/artifacts/admin-docker-github-artifact-readiness-20260628T194849Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-github-artifact-readiness-20260628T194849Z.md
