# Admin Real NAS Performance Probe 2026-06-27T07:07:36.916Z
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| health | shell | 200 | 2/2 | 3.0ms | 2.2ms | 3.0ms | 3.0ms | pass |
| auth_status | shell | 200 | 2/2 | 2.4ms | 1.0ms | 2.4ms | 2.4ms | pass |
| library_status | shell | 200 | 2/2 | 32.1ms | 6.1ms | 32.1ms | 32.1ms | pass |
| data_loading_plan | shell | 200 | 2/2 | 1.0ms | 0.7ms | 1.0ms | 1.0ms | pass |
| read_model_status | diagnostic | 200 | 2/2 | 93.3ms | 93.3ms | 95.5ms | 95.5ms | pass |
| read_model_reconcile_status | diagnostic | 200 | 2/2 | 1.6ms | 0.8ms | 1.6ms | 1.6ms | pass |
| protection_status | route | 200 | 2/2 | 1.2ms | 1.0ms | 1.2ms | 1.2ms | pass |
| release_gates | route | 200 | 2/2 | 128.4ms | 23.0ms | 128.4ms | 128.4ms | pass |
| preprocess_safety | route | 200 | 2/2 | 1.0ms | 0.5ms | 1.0ms | 1.0ms | pass |
| operations_overview | route | 200 | 2/2 | 99.5ms | 99.5ms | 99.6ms | 99.6ms | pass |
| operation_log | route | 200 | 2/2 | 23.5ms | 0.6ms | 23.5ms | 23.5ms | pass |
| source_videos_first_page | route | 200 | 2/2 | 1.3ms | 0.5ms | 1.3ms | 1.3ms | pass |
| source_videos_processing | route | 200 | 2/2 | 69.1ms | 69.1ms | 81.2ms | 81.2ms | pass |
| source_videos_index_required | route | 200 | 2/2 | 224.6ms | 224.6ms | 238.0ms | 238.0ms | pass |
| source_videos_queued | route | 200 | 2/2 | 179.3ms | 179.3ms | 183.8ms | 183.8ms | pass |
| source_videos_failed | route | 200 | 2/2 | 74.2ms | 72.0ms | 74.2ms | 74.2ms | pass |
| preprocess_jobs | route | 200 | 2/2 | 498.5ms | 486.5ms | 498.5ms | 498.5ms | pass |
| index_versions | route | 200 | 2/2 | 299.7ms | 2.0ms | 299.7ms | 299.7ms | pass |
| cutter_users | route | 200 | 2/2 | 34.1ms | 2.6ms | 34.1ms | 34.1ms | pass |
| dashboard_metrics | background | 200 | 3/3 | 1945.7ms | 2.5ms | 1945.7ms | 1945.7ms | pass |
...
| --- | --- | ---: | ---: | ---: | --- | --- | --- |
| dashboard_metrics | production_summary | 1 | 1358.0ms | 1358.0ms | admin-read-model=1 | none | none |
...
| dashboard_metrics | usage_metrics | 1 | 107.0ms | 107.0ms | admin-read-model=1 | none | none |
