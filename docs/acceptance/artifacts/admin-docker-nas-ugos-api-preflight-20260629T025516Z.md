...
Generated: 2026-06-29T02:55:16.538Z
...
| --- | --- | --- | --- | --- | --- | --- |
| desktop_html | 200 | n/a | none | html | 9.5ms | none |
| verify_is_login | 200 | 1114 | Illegal operation, unauthorized user | object(no-keys) | 14ms | none |
| current_user | 200 | 1114 | Illegal operation, unauthorized user | object(no-keys) | 15.9ms | none |
| docker_app_uid | 200 | 200 | success | object(result) | 84.8ms | none |
| docker_container_list | 200 | 9405 | none | object(no-keys) | 73.7ms | none |
| docker_container_list_v2 | 200 | 200 | success | object(originalTotal,result,total) | 240.4ms | none |
| docker_overview | 200 | 1114 | Illegal operation, unauthorized user | object(no-keys) | 154.6ms | none |
| filemgr_share_list | 200 | 1114 | Illegal operation, unauthorized user | object(no-keys) | 43.9ms | none |
| machine_common | 200 | 1114 | Illegal operation, unauthorized user | object(no-keys) | 13.4ms | none |
...
- JSON: docs/acceptance/artifacts/admin-docker-nas-ugos-api-preflight-20260629T025516Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-nas-ugos-api-preflight-20260629T025516Z.md
