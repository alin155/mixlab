...
- Admin Docker local smoke: .local-dev/admin-docker-github-runs/28338518625/mixlab-admin-docker-release-gates/admin-docker-local-smoke-20260628T224526Z.json
- Admin Docker candidate contract proof: .local-dev/admin-docker-github-runs/28338518625/mixlab-admin-docker-release-gates/admin-docker-candidate-contract-proof-20260628T224630Z.json
- Admin Docker live read-only probe: .local-dev/admin-docker-github-runs/28338518625/mixlab-admin-docker-release-gates/admin-docker-release-live-readonly-20260628T224631Z.json
- Admin Docker version parity plan: .local-dev/admin-docker-github-runs/28338518625/mixlab-admin-docker-release-gates/admin-docker-version-parity-plan-20260628T224631Z.json
- Admin worker env proof: .local-dev/admin-docker-github-runs/28338518625/mixlab-admin-docker-release-gates/admin-worker-env-proof-20260628T224632Z.json
- Cutter compatibility proof: .local-dev/admin-docker-github-runs/28338518625/mixlab-admin-docker-release-gates/admin-cutter-compatibility-proof-20260628T224632Z.json
- Admin Docker NAS release-inputs intake: .local-dev/admin-docker-github-runs/28338518625/mixlab-admin-docker-release-gates/admin-docker-nas-release-inputs-intake-20260628T224730Z.json
- Admin Docker staging runbook: .local-dev/admin-docker-github-runs/28338518625/mixlab-admin-docker-release-gates/admin-docker-staging-runbook-20260628T224730Z.json
- Admin Docker release readiness summary: .local-dev/admin-docker-github-runs/28338518625/mixlab-admin-docker-release-gates/admin-docker-release-readiness-summary-20260628T224731Z.json

## Observations

- Local smoke: accepted, passed=true
- Smoked image tag: b945418df2a447fd39bb9c88f781322594fc11c0
- Smoked build sha: b945418df2a447fd39bb9c88f781322594fc11c0
- Candidate: ready-for-candidate-review, ready=true
- Candidate source: local-smoke-report, local_smoke_passed=true
- Candidate observed image tag: b945418df2a447fd39bb9c88f781322594fc11c0
- Target image tag: b945418df2a447fd39bb9c88f781322594fc11c0
...
| artifact-admin-docker-local-smoke-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28338518625/mixlab-admin-docker-release-gates/admin-docker-local-smoke-20260628T224526Z.json |
| artifact-admin-docker-candidate-contract-proof-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28338518625/mixlab-admin-docker-release-gates/admin-docker-candidate-contract-proof-20260628T224630Z.json |
| artifact-admin-docker-release-live-readonly-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28338518625/mixlab-admin-docker-release-gates/admin-docker-release-live-readonly-20260628T224631Z.json |
| artifact-admin-docker-version-parity-plan-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28338518625/mixlab-admin-docker-release-gates/admin-docker-version-parity-plan-20260628T224631Z.json |
| artifact-admin-worker-env-proof-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28338518625/mixlab-admin-docker-release-gates/admin-worker-env-proof-20260628T224632Z.json |
| artifact-admin-cutter-compatibility-proof-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28338518625/mixlab-admin-docker-release-gates/admin-cutter-compatibility-proof-20260628T224632Z.json |
| artifact-admin-docker-nas-release-inputs-intake-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28338518625/mixlab-admin-docker-release-gates/admin-docker-nas-release-inputs-intake-20260628T224730Z.json |
| artifact-admin-docker-staging-runbook-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28338518625/mixlab-admin-docker-release-gates/admin-docker-staging-runbook-20260628T224730Z.json |
| artifact-admin-docker-release-readiness-summary-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28338518625/mixlab-admin-docker-release-gates/admin-docker-release-readiness-summary-20260628T224731Z.json |
...
| local-smoke-build-identity-current | candidate | pass | yes | yes | yes | image_tag=b945418df2a447fd39bb9c88f781322594fc11c0, build_sha=b945418df2a447fd39bb9c88f781322594fc11c0 |
...
| candidate-build-matches-smoke | candidate | pass | yes | yes | yes | candidate.image_tag=b945418df2a447fd39bb9c88f781322594fc11c0, smoke.image_tag=b945418df2a447fd39bb9c88f781322594fc11c0, candidate.build_sha=b945418df2a447fd39bb9c88f781322594fc11c0, smoke.build_sha=b945418df2a447fd39bb9c88f781322594fc11c0 |
| target-tag-matches-smoked-image | image | pass | yes | yes | yes | target=b945418df2a447fd39bb9c88f781322594fc11c0, smoke.image_tag=b945418df2a447fd39bb9c88f781322594fc11c0, runbook.target_tag_matches_local_smoke=true |
...
- JSON: docs/acceptance/artifacts/admin-docker-github-artifact-readiness-20260628T224810Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-github-artifact-readiness-20260628T224810Z.md
