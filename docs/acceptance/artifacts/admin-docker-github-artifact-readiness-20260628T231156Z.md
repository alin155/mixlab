...
- Admin Docker local smoke: .local-dev/admin-docker-github-runs/28339129475/mixlab-admin-docker-release-gates/admin-docker-local-smoke-20260628T230908Z.json
- Admin Docker candidate contract proof: .local-dev/admin-docker-github-runs/28339129475/mixlab-admin-docker-release-gates/admin-docker-candidate-contract-proof-20260628T231014Z.json
- Admin Docker live read-only probe: .local-dev/admin-docker-github-runs/28339129475/mixlab-admin-docker-release-gates/admin-docker-release-live-readonly-20260628T231014Z.json
- Admin Docker version parity plan: .local-dev/admin-docker-github-runs/28339129475/mixlab-admin-docker-release-gates/admin-docker-version-parity-plan-20260628T231014Z.json
- Admin worker env proof: .local-dev/admin-docker-github-runs/28339129475/mixlab-admin-docker-release-gates/admin-worker-env-proof-20260628T231015Z.json
- Cutter compatibility proof: .local-dev/admin-docker-github-runs/28339129475/mixlab-admin-docker-release-gates/admin-cutter-compatibility-proof-20260628T231015Z.json
- Admin Docker NAS release-inputs intake: .local-dev/admin-docker-github-runs/28339129475/mixlab-admin-docker-release-gates/admin-docker-nas-release-inputs-intake-20260628T231114Z.json
- Admin Docker staging runbook: .local-dev/admin-docker-github-runs/28339129475/mixlab-admin-docker-release-gates/admin-docker-staging-runbook-20260628T231114Z.json
- Admin Docker release readiness summary: .local-dev/admin-docker-github-runs/28339129475/mixlab-admin-docker-release-gates/admin-docker-release-readiness-summary-20260628T231115Z.json

## Observations

- Local smoke: accepted, passed=true
- Smoked image tag: 4cb5b18262e49894d4272b0fc940be6c1d2102b4
- Smoked build sha: 4cb5b18262e49894d4272b0fc940be6c1d2102b4
- Candidate: ready-for-candidate-review, ready=true
- Candidate source: local-smoke-report, local_smoke_passed=true
- Candidate observed image tag: 4cb5b18262e49894d4272b0fc940be6c1d2102b4
...
| artifact-admin-docker-local-smoke-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28339129475/mixlab-admin-docker-release-gates/admin-docker-local-smoke-20260628T230908Z.json |
| artifact-admin-docker-candidate-contract-proof-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28339129475/mixlab-admin-docker-release-gates/admin-docker-candidate-contract-proof-20260628T231014Z.json |
| artifact-admin-docker-release-live-readonly-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28339129475/mixlab-admin-docker-release-gates/admin-docker-release-live-readonly-20260628T231014Z.json |
| artifact-admin-docker-version-parity-plan-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28339129475/mixlab-admin-docker-release-gates/admin-docker-version-parity-plan-20260628T231014Z.json |
| artifact-admin-worker-env-proof-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28339129475/mixlab-admin-docker-release-gates/admin-worker-env-proof-20260628T231015Z.json |
| artifact-admin-cutter-compatibility-proof-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28339129475/mixlab-admin-docker-release-gates/admin-cutter-compatibility-proof-20260628T231015Z.json |
| artifact-admin-docker-nas-release-inputs-intake-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28339129475/mixlab-admin-docker-release-gates/admin-docker-nas-release-inputs-intake-20260628T231114Z.json |
| artifact-admin-docker-staging-runbook-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28339129475/mixlab-admin-docker-release-gates/admin-docker-staging-runbook-20260628T231114Z.json |
| artifact-admin-docker-release-readiness-summary-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28339129475/mixlab-admin-docker-release-gates/admin-docker-release-readiness-summary-20260628T231115Z.json |
...
| local-smoke-build-identity-current | candidate | pass | yes | yes | yes | image_tag=4cb5b18262e49894d4272b0fc940be6c1d2102b4, build_sha=4cb5b18262e49894d4272b0fc940be6c1d2102b4 |
...
| candidate-build-matches-smoke | candidate | pass | yes | yes | yes | candidate.image_tag=4cb5b18262e49894d4272b0fc940be6c1d2102b4, smoke.image_tag=4cb5b18262e49894d4272b0fc940be6c1d2102b4, candidate.build_sha=4cb5b18262e49894d4272b0fc940be6c1d2102b4, smoke.build_sha=4cb5b18262e49894d4272b0fc940be6c1d2102b4 |
| target-tag-matches-smoked-image | image | pass | yes | yes | yes | target=4cb5b18262e49894d4272b0fc940be6c1d2102b4, smoke.image_tag=4cb5b18262e49894d4272b0fc940be6c1d2102b4, runbook.target_tag_matches_local_smoke=true |
...
- JSON: docs/acceptance/artifacts/admin-docker-github-artifact-readiness-20260628T231156Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-github-artifact-readiness-20260628T231156Z.md
