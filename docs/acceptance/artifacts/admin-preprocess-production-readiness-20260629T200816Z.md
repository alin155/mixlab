...
Generated: 2026-06-29T20:08:16.156Z
...
- Library: root=/data/PublicLibrary, total=11394, ready=10471, queued=884, processing=0, index_required=39, current_index=v010471
...
- Windows Cutter acceptance: docs/acceptance/artifacts/windows_acceptance-20260629T194944Z-0c095293/report.json
...
| --- | --- | --- | --- | --- | --- |
admin_web_root | GET / | 200 | yes | 33.2ms | none
health | GET /health | 200 | yes | 13.5ms | none
auth_status | GET /api/admin/auth/status | 200 | yes | 7.9ms | none
library_status | GET /api/admin/library/status | 200 | yes | 6.9ms | none
release_gates | GET /api/admin/release-gates | 200 | yes | 96.4ms | none
data_loading_plan | GET /api/admin/data-loading/plan | 200 | yes | 11.9ms | none
preprocess_safety | GET /api/admin/preprocess/safety | 200 | yes | 8.6ms | none
preprocess_supervisor_status | GET /api/admin/preprocess/supervisor/status | 200 | yes | 6.0ms | none
preprocess_jobs | GET /api/admin/preprocess/jobs?limit=20 | 200 | yes | 301.2ms | none
source_videos_processing | GET /api/admin/source-videos?status=processing&limit=20 | 200 | yes | 17.1ms | none
source_videos_queued | GET /api/admin/source-videos?status=queued&limit=1 | 200 | yes | 14.4ms | none
source_videos_index_required | GET /api/admin/source-videos?status=index-required&limit=1 | 200 | yes | 13.2ms | none
runtime_settings | GET /api/admin/settings/runtime | 200 | yes | 144.9ms | none
...
queue-and-index-required-visible | library | pass | yes | yes | library queued=884, index_required=39, queued_probe=1, index_required_probe=1. | The Admin API must expose at least one queued item for the next single-video smoke and must expose index-required items without auto-publish.
...
- JSON: docs/acceptance/artifacts/admin-preprocess-production-readiness-20260629T200816Z.json
- Markdown: docs/acceptance/artifacts/admin-preprocess-production-readiness-20260629T200816Z.md
