# Admin Read Model Rebuild Plan 2026-06-27T10:45:40.980Z
...
- Disk: 634.8 GiB available / 29.0 TiB total
...
- Reason: `projection_incomplete:material_summary:missing_metadata`
...
| disk-available | pass | disk_available=634.8 GiB, minimum=1.0 GiB |
...
| projection-plan-covers-background-reconcile | pass | projection_reasons=projection_incomplete:material_summary:missing_metadata, plan_needed=true |
...
| --- | --- | ---: | --- | ---: |
| auth_status | GET /api/admin/auth/status | 200 | pass | 68.8ms |
| library_status | GET /api/admin/library/status | 200 | pass | 75.1ms |
| read_model_status | GET /api/admin/read-model/status | 200 | pass | 124.9ms |
| reconcile_status | GET /api/admin/read-model/reconcile/status | 200 | pass | 0.8ms |
| process_history_readiness | GET /api/admin/preprocess/process-history/readiness | 200 | pass | 267.9ms |
| process_history | GET /api/admin/preprocess/process-history?limit=20&window_days=30 | 200 | pass | 2879.7ms |

## Result

- Status: `passed`
- Passed: `true`
- Summary: plan-only rebuild gate passed; reason=projection_incomplete:material_summary:missing_metadata; execute separate reconcile runner if proceeding
