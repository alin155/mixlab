...
Generated: 2026-06-29T03:26:21.410Z
...
- Staging runbook: docs/acceptance/artifacts/admin-docker-staging-runbook-20260629T032537Z.json
- Release inputs: docs/acceptance/artifacts/admin-docker-release-inputs-20260629T032537Z.json
- Readiness summary: docs/acceptance/artifacts/admin-docker-release-readiness-summary-20260629T032613Z.json

## Decision Command

```sh
gh workflow run docker-admin.yml --repo alin155/mixlab --ref admin-docker-candidate-73ab7b355051d7325174111f955cd8356d42787d -f push_images=true -f current_image_tag=latest -f rollback_image_tag=latest
```
...
image-tags-present | evidence | pass | yes | yes | yes | current=latest, target=73ab7b355051d7325174111f955cd8356d42787d, rollback=latest
workflow-command-ready | release-decision | pass | yes | yes | yes | gh workflow run docker-admin.yml --repo alin155/mixlab --ref admin-docker-candidate-73ab7b355051d7325174111f955cd8356d42787d -f push_images=true -f current_image_tag=latest -f rollback_image_tag=latest
...
- If explicitly approved, run exactly: gh workflow run docker-admin.yml --repo alin155/mixlab --ref admin-docker-candidate-73ab7b355051d7325174111f955cd8356d42787d -f push_images=true -f current_image_tag=latest -f rollback_image_tag=latest
...
- JSON: docs/acceptance/artifacts/admin-docker-push-decision-package-20260629T032621Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-push-decision-package-20260629T032621Z.md
