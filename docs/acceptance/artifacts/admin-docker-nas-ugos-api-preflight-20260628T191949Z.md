...
Generated: 2026-06-28T19:19:49.356Z
...
| current_user | 200 | 1024 | Login has expired, please login again! | object(no-keys) | 14.4ms | none |
| docker_app_uid | 200 | 1024 | Login has expired, please login again! | object(no-keys) | 14.7ms | none |
| docker_container_list | 200 | 9405 | none | object(no-keys) | 28.7ms | none |
| filemgr_share_list | 200 | 1024 | Login has expired, please login again! | object(no-keys) | 28.8ms | none |
| machine_common | 200 | 1024 | Login has expired, please login again! | object(no-keys) | 16.7ms | none |
...
| ugos-auth-inputs-not-recorded | safety | pass | no | no | cookie_present=false, x_ugreen_auth_present=false, authorization_present=false; values are not written to artifacts. | n/a |
...
- JSON: docs/acceptance/artifacts/admin-docker-nas-ugos-api-preflight-20260628T191949Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-nas-ugos-api-preflight-20260628T191949Z.md
