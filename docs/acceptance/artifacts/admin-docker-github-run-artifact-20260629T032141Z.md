...
- Local HEAD: 73ab7b355051d7325174111f955cd8356d42787d
- Worktree dirty: no
- Changed paths: 0
...
- Readiness JSON: docs/acceptance/artifacts/admin-docker-github-artifact-readiness-20260629T032141Z.json
- Readiness Markdown: docs/acceptance/artifacts/admin-docker-github-artifact-readiness-20260629T032141Z.md
...
| github-run-successful | github-run | pass | yes | yes | yes | yes | yes | status=completed, conclusion=success, url=https://github.com/alin155/mixlab/actions/runs/28346369749 |
| release-gates-artifact-downloaded | artifact | pass | yes | yes | yes | yes | yes | .local-dev/admin-docker-github-runs/28346369749/mixlab-admin-docker-release-gates |
| github-artifact-readiness-generated | readiness | pass | yes | yes | yes | yes | yes | docs/acceptance/artifacts/admin-docker-github-artifact-readiness-20260629T032141Z.json |
...
| run-head-matches-current-head | source-control | pass | no | yes | no | yes | yes | run.headSha=73ab7b355051d7325174111f955cd8356d42787d, local.head=73ab7b355051d7325174111f955cd8356d42787d |
...
- JSON: docs/acceptance/artifacts/admin-docker-github-run-artifact-20260629T032141Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-github-run-artifact-20260629T032141Z.md
