# Admin Real NAS Performance Probe 2026-06-27T10:08:02.041Z
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| health | shell | 200 | 2/2 | 1.1ms | 0.9ms | 1.1ms | 1.1ms | pass |
| auth_status | shell | 200 | 2/2 | 1.2ms | 1.2ms | 2.0ms | 2.0ms | pass |
| library_status | shell | 200 | 2/2 | 26.9ms | 5.1ms | 26.9ms | 26.9ms | pass |
| data_loading_plan | shell | 200 | 2/2 | 0.9ms | 0.6ms | 0.9ms | 0.9ms | pass |
| read_model_status | diagnostic | 200 | 2/2 | 74.7ms | 74.7ms | 76.6ms | 76.6ms | pass |
| read_model_reconcile_status | diagnostic | 200 | 2/2 | 0.8ms | 0.7ms | 0.8ms | 0.8ms | pass |
| protection_status | route | 200 | 2/2 | 0.9ms | 0.7ms | 0.9ms | 0.9ms | pass |
| release_gates | route | 200 | 2/2 | 55.6ms | 20.5ms | 55.6ms | 55.6ms | pass |
| preprocess_safety | route | 200 | 2/2 | 1.4ms | 0.5ms | 1.4ms | 1.4ms | pass |
| operations_overview | route | 200 | 2/2 | 85.9ms | 85.9ms | 92.9ms | 92.9ms | pass |
| operation_log | route | 200 | 2/2 | 18.3ms | 0.5ms | 18.3ms | 18.3ms | pass |
| source_videos_first_page | route | 200 | 2/2 | 1.3ms | 0.5ms | 1.3ms | 1.3ms | pass |
| source_videos_processing | route | 200 | 2/2 | 69.1ms | 67.9ms | 69.1ms | 69.1ms | pass |
| source_videos_index_required | route | 200 | 2/2 | 189.5ms | 189.3ms | 189.5ms | 189.5ms | pass |
| source_videos_queued | route | 200 | 2/2 | 145.8ms | 144.1ms | 145.8ms | 145.8ms | pass |
| source_videos_failed | route | 200 | 2/2 | 71.2ms | 71.2ms | 74.0ms | 74.0ms | pass |
| preprocess_jobs | route | 200 | 2/2 | 410.3ms | 144.4ms | 410.3ms | 410.3ms | pass |
| index_versions | route | 200 | 2/2 | 218.9ms | 1.5ms | 218.9ms | 218.9ms | pass |
| cutter_users | route | 200 | 2/2 | 21.3ms | 2.7ms | 21.3ms | 21.3ms | pass |
| dashboard_metrics | background | 200 | 3/3 | 654.4ms | 0.6ms | 654.4ms | 654.4ms | pass |
...
| --- | --- | ---: | ---: | ---: | --- | --- | --- | --- |
| source_videos_processing | status_store_page | 2 | 67.0ms | 68.0ms | admin-read-model=2 | paged-list=2 | hit=2 | status=processing;offset=0;limit=20;manifests=0=2 |
...
| source_videos_index_required | status_store_page | 2 | 186.5ms | 187.0ms | admin-read-model=2 | paged-list=2 | hit=2 | status=index-required;offset=0;limit=20;manifests=19=2 |
...
| source_videos_queued | status_store_page | 2 | 142.0ms | 143.0ms | admin-read-model=2 | paged-list=2 | hit=2 | status=queued;offset=0;limit=20;manifests=20=2 |
...
| source_videos_failed | status_store_page | 2 | 69.5ms | 71.0ms | admin-read-model=2 | paged-list=2 | hit=2 | status=failed;offset=0;limit=20;manifests=0=2 |
...
| preprocess_jobs | runtime_load | 2 | 131.0ms | 262.0ms | runtime-telemetry=2 | no-scan=2 | not-applicable=2 | status=blocked=2 |
| preprocess_jobs | preprocess_job_page | 2 | 142.0ms | 143.0ms | admin-read-model=2 | paged-list=2 | hit=2 | offset=0;limit=20;manifests=20;snapshots=0=2 |
| preprocess_jobs | concurrency_policy | 2 | 1.0ms | 1.0ms | admin-settings=2 | no-scan=2 | not-applicable=2 | concurrency=1=2 |
...
| index_versions | index_package_validation | 1 | 167.0ms | 167.0ms | index-version-packages=1 | paged-list=1 | not-applicable=1 | versions=8;directory_ms=0;current_ms=0=1 |
| index_versions | current_pointer_fast_page | 1 | 49.0ms | 49.0ms | current-index=1 | paged-list=1 | hit=1 | offset=0;limit=8;result=hit;versions=8=1 |
| index_versions | cache_lookup | 1 | 0.0ms | 0.0ms | current-index=1 | no-scan=1 | hit=1 | offset=0;limit=8=1 |
| dashboard_metrics | production_summary | 1 | 342.0ms | 342.0ms | admin-read-model=1 | no-scan=1 | none | none |
| dashboard_metrics | material_summary | 1 | 132.0ms | 132.0ms | admin-read-model=1 | no-scan=1 | none | none |
| dashboard_metrics | usage_metrics | 1 | 99.0ms | 99.0ms | admin-read-model=1 | no-scan=1 | none | none |
| dashboard_metrics | status_summary | 1 | 70.0ms | 70.0ms | admin-read-model=1 | no-scan=1 | none | none |
| dashboard_metrics | current_index_version | 1 | 5.0ms | 5.0ms | current-index=1 | no-scan=1 | none | none |
| dashboard_metrics | library_manifest | 1 | 4.0ms | 4.0ms | library-manifest=1 | no-scan=1 | none | none |
...
| dashboard_metrics | transcript_metrics | 1 | 0.0ms | 0.0ms | current-index=1 | no-scan=1 | none | none |
