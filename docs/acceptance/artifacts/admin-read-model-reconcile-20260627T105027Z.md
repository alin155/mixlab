# Admin Read Model Reconcile 2026-06-27T10:50:27.615Z
...
| disk-available | pass | disk_available_bytes=681569394688, minimum=1073741824 |
...
| dashboard-material-projection-ready | fail | status=missing, reason=missing_metadata, requires_background_reconcile=true |
...
| --- | --- | ---: | --- | ---: |
| source_videos_index_required | GET /api/admin/source-videos?status=index-required&limit=20 | 200 | pass | 8141.7ms |
| source_videos_queued | GET /api/admin/source-videos?status=queued&limit=20 | 200 | pass | 252.6ms |
| preprocess_jobs | GET /api/admin/preprocess/jobs?limit=20 | 200 | pass | 741.1ms |
| process_history_readiness | GET /api/admin/preprocess/process-history/readiness | 200 | pass | 351.4ms |
| process_history | GET /api/admin/preprocess/process-history?limit=20&window_days=30 | 200 | pass | 3027.9ms |
