# Admin Isolated No-Repair Performance Probe 2026-06-27T14:16:40.864Z
...
- Temporary server: `127.0.0.1:60998`, health wait `489.7ms`
- Performance artifacts: `docs/acceptance/artifacts/admin-real-nas-performance-20260627T141641Z.json`, `docs/acceptance/artifacts/admin-real-nas-performance-20260627T141641Z.md`
...
| --- | ---: | ---: | ---: | ---: | --- | --- | --- | --- | --- | --- | --- |
| source_videos_processing | 2/2 | 2/2 | 87.1ms | 1000.0ms | admin-read-model=2 | paged-list=2 | hit=2 | none | none | status_store_page max 85.0ms, library_counts max 0.0ms | complete |
| source_videos_index_required | 2/2 | 2/2 | 237.8ms | 1000.0ms | admin-read-model=2 | paged-list=2 | hit=2 | none | none | status_store_page max 234.0ms, library_counts max 1.0ms | complete |
| preprocess_jobs | 2/2 | 2/2 | 472.2ms | 1000.0ms | admin-read-model=2 | status-scan=2 | hit=2 | none | none | runtime_load max 269.0ms, preprocess_job_page max 200.0ms, concurrency_policy max 4.0ms, library_counts max 0.0ms | complete |
| index_versions | 2/2 | 2/2 | 291.8ms | 1000.0ms | current-index=2 | paged-list=2 | hit=1, miss=1 | none | none | index_package_validation max 240.0ms, current_pointer_fast_page max 48.0ms, cache_lookup max 0.0ms | complete |
...
| --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- | --- | --- | --- | --- |
| dashboard_metrics | background | 3/3 | 3/3 | 460.9ms | 8000.0ms | admin-read-model=3 | no-scan=3 | hit=2, miss=1 | none | none | production_summary max 174.0ms, usage_metrics max 106.0ms, status_summary max 88.0ms, material_summary max 85.0ms, transcript_metrics max 2.0ms, current_index_version max 1.0ms, dashboard_metrics_cache max 0.0ms, library_manifest max 0.0ms, preprocess_jobs max 0.0ms, runtime_load max 0.0ms | complete |
