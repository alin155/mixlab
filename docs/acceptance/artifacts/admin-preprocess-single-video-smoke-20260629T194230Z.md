...
Generated: 2026-06-29T19:42:30.523Z
...
- Candidate before: status=queued, visible=false, size=54297057, path=王牧笛/2025年素材/20250813牧笛北大游学/视频/DJI_20250813123842_0211_D.MP4
...
- Snapshot dir: docs/acceptance/artifacts/admin-preprocess-single-video-smoke-20260629T194230Z/pre-smoke-snapshot
...
source-video-manifest | yes | .mixlab-library/videos/V000492/source-video.json | 692
preprocess-job | no | .mixlab-library/videos/V000492/preprocess-job.json | 141
preprocess-log | no | .mixlab-library/logs/V000492.log | 65
...
| --- | --- | --- | --- | --- | --- | --- |
.mixlab-library/videos/V000492/source-video.json | yes | yes | no | 828 | {"source_video_id":"V000492","preprocess_status":"index-required","visible_to_cutters":false,"transcript_path":".mixlab-library/videos/V000492/transcript.json","srt_path":".mixlab-library/videos/V000492/subtitles.srt","cover_path":"","keyframes_path":""} | none
.mixlab-library/videos/V000492/preprocess-job.json | yes | yes | no | 205 | {"source_video_id":"V000492","status":"index-required","attempt":4,"worker_id":"admin-worker-30","claimed_at":"2026-06-29T19:43:31.366Z","completed_at":"2026-06-29T19:43:38.103Z"} | none
...
| --- | --- | --- | --- | --- | --- |
auth_status | GET /api/admin/auth/status | 200 | yes | 9.3ms | none
library_status_before | GET /api/admin/library/status | 200 | yes | 7.9ms | none
preprocess_safety | GET /api/admin/preprocess/safety | 200 | yes | 1084.8ms | none
supervisor_status_before | GET /api/admin/preprocess/supervisor/status | 200 | yes | 12.8ms | none
source_videos_processing_before | GET /api/admin/source-videos?status=processing&limit=20 | 200 | yes | 14.0ms | none
source_video_before | GET /api/admin/source-videos/V000492 | 200 | yes | 9.3ms | none
supervisor_start | POST /api/admin/preprocess/supervisor/start | 200 | yes | 1297.6ms | none
supervisor_status_poll | GET /api/admin/preprocess/supervisor/status | 200 | yes | 6.8ms | none
supervisor_status_poll | GET /api/admin/preprocess/supervisor/status | 200 | yes | 10.2ms | none
supervisor_status_poll | GET /api/admin/preprocess/supervisor/status | 200 | yes | 407.2ms | none
supervisor_status_poll | GET /api/admin/preprocess/supervisor/status | 200 | yes | 14.8ms | none
supervisor_status_after | GET /api/admin/preprocess/supervisor/status | 200 | yes | 11.8ms | none
library_status_after | GET /api/admin/library/status | 200 | yes | 10.2ms | none
source_videos_processing_after | GET /api/admin/source-videos?status=processing&limit=20 | 200 | yes | 84.6ms | none
source_video_after | GET /api/admin/source-videos/V000492 | 200 | yes | 1066.7ms | none
preprocess_job_log_after | GET /api/admin/preprocess/jobs/J000492/log | 200 | yes | 13.3ms | none

## Gates

| Gate | Category | Status | Blocks Dry-run | Blocks Execute | Evidence | Required Evidence |
| --- | --- | --- | --- | --- | --- | --- |
single-video-scope-only | scope | pass | yes | yes | source_video_id=V000492. | n/a
...
candidate-is-queued-and-hidden | library | pass | yes | yes | status=queued, visible_to_cutters=false, path=王牧笛/2025年素材/20250813牧笛北大游学/视频/DJI_20250813123842_0211_D.MP4, size=54297057. | n/a
...
pre-smoke-snapshot-captured | snapshot | pass | yes | yes | Copied 5 files to docs/acceptance/artifacts/admin-preprocess-single-video-smoke-20260629T194230Z/pre-smoke-snapshot. | n/a
dry-run-does-not-post | execution | needs-follow-up | no | no | Execution mode was explicitly requested. | n/a
execute-body-is-single-target | execution | pass | no | yes | start_body={"limit":1,"source_video_id":"V000492"}. | n/a
...
post-smoke-nas-file-persistence | postcheck | pass | no | yes | status=checked, attempts=2, wait_ms=220, refresh_configured=true, refresh_attempted=true, refresh_exit=0, source=index-required, source_visible=false, job=index-required, direct_ready=10471, direct_processing=0, direct_index_required=39, api_index_required=39, direct_queued=884, no_nul=true. | n/a

## Artifacts

- JSON: docs/acceptance/artifacts/admin-preprocess-single-video-smoke-20260629T194230Z.json
- Markdown: docs/acceptance/artifacts/admin-preprocess-single-video-smoke-20260629T194230Z.md
