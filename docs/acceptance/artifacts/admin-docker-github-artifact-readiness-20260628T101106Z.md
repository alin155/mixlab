...
Generated: 2026-06-28T10:11:06.596Z
Mode: admin-docker-github-artifact-readiness
Artifact dir: .local-dev/admin-docker-github-runs/28318729283/mixlab-admin-docker-release-gates
...
- Admin Docker local smoke: .local-dev/admin-docker-github-runs/28318729283/mixlab-admin-docker-release-gates/admin-docker-local-smoke-20260628T100539Z.json
- Admin Docker candidate contract proof: .local-dev/admin-docker-github-runs/28318729283/mixlab-admin-docker-release-gates/admin-docker-candidate-contract-proof-20260628T100642Z.json
- Admin Docker live read-only probe: .local-dev/admin-docker-github-runs/28318729283/mixlab-admin-docker-release-gates/admin-docker-release-live-readonly-20260628T100643Z.json
- Admin Docker version parity plan: .local-dev/admin-docker-github-runs/28318729283/mixlab-admin-docker-release-gates/admin-docker-version-parity-plan-20260628T100643Z.json
- Admin worker env proof: .local-dev/admin-docker-github-runs/28318729283/mixlab-admin-docker-release-gates/admin-worker-env-proof-20260628T100643Z.json
- Cutter compatibility proof: .local-dev/admin-docker-github-runs/28318729283/mixlab-admin-docker-release-gates/admin-cutter-compatibility-proof-20260628T100644Z.json
- Admin Docker NAS release-inputs intake: .local-dev/admin-docker-github-runs/28318729283/mixlab-admin-docker-release-gates/admin-docker-nas-release-inputs-intake-20260628T100741Z.json
- Admin Docker staging runbook: .local-dev/admin-docker-github-runs/28318729283/mixlab-admin-docker-release-gates/admin-docker-staging-runbook-20260628T100741Z.json
- Admin Docker release readiness summary: .local-dev/admin-docker-github-runs/28318729283/mixlab-admin-docker-release-gates/admin-docker-release-readiness-summary-20260628T100742Z.json
...
| artifact-admin-docker-local-smoke-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28318729283/mixlab-admin-docker-release-gates/admin-docker-local-smoke-20260628T100539Z.json |
| artifact-admin-docker-candidate-contract-proof-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28318729283/mixlab-admin-docker-release-gates/admin-docker-candidate-contract-proof-20260628T100642Z.json |
| artifact-admin-docker-release-live-readonly-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28318729283/mixlab-admin-docker-release-gates/admin-docker-release-live-readonly-20260628T100643Z.json |
| artifact-admin-docker-version-parity-plan-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28318729283/mixlab-admin-docker-release-gates/admin-docker-version-parity-plan-20260628T100643Z.json |
| artifact-admin-worker-env-proof-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28318729283/mixlab-admin-docker-release-gates/admin-worker-env-proof-20260628T100643Z.json |
| artifact-admin-cutter-compatibility-proof-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28318729283/mixlab-admin-docker-release-gates/admin-cutter-compatibility-proof-20260628T100644Z.json |
| artifact-admin-docker-nas-release-inputs-intake-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28318729283/mixlab-admin-docker-release-gates/admin-docker-nas-release-inputs-intake-20260628T100741Z.json |
| artifact-admin-docker-staging-runbook-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28318729283/mixlab-admin-docker-release-gates/admin-docker-staging-runbook-20260628T100741Z.json |
| artifact-admin-docker-release-readiness-summary-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28318729283/mixlab-admin-docker-release-gates/admin-docker-release-readiness-summary-20260628T100742Z.json |
...
- JSON: docs/acceptance/artifacts/admin-docker-github-artifact-readiness-20260628T101106Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-github-artifact-readiness-20260628T101106Z.md
