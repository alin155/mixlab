...
Generated: 2026-06-29T19:41:14.083Z
...
- Snapshot dir: docs/acceptance/artifacts/admin-preprocess-single-video-smoke-20260629T194114Z/pre-smoke-snapshot
...
| --- | --- | --- | --- | --- | --- | --- |
.mixlab-library/videos/V000462/source-video.json | no | no | n/a | n/a | {} | none
.mixlab-library/videos/V000462/preprocess-job.json | no | no | n/a | n/a | {} | none
...
| --- | --- | --- | --- | --- | --- |
auth_status | GET /api/admin/auth/status | 200 | yes | 7.7ms | none
...
supervisor_status_before | GET /api/admin/preprocess/supervisor/status | 200 | yes | 6.3ms | none
source_videos_processing_before | GET /api/admin/source-videos?status=processing&limit=20 | 200 | yes | 13.5ms | none
source_video_before | GET /api/admin/source-videos/V000462 | 200 | yes | 21.3ms | none
...
pre-smoke-snapshot-captured | snapshot | pass | yes | yes | Copied 5 files to docs/acceptance/artifacts/admin-preprocess-single-video-smoke-20260629T194114Z/pre-smoke-snapshot. | n/a
...
- JSON: docs/acceptance/artifacts/admin-preprocess-single-video-smoke-20260629T194114Z.json
- Markdown: docs/acceptance/artifacts/admin-preprocess-single-video-smoke-20260629T194114Z.md
