# Admin Real NAS Performance Probe 2026-06-27T09:38:28.950Z
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| health | shell | 200 | 2/2 | 3.3ms | 2.4ms | 3.3ms | 3.3ms | pass |
| auth_status | shell | 200 | 2/2 | 0.9ms | 0.9ms | 1.0ms | 1.0ms | pass |
| library_status | shell | 200 | 2/2 | 25.8ms | 5.2ms | 25.8ms | 25.8ms | pass |
| data_loading_plan | shell | 200 | 2/2 | 0.9ms | 0.7ms | 0.9ms | 0.9ms | pass |
| read_model_status | diagnostic | 200 | 2/2 | 77.1ms | 75.0ms | 77.1ms | 77.1ms | pass |
| read_model_reconcile_status | diagnostic | 200 | 2/2 | 1.0ms | 0.7ms | 1.0ms | 1.0ms | pass |
| protection_status | route | 200 | 2/2 | 1.0ms | 0.6ms | 1.0ms | 1.0ms | pass |
| release_gates | route | 200 | 2/2 | 52.9ms | 20.0ms | 52.9ms | 52.9ms | pass |
| preprocess_safety | route | 200 | 2/2 | 0.9ms | 0.5ms | 0.9ms | 0.9ms | pass |
| operations_overview | route | 200 | 2/2 | 85.2ms | 85.2ms | 89.8ms | 89.8ms | pass |
| operation_log | route | 200 | 2/2 | 21.6ms | 0.5ms | 21.6ms | 21.6ms | pass |
| source_videos_first_page | route | 200 | 2/2 | 0.9ms | 0.4ms | 0.9ms | 0.9ms | pass |
| source_videos_processing | route | 200 | 2/2 | 76.8ms | 75.3ms | 76.8ms | 76.8ms | pass |
| source_videos_index_required | route | 200 | 2/2 | 224.9ms | 224.9ms | 232.0ms | 232.0ms | pass |
| source_videos_queued | route | 200 | 2/2 | 182.4ms | 182.0ms | 182.4ms | 182.4ms | pass |
| source_videos_failed | route | 200 | 2/2 | 76.1ms | 75.4ms | 76.1ms | 76.1ms | pass |
| preprocess_jobs | route | 200 | 2/2 | 490.8ms | 478.5ms | 490.8ms | 490.8ms | pass |
| index_versions | route | 200 | 2/2 | 229.0ms | 1.6ms | 229.0ms | 229.0ms | pass |
| cutter_users | route | 200 | 2/2 | 21.1ms | 2.3ms | 21.1ms | 21.1ms | pass |
| dashboard_metrics | background | 200 | 3/3 | 939.0ms | 1.6ms | 939.0ms | 939.0ms | pass |
...
| --- | --- | ---: | ---: | ---: | --- | --- | --- | --- |
| preprocess_jobs | runtime_load | 2 | 264.0ms | 266.0ms | runtime-telemetry=2 | no-scan=2 | not-applicable=2 | status=blocked=2 |
| preprocess_jobs | preprocess_job_page | 2 | 215.5ms | 222.0ms | admin-read-model=2 | paged-list=2 | hit=2 | offset=0;limit=20;manifests=20;snapshots=0=2 |
...
| index_versions | index_package_validation | 1 | 173.0ms | 173.0ms | index-version-packages=1 | paged-list=1 | not-applicable=1 | versions=8;directory_ms=0;current_ms=0=1 |
| index_versions | current_pointer_fast_page | 1 | 51.0ms | 51.0ms | current-index=1 | paged-list=1 | hit=1 | offset=0;limit=8;result=hit;versions=8=1 |
| index_versions | cache_lookup | 1 | 0.0ms | 0.0ms | current-index=1 | no-scan=1 | hit=1 | offset=0;limit=8=1 |
| dashboard_metrics | production_summary | 1 | 362.0ms | 362.0ms | admin-read-model=1 | no-scan=1 | none | none |
| dashboard_metrics | runtime_load | 1 | 259.0ms | 259.0ms | runtime-telemetry=1 | no-scan=1 | none | none |
