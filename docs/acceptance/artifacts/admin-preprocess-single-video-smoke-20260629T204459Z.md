...
Generated: 2026-06-29T20:44:59.120Z
...
- Snapshot dir: docs/acceptance/artifacts/admin-preprocess-single-video-smoke-20260629T204459Z/pre-smoke-snapshot
...
| --- | --- | --- | --- | --- | --- | --- |
.mixlab-library/videos/V002985/source-video.json | no | no | n/a | n/a | {} | none
.mixlab-library/videos/V002985/preprocess-job.json | no | no | n/a | n/a | {} | none
...
| --- | --- | --- | --- | --- | --- |
auth_status | GET /api/admin/auth/status | 200 | yes | 8.8ms | none
library_status_before | GET /api/admin/library/status | 200 | yes | 9.3ms | none
...
source_videos_processing_before | GET /api/admin/source-videos?status=processing&limit=20 | 200 | yes | 37.3ms | none
source_video_before | GET /api/admin/source-videos/V002985 | 200 | yes | 8.4ms | none
...
pre-smoke-snapshot-captured | snapshot | pass | yes | yes | Copied 5 files to docs/acceptance/artifacts/admin-preprocess-single-video-smoke-20260629T204459Z/pre-smoke-snapshot. | n/a
...
- JSON: docs/acceptance/artifacts/admin-preprocess-single-video-smoke-20260629T204459Z.json
- Markdown: docs/acceptance/artifacts/admin-preprocess-single-video-smoke-20260629T204459Z.md
