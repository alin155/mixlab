...
Generated: 2026-06-29T01:31:45.318Z
...
- Worker env proof: docs/acceptance/artifacts/admin-worker-env-proof-20260629T013145Z.json
- Cutter compatibility proof: docs/acceptance/artifacts/admin-cutter-compatibility-proof-20260628T203711Z.json
- Release inputs: docs/acceptance/artifacts/admin-docker-release-inputs-20260629T013145Z.json
- NAS disk proof: docs/acceptance/artifacts/admin-docker-nas-disk-proof-20260629T013145Z.json
...
- Release input blockers: legacy-rollback-exception-approved, nas-image-proof-accepted
...
target-tag-matches-smoked-image | input | blocked | yes | yes | target=missing, smoked_image_tags=25fe2264de7b391a56e770a8acb6bf40ebec3863, 4cb5b18262e49894d4272b0fc940be6c1d2102b4 | Set MIXLAB_DOCKER_TARGET_IMAGE_TAG to the exact image tag from the accepted local smoke or GitHub candidate artifact.
...
release-inputs-ready-for-decision | evidence | blocked | yes | yes | release input blockers: legacy-rollback-exception-approved, nas-image-proof-accepted | Provide an accepted admin-docker-release-inputs report before using it to constrain staging.
...
- JSON: docs/acceptance/artifacts/admin-docker-staging-runbook-20260629T013145Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-staging-runbook-20260629T013145Z.md
