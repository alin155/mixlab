...
Generated: 2026-06-28T22:55:30.554Z
...
| --- | --- | --- | --- | --- | --- | --- |
| desktop_html | 200 | n/a | none | html | 7.4ms | none |
| verify_is_login | 200 | 1114 | Illegal operation, unauthorized user | object(no-keys) | 12.5ms | none |
| current_user | 200 | 1114 | Illegal operation, unauthorized user | object(no-keys) | 16.8ms | none |
| docker_app_uid | 200 | 200 | success | object(result) | 16.2ms | none |
| docker_container_list | 200 | 9405 | none | object(no-keys) | 26.6ms | none |
| docker_container_list_v2 | 200 | 200 | success | object(originalTotal,result,total) | 17.4ms | none |
| docker_overview | 200 | 1114 | Illegal operation, unauthorized user | object(no-keys) | 15.2ms | none |
| filemgr_share_list | 200 | 1114 | Illegal operation, unauthorized user | object(no-keys) | 14.4ms | none |
| machine_common | 200 | 1114 | Illegal operation, unauthorized user | object(no-keys) | 14.4ms | none |
...
- JSON: docs/acceptance/artifacts/admin-docker-nas-ugos-api-preflight-20260628T225530Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-nas-ugos-api-preflight-20260628T225530Z.md
