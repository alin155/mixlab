...
Generated: 2026-06-28T18:42:08.935Z
...
- GitHub run: 28331941051
- GitHub run URL: https://github.com/alin155/mixlab/actions/runs/28331941051
- Head SHA: 97f2d513a4a27315929b4d964320d4170b4b4631
- Current worktree candidate ready: yes
- GitHub run candidate ready: yes
- Immutable candidate ref ready: no
...
- Candidate branch: codex/windows-first-run-autostart-20260615104835
- Workflow ref: admin-docker-candidate-97f2d513a4a27315929b4d964320d4170b4b4631
- Release ref setup: git tag admin-docker-candidate-97f2d513a4a27315929b4d964320d4170b4b4631 97f2d513a4a27315929b4d964320d4170b4b4631 && git push origin refs/tags/admin-docker-candidate-97f2d513a4a27315929b4d964320d4170b4b4631:refs/tags/admin-docker-candidate-97f2d513a4a27315929b4d964320d4170b4b4631
- Workflow command: gh workflow run docker-admin.yml --repo alin155/mixlab --ref admin-docker-candidate-97f2d513a4a27315929b4d964320d4170b4b4631 -f push_images=true -f current_image_tag=<current-admin-docker-image-tag> -f rollback_image_tag=<current-admin-docker-image-tag>
- Candidate ref proof command: MIXLAB_ADMIN_DOCKER_CANDIDATE_REF_SHA=97f2d513a4a27315929b4d964320d4170b4b4631 MIXLAB_ADMIN_DOCKER_CANDIDATE_REF_TAG=admin-docker-candidate-97f2d513a4a27315929b4d964320d4170b4b4631 MIXLAB_ADMIN_DOCKER_CANDIDATE_REF_RUN_ID=<tag-ref-push-images-false-run-id> MIXLAB_ADMIN_DOCKER_CANDIDATE_REF_ARTIFACT_DIR=<downloaded-tag-ref-release-gates-artifact-dir> npm run validate:admin-docker-candidate-ref-proof
...
| current-worktree-candidate-ready | candidate | pass | no | no | yes | current_worktree_candidate_ready=true, github_run_candidate_ready=true, immutable_candidate_ref_ready=false, run=https://github.com/alin155/mixlab/actions/runs/28331941051 |
...
- Before explicit push approval, create or verify the immutable release ref admin-docker-candidate-97f2d513a4a27315929b4d964320d4170b4b4631 points at candidate SHA 97f2d513a4a27315929b4d964320d4170b4b4631.
...
- After explicit approval, rerun the Admin Docker workflow with --ref admin-docker-candidate-97f2d513a4a27315929b4d964320d4170b4b4631, push_images=true, current_image_tag=<current-tag>, rollback_image_tag=<current-tag>, and target image 97f2d513a4a27315929b4d964320d4170b4b4631.
...
- JSON: docs/acceptance/artifacts/admin-docker-prestaging-handoff-20260628T184208Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-prestaging-handoff-20260628T184208Z.md
