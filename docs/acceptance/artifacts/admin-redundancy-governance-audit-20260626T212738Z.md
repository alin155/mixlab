...
Generated: 2026-06-26T21:27:38.820Z
...
fixture-fallback-legacy-hotspots-reviewed | fallbacks | blocked | yes | 21 files contain fixture/fallback/legacy/mock/deprecated/TODO terms and need classification before cleanup. | Classify each cleanup candidate as test fixture, safe fallback, legacy compatibility, or removable dead code before editing.
...
- path: apps/admin-web/src/api.ts; line_count: 3520
...
- path: apps/admin-web/src/fixtures/admin-fixture-data.ts; count: 4; terms: fixture
...
- path: apps/admin-web/src/fixtures/admin-fixture-usage-data.ts; count: 1; terms: fixture
...
- JSON: docs/acceptance/artifacts/admin-redundancy-governance-audit-20260626T212738Z.json
- Markdown: docs/acceptance/artifacts/admin-redundancy-governance-audit-20260626T212738Z.md
