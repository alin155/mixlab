...
Generated: 2026-06-28T03:25:50.204Z
...
- GitHub run: 28309646394
- GitHub run URL: https://github.com/alin155/mixlab/actions/runs/28309646394
...
- Workflow ref: admin-docker-candidate-0636039e0fc601af83b88cff9140bf2db8b6fec1
- Release ref setup: git tag admin-docker-candidate-0636039e0fc601af83b88cff9140bf2db8b6fec1 0636039e0fc601af83b88cff9140bf2db8b6fec1 && git push origin refs/tags/admin-docker-candidate-0636039e0fc601af83b88cff9140bf2db8b6fec1:refs/tags/admin-docker-candidate-0636039e0fc601af83b88cff9140bf2db8b6fec1
- Workflow command: gh workflow run docker-admin.yml --repo alin155/mixlab --ref admin-docker-candidate-0636039e0fc601af83b88cff9140bf2db8b6fec1 -f push_images=true -f current_image_tag=<current-admin-docker-image-tag> -f rollback_image_tag=<current-admin-docker-image-tag>
- Candidate ref proof command: MIXLAB_ADMIN_DOCKER_CANDIDATE_REF_SHA=0636039e0fc601af83b88cff9140bf2db8b6fec1 MIXLAB_ADMIN_DOCKER_CANDIDATE_REF_TAG=admin-docker-candidate-0636039e0fc601af83b88cff9140bf2db8b6fec1 MIXLAB_ADMIN_DOCKER_CANDIDATE_REF_RUN_ID=<tag-ref-push-images-false-run-id> MIXLAB_ADMIN_DOCKER_CANDIDATE_REF_ARTIFACT_DIR=<downloaded-tag-ref-release-gates-artifact-dir> npm run validate:admin-docker-candidate-ref-proof
...
| current-worktree-candidate-ready | candidate | pass | no | no | yes | current_worktree_candidate_ready=true, run=https://github.com/alin155/mixlab/actions/runs/28309646394 |
...
- Before explicit push approval, create or verify the immutable release ref admin-docker-candidate-0636039e0fc601af83b88cff9140bf2db8b6fec1 points at candidate SHA 0636039e0fc601af83b88cff9140bf2db8b6fec1.
...
- After explicit approval, rerun the Admin Docker workflow with --ref admin-docker-candidate-0636039e0fc601af83b88cff9140bf2db8b6fec1, push_images=true, current_image_tag=<current-tag>, rollback_image_tag=<current-tag>, and target image 0636039e0fc601af83b88cff9140bf2db8b6fec1.
...
- JSON: docs/acceptance/artifacts/admin-docker-prestaging-handoff-20260628T032550Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-prestaging-handoff-20260628T032550Z.md
