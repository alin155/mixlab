...
Generated: 2026-06-28T20:39:35.527Z
...
- GitHub run: 28335143445
- GitHub run URL: https://github.com/alin155/mixlab/actions/runs/28335143445
...
- Candidate branch: admin-docker-candidate-25fe2264de7b391a56e770a8acb6bf40ebec3863
- Workflow ref: admin-docker-candidate-25fe2264de7b391a56e770a8acb6bf40ebec3863
- Release ref setup: git tag admin-docker-candidate-25fe2264de7b391a56e770a8acb6bf40ebec3863 25fe2264de7b391a56e770a8acb6bf40ebec3863 && git push origin refs/tags/admin-docker-candidate-25fe2264de7b391a56e770a8acb6bf40ebec3863:refs/tags/admin-docker-candidate-25fe2264de7b391a56e770a8acb6bf40ebec3863
- Workflow command: gh workflow run docker-admin.yml --repo alin155/mixlab --ref admin-docker-candidate-25fe2264de7b391a56e770a8acb6bf40ebec3863 -f push_images=true -f current_image_tag=<current-admin-docker-image-tag> -f rollback_image_tag=<current-admin-docker-image-tag>
- Candidate ref proof command: MIXLAB_ADMIN_DOCKER_CANDIDATE_REF_SHA=25fe2264de7b391a56e770a8acb6bf40ebec3863 MIXLAB_ADMIN_DOCKER_CANDIDATE_REF_TAG=admin-docker-candidate-25fe2264de7b391a56e770a8acb6bf40ebec3863 MIXLAB_ADMIN_DOCKER_CANDIDATE_REF_RUN_ID=<tag-ref-push-images-false-run-id> MIXLAB_ADMIN_DOCKER_CANDIDATE_REF_ARTIFACT_DIR=<downloaded-tag-ref-release-gates-artifact-dir> npm run validate:admin-docker-candidate-ref-proof
...
| current-worktree-candidate-ready | candidate | pass | no | no | yes | current_worktree_candidate_ready=false, github_run_candidate_ready=true, immutable_candidate_ref_ready=true, run=https://github.com/alin155/mixlab/actions/runs/28335143445 |
...
- Before explicit push approval, create or verify the immutable release ref admin-docker-candidate-25fe2264de7b391a56e770a8acb6bf40ebec3863 points at candidate SHA 25fe2264de7b391a56e770a8acb6bf40ebec3863.
...
- After explicit approval, rerun the Admin Docker workflow with --ref admin-docker-candidate-25fe2264de7b391a56e770a8acb6bf40ebec3863, push_images=true, current_image_tag=<current-tag>, rollback_image_tag=<current-tag>, and target image 25fe2264de7b391a56e770a8acb6bf40ebec3863.
...
- JSON: docs/acceptance/artifacts/admin-docker-prestaging-handoff-20260628T203935Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-prestaging-handoff-20260628T203935Z.md
