...
- Parity blockers: current-admin-api-contract-parity, version-health-parity-contract, admin-worker-env-proof-contract, cutter-compatibility-proof-contract, docker-library-root-parity, admin-worker-env-external-proof, cutter-compatibility-external-proof
- Staging execution parity blockers: docker-library-root-parity
...
target-tag-matches-smoked-image | input | blocked | yes | yes | target=missing, smoked_image_tags=9c015b9105e97954240020781f79daae3f954bde, 9c015b9105e97954240020781f79daae3f954bde | Set MIXLAB_DOCKER_TARGET_IMAGE_TAG to the exact image tag from the accepted local smoke or GitHub candidate artifact.
parity-report-present | evidence | pass | no | no | docs/acceptance/artifacts/admin-docker-version-parity-plan-20260629T075922Z.json | Provide the Docker version/API parity plan artifact.
release-inputs-ready-for-decision | evidence | blocked | yes | yes | release input blockers: target-tag-differs-from-current | Provide an accepted admin-docker-release-inputs report before using it to constrain staging.
...
- JSON: docs/acceptance/artifacts/admin-docker-staging-runbook-20260629T080002Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-staging-runbook-20260629T080002Z.md
