...
Generated: 2026-06-28T00:49:37.010Z
...
- GitHub run: 28306681028
- GitHub run URL: https://github.com/alin155/mixlab/actions/runs/28306681028
...
- Workflow command: gh workflow run docker-admin.yml --repo alin155/mixlab --ref codex/windows-first-run-autostart-20260615104835 -f push_images=true -f current_image_tag=<current-admin-docker-image-tag> -f rollback_image_tag=<current-admin-docker-image-tag>
...
| current-worktree-candidate-ready | candidate | pass | no | no | yes | current_worktree_candidate_ready=true, run=https://github.com/alin155/mixlab/actions/runs/28306681028 |
...
- After explicit approval, rerun the Admin Docker workflow with push_images=true, current_image_tag=<current-tag>, rollback_image_tag=<current-tag>, and target image a7623b55d949e9798d97b608a3447e2054a9c45d.
...
- JSON: docs/acceptance/artifacts/admin-docker-prestaging-handoff-20260628T004937Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-prestaging-handoff-20260628T004937Z.md
