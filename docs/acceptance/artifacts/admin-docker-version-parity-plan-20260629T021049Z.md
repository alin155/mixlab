...
Generated: 2026-06-29T02:10:49.546Z
...
- Artifact: docs/acceptance/artifacts/admin-docker-release-live-readonly-20260629T021039Z.json
...
admin-web-root-observed | live-evidence | pass | no | HTTP 200, ok, 56.6ms | Admin Web root must be reachable before comparing API/image parity.
admin-api-proxy-observed | live-evidence | pass | no | auth=HTTP 404, not_found 路由不存在, 13.9ms; library=HTTP 200, ok, 6451.5ms; supervisor=HTTP 200, ok, 12.6ms | At least one Admin API JSON endpoint must respond through Admin Web before diagnosing image/API parity.
...
- JSON: docs/acceptance/artifacts/admin-docker-version-parity-plan-20260629T021049Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-version-parity-plan-20260629T021049Z.md
