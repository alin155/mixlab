...
Generated: 2026-06-28T21:00:52.110Z
...
- Returned dir: docs/acceptance/artifacts/admin-docker-nas-desktop-returned-evidence-20260628T210033Z/admin-docker-release-inputs
...
| --- | --- | --- | --- |
| admin-docker-current.env | yes | 24 | docs/acceptance/artifacts/admin-docker-nas-desktop-returned-evidence-20260628T210033Z/admin-docker-release-inputs/admin-docker-current.env |
| admin-docker-current.inspect.json | yes | 638 | docs/acceptance/artifacts/admin-docker-nas-desktop-returned-evidence-20260628T210033Z/admin-docker-release-inputs/admin-docker-current.inspect.json |
| admin-worker.env | yes | 109 | docs/acceptance/artifacts/admin-docker-nas-desktop-returned-evidence-20260628T210033Z/admin-docker-release-inputs/admin-worker.env |
| admin-worker.inspect.json | yes | 405 | docs/acceptance/artifacts/admin-docker-nas-desktop-returned-evidence-20260628T210033Z/admin-docker-release-inputs/admin-worker.inspect.json |
| admin-docker-disk-proof.json | yes | 989 | docs/acceptance/artifacts/admin-docker-nas-desktop-returned-evidence-20260628T210033Z/admin-docker-release-inputs/admin-docker-disk-proof.json |
| MANIFEST.txt | yes | 726 | docs/acceptance/artifacts/admin-docker-nas-desktop-returned-evidence-20260628T210033Z/admin-docker-release-inputs/MANIFEST.txt |
| README.md | yes | 815 | docs/acceptance/artifacts/admin-docker-nas-desktop-returned-evidence-20260628T210033Z/admin-docker-release-inputs/README.md |
...
| returned-dir-provided | returned-evidence | pass | no | yes | yes | yes | docs/acceptance/artifacts/admin-docker-nas-desktop-returned-evidence-20260628T210033Z/admin-docker-release-inputs |
...
- JSON: docs/acceptance/artifacts/admin-docker-nas-release-inputs-intake-20260628T210052Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-nas-release-inputs-intake-20260628T210052Z.md
