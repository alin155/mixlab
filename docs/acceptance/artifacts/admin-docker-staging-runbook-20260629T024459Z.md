...
nas-disk-proof-accepted | runtime-risk | pass | no | no | disk proof accepted: docs/acceptance/artifacts/admin-docker-nas-disk-proof-20260629T024459Z.json | Run validate:admin-docker-nas-disk-proof with sanitized NAS df evidence and require proof_accepted:true.
...
- JSON: docs/acceptance/artifacts/admin-docker-staging-runbook-20260629T024459Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-staging-runbook-20260629T024459Z.md
