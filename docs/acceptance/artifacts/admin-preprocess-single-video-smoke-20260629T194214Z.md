...
Generated: 2026-06-29T19:42:14.083Z
...
- Snapshot dir: docs/acceptance/artifacts/admin-preprocess-single-video-smoke-20260629T194214Z/pre-smoke-snapshot
...
| --- | --- | --- | --- | --- | --- | --- |
.mixlab-library/videos/V000488/source-video.json | no | no | n/a | n/a | {} | none
.mixlab-library/videos/V000488/preprocess-job.json | no | no | n/a | n/a | {} | none
...
| --- | --- | --- | --- | --- | --- |
auth_status | GET /api/admin/auth/status | 200 | yes | 8.6ms | none
library_status_before | GET /api/admin/library/status | 200 | yes | 9.1ms | none
...
source_videos_processing_before | GET /api/admin/source-videos?status=processing&limit=20 | 200 | yes | 12.7ms | none
source_video_before | GET /api/admin/source-videos/V000488 | 200 | yes | 7.9ms | none
...
pre-smoke-snapshot-captured | snapshot | pass | yes | yes | Copied 5 files to docs/acceptance/artifacts/admin-preprocess-single-video-smoke-20260629T194214Z/pre-smoke-snapshot. | n/a
...
- JSON: docs/acceptance/artifacts/admin-preprocess-single-video-smoke-20260629T194214Z.json
- Markdown: docs/acceptance/artifacts/admin-preprocess-single-video-smoke-20260629T194214Z.md
