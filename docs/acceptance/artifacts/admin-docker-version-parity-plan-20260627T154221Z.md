...
Generated: 2026-06-27T15:42:21.920Z
...
- Artifact: docs/acceptance/artifacts/admin-docker-release-live-readonly-20260627T154159Z.json
...
- Upload blockers: current-admin-api-contract-parity, version-health-parity-contract, admin-worker-env-proof-contract, cutter-compatibility-proof-contract, nas-disk-risk, admin-worker-env-external-proof, cutter-compatibility-external-proof
...
admin-web-root-observed | live-evidence | pass | no | HTTP 200, ok, 28.5ms | Admin Web root must be reachable before comparing API/image parity.
admin-api-proxy-observed | live-evidence | pass | no | auth=HTTP 404, not_found 路由不存在, 15.5ms; library=HTTP 200, ok, 1120.2ms; supervisor=HTTP 200, ok, 5.6ms | At least one Admin API JSON endpoint must respond through Admin Web before diagnosing image/API parity.
...
- JSON: docs/acceptance/artifacts/admin-docker-version-parity-plan-20260627T154221Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-version-parity-plan-20260627T154221Z.md
