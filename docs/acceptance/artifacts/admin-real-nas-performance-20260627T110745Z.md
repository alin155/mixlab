# Admin Real NAS Performance Probe 2026-06-27T11:07:45.261Z
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| health | shell | 200 | 2/2 | 1.4ms | 1.2ms | 1.4ms | 1.4ms | pass |
| auth_status | shell | 200 | 2/2 | 1.0ms | 1.0ms | 1.6ms | 1.6ms | pass |
| library_status | shell | 200 | 2/2 | 7.4ms | 5.0ms | 7.4ms | 7.4ms | pass |
| data_loading_plan | shell | 200 | 2/2 | 0.9ms | 0.6ms | 0.9ms | 0.9ms | pass |
| read_model_status | diagnostic | 200 | 2/2 | 78.0ms | 77.7ms | 78.0ms | 78.0ms | pass |
| read_model_reconcile_status | diagnostic | 200 | 2/2 | 0.6ms | 0.5ms | 0.6ms | 0.6ms | pass |
| protection_status | route | 200 | 2/2 | 0.8ms | 0.6ms | 0.8ms | 0.8ms | pass |
| release_gates | route | 200 | 2/2 | 128.7ms | 21.5ms | 128.7ms | 128.7ms | pass |
| preprocess_safety | route | 200 | 2/2 | 1.0ms | 0.5ms | 1.0ms | 1.0ms | pass |
| operations_overview | route | 200 | 2/2 | 88.6ms | 85.7ms | 88.6ms | 88.6ms | pass |
| operation_log | route | 200 | 2/2 | 22.7ms | 0.5ms | 22.7ms | 22.7ms | pass |
| source_videos_first_page | route | 200 | 2/2 | 1.1ms | 0.4ms | 1.1ms | 1.1ms | pass |
| source_videos_processing | route | 200 | 2/2 | 67.6ms | 67.6ms | 75.8ms | 75.8ms | pass |
| source_videos_index_required | route | 200 | 2/2 | 230.8ms | 227.0ms | 230.8ms | 230.8ms | pass |
| source_videos_queued | route | 200 | 2/2 | 190.4ms | 190.4ms | 192.4ms | 192.4ms | pass |
| source_videos_failed | route | 200 | 2/2 | 75.7ms | 75.7ms | 77.2ms | 77.2ms | pass |
| preprocess_jobs | route | 200 | 2/2 | 451.5ms | 198.7ms | 451.5ms | 451.5ms | pass |
| index_versions | route | 200 | 2/2 | 276.8ms | 2.2ms | 276.8ms | 276.8ms | pass |
| cutter_users | route | 200 | 2/2 | 32.7ms | 2.7ms | 32.7ms | 32.7ms | pass |
| dashboard_metrics | background | 200 | 3/3 | 433.7ms | 2.3ms | 433.7ms | 433.7ms | pass |
...
| --- | --- | ---: | ---: | ---: | --- | --- | --- | --- |
| source_videos_processing | status_store_page | 2 | 70.5ms | 74.0ms | admin-read-model=2 | paged-list=2 | hit=2 | status=processing;offset=0;limit=20;manifests=0=2 |
...
| source_videos_index_required | status_store_page | 2 | 225.5ms | 227.0ms | admin-read-model=2 | paged-list=2 | hit=2 | status=index-required;offset=0;limit=20;manifests=19=2 |
...
| source_videos_queued | status_store_page | 2 | 188.0ms | 189.0ms | admin-read-model=2 | paged-list=2 | hit=2 | status=queued;offset=0;limit=20;manifests=20=2 |
...
| source_videos_failed | status_store_page | 2 | 73.5ms | 74.0ms | admin-read-model=2 | paged-list=2 | hit=2 | status=failed;offset=0;limit=20;manifests=0=2 |
...
| preprocess_jobs | runtime_load | 2 | 130.5ms | 261.0ms | runtime-telemetry=2 | no-scan=2 | not-applicable=2 | status=blocked=2 |
| preprocess_jobs | preprocess_job_page | 2 | 189.5ms | 195.0ms | admin-read-model=2 | paged-list=2 | hit=2 | offset=0;limit=20;manifests=20;snapshots=0=2 |
...
| index_versions | index_package_validation | 1 | 234.0ms | 234.0ms | index-version-packages=1 | paged-list=1 | not-applicable=1 | versions=8;directory_ms=0;current_ms=0=1 |
...
| dashboard_metrics | production_summary | 1 | 167.0ms | 167.0ms | admin-read-model=1 | no-scan=1 | none | none |
| dashboard_metrics | usage_metrics | 1 | 117.0ms | 117.0ms | admin-read-model=1 | no-scan=1 | none | none |
| dashboard_metrics | status_summary | 1 | 77.0ms | 77.0ms | admin-read-model=1 | no-scan=1 | none | none |
| dashboard_metrics | material_summary | 1 | 66.0ms | 66.0ms | admin-read-model=1 | no-scan=1 | none | none |
