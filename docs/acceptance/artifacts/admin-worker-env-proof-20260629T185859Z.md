...
Generated: 2026-06-29T18:58:59.011Z
...
- Env file: docs/acceptance/artifacts/admin-docker-nas-ugos-returned-evidence-20260629T185832Z/admin-docker-release-inputs/admin-worker.env
- Inspect JSON: docs/acceptance/artifacts/admin-docker-nas-ugos-returned-evidence-20260629T185832Z/admin-docker-release-inputs/admin-worker.inspect.json
...
- Image: ghcr.io/alin155/mixlab-admin-runtime:7f522691369862093257c228b4fdace00e20d1fa
...
env-file-provided | evidence | pass | no | Read docs/acceptance/artifacts/admin-docker-nas-ugos-returned-evidence-20260629T185832Z/admin-docker-release-inputs/admin-worker.env. | Provide a sanitized admin-worker.env file from the NAS host containing only the required MVP worker flags.
inspect-json-provided | evidence | pass | no | Read docs/acceptance/artifacts/admin-docker-nas-ugos-returned-evidence-20260629T185832Z/admin-docker-release-inputs/admin-worker.inspect.json. | Provide sanitized docker inspect JSON for the running admin-worker container without full Config.Env secrets.
...
admin-worker-image-observed | image | pass | no | image=ghcr.io/alin155/mixlab-admin-runtime:7f522691369862093257c228b4fdace00e20d1fa, container=mixlab-server-admin-worker-1 | docker inspect evidence must include the running admin-worker image.

## Artifacts

- JSON: docs/acceptance/artifacts/admin-worker-env-proof-20260629T185859Z.json
- Markdown: docs/acceptance/artifacts/admin-worker-env-proof-20260629T185859Z.md
