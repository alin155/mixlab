...
Generated: 2026-06-26T19:46:17.136Z
...
- Upload blockers: target-url-configured, admin-web-root-live, admin-api-proxy-live, auth-context-live, runtime-path-profile-live, build-version-health, preprocess-disk, usage-events-tolerance, processing-recovery, current-index, dashboard-metrics-live, data-loading-contract-live, supervisor-status-live, admin-worker-live-flags, cutter-release-compatibility-live
...
admin-api-proxy-live | Admin API proxy reachable through Admin Web | live-admin | blocked | yes | Auth status not proven: request not run | Probe /api/admin/auth/status through the NAS admin-web proxy.
...
- JSON: docs/acceptance/artifacts/admin-docker-release-live-readonly-20260626T194617Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-release-live-readonly-20260626T194617Z.md
