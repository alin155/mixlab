...
Generated: 2026-06-28T20:37:11.593Z
...
release-version-matches-expected | windows-acceptance | blocked | yes | release_version=unknown, expected=v010471 | Set MIXLAB_CUTTER_EXPECTED_RELEASE_VERSION only when a specific staged release version must be enforced.
...
- JSON: .local-dev/admin-docker-release-gates/admin-cutter-compatibility-proof-20260628T203711Z.json
- Markdown: .local-dev/admin-docker-release-gates/admin-cutter-compatibility-proof-20260628T203711Z.md
