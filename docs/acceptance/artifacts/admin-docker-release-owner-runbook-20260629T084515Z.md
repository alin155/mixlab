...
Generated: 2026-06-29T08:45:15.043Z
...
- Readiness summary: docs/acceptance/artifacts/admin-docker-release-readiness-summary-20260629T081908Z.json
...
```sh
gh workflow run docker-admin.yml --repo alin155/mixlab --ref admin-docker-candidate-9c015b9105e97954240020781f79daae3f954bde -f push_images=true -f current_image_tag=latest -f rollback_image_tag=latest
```
...
- Staging execution ready: true
- Staging review ready: true
...
- Confirm current=latest, target=9c015b9105e97954240020781f79daae3f954bde, rollback=latest.
...
### Rollback
- Set the NAS Docker image tag back to rollback=latest.
...
readiness-ready-for-release-decision | evidence | pass | yes | yes | yes | yes | release_review_ready=true, blockers=none | Provide a release-readiness summary with release_review_ready=true and no release_review_blockers.
...
staging-runbook-ready | staging | pass | yes | yes | yes | yes | staging_execution_ready=true, staging_review_ready=true, blockers=none | Provide a staging runbook with staging_execution_ready=true, staging_review_ready=true, and no blockers.
...
image-tags-ready | rollback | pass | yes | yes | yes | yes | current=latest, target=9c015b9105e97954240020781f79daae3f954bde, rollback=latest | Current, target, and rollback image tags must be present.
workflow-command-ready | release-decision | pass | yes | yes | yes | yes | gh workflow run docker-admin.yml --repo alin155/mixlab --ref admin-docker-candidate-9c015b9105e97954240020781f79daae3f954bde -f push_images=true -f current_image_tag=latest -f rollback_image_tag=latest | Workflow command must be placeholder-free and match the accepted image tags.
...
- JSON: docs/acceptance/artifacts/admin-docker-release-owner-runbook-20260629T084515Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-release-owner-runbook-20260629T084515Z.md
