...
- NAS image proof: docs/acceptance/artifacts/admin-docker-nas-image-proof-20260629T013145Z.json
...
nas-image-proof-provided | image-proof | pass | no | yes | yes | docs/acceptance/artifacts/admin-docker-nas-image-proof-20260629T013145Z.json
...
legacy-rollback-exception-approved | release-decision | blocked | yes | yes | yes | approval=missing-or-invalid
nas-image-proof-accepted | image-proof | blocked | yes | yes | yes | proof blocked by legacy latest; exception_accepted=false
...
- Push execution blockers: legacy-rollback-exception-approved, nas-image-proof-accepted, explicit-release-approval-required
- Docker deploy blockers: handoff-staging-blockers-carried-forward, legacy-rollback-exception-approved, nas-image-proof-accepted, explicit-release-approval-required
...
- Have a release-manager role review the legacy latest rollback exception, then set MIXLAB_DOCKER_LEGACY_ROLLBACK_EXCEPTION_APPROVAL=release-manager:legacy-latest-rollback-exception=accepted only if accepted.
- Resolve release input blockers: legacy-rollback-exception-approved, nas-image-proof-accepted.
...
- JSON: docs/acceptance/artifacts/admin-docker-release-inputs-20260629T013145Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-release-inputs-20260629T013145Z.md
