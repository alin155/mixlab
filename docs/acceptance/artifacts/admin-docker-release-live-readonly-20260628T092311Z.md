...
Generated: 2026-06-28T09:23:11.960Z
...
| --- | --- | --- | --- | --- | --- |
admin_web_root | GET / | 200 | yes | 35.1ms | none
auth_status | GET /api/admin/auth/status | 404 | no | 10.1ms | not_found
library_status | GET /api/admin/library/status | 200 | yes | 702.1ms | none
release_gates | GET /api/admin/release-gates | 404 | no | 4.3ms | not_found
dashboard_metrics | GET /api/admin/dashboard/metrics | 200 | yes | 5477.7ms | none
data_loading_plan | GET /api/admin/data-loading/plan | 404 | no | 10.6ms | not_found
preprocess_supervisor_status | GET /api/admin/preprocess/supervisor/status | 200 | yes | 6.3ms | none
...
dashboard-metrics-live | Dashboard metrics read does not fail live | live-admin | pass | no | HTTP 200, 7407 bytes | n/a
...
- JSON: docs/acceptance/artifacts/admin-docker-release-live-readonly-20260628T092311Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-release-live-readonly-20260628T092311Z.md
