...
Generated: 2026-06-29T04:08:25.166Z
...
- Artifact: docs/acceptance/artifacts/admin-docker-release-live-readonly-20260629T040824Z.json
...
admin-web-root-observed | live-evidence | pass | no | HTTP 200, ok, 65.4ms | Admin Web root must be reachable before comparing API/image parity.
admin-api-proxy-observed | live-evidence | pass | no | auth=HTTP 404, not_found 路由不存在, 36.1ms; library=HTTP 200, ok, 1104.1ms; supervisor=HTTP 200, ok, 43.3ms | At least one Admin API JSON endpoint must respond through Admin Web before diagnosing image/API parity.
...
- JSON: docs/acceptance/artifacts/admin-docker-version-parity-plan-20260629T040825Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-version-parity-plan-20260629T040825Z.md
