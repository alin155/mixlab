...
Generated: 2026-06-29T19:31:38.979Z
...
- Library: root=/data/PublicLibrary, total=11394, ready=10471, queued=899, processing=0, index_required=24, current_index=v010471
...
| --- | --- | --- | --- | --- | --- |
admin_web_root | GET / | 200 | yes | 32.3ms | none
health | GET /health | 200 | yes | 13.6ms | none
auth_status | GET /api/admin/auth/status | 200 | yes | 7.6ms | none
library_status | GET /api/admin/library/status | 200 | yes | 8.5ms | none
release_gates | GET /api/admin/release-gates | 200 | yes | 86.7ms | none
...
preprocess_supervisor_status | GET /api/admin/preprocess/supervisor/status | 200 | yes | 6.1ms | none
preprocess_jobs | GET /api/admin/preprocess/jobs?limit=20 | 200 | yes | 292.8ms | none
source_videos_processing | GET /api/admin/source-videos?status=processing&limit=20 | 200 | yes | 12.2ms | none
source_videos_queued | GET /api/admin/source-videos?status=queued&limit=1 | 200 | yes | 11.1ms | none
source_videos_index_required | GET /api/admin/source-videos?status=index-required&limit=1 | 200 | yes | 10.0ms | none
runtime_settings | GET /api/admin/settings/runtime | 200 | yes | 158.7ms | none
...
queue-and-index-required-visible | library | pass | yes | yes | library queued=899, index_required=24, queued_probe=1, index_required_probe=1. | The Admin API must expose at least one queued item for the next single-video smoke and must expose index-required items without auto-publish.
...
- JSON: docs/acceptance/artifacts/admin-preprocess-production-readiness-20260629T193138Z.json
- Markdown: docs/acceptance/artifacts/admin-preprocess-production-readiness-20260629T193138Z.md
