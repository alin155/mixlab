...
Generated: 2026-06-28T02:19:33.413Z
...
- GitHub run: 28308542068
- GitHub run URL: https://github.com/alin155/mixlab/actions/runs/28308542068
...
- Workflow ref: admin-docker-candidate-71d32cd9115e9eec1ba409621c8bceaa7a47b070
- Release ref setup: git tag admin-docker-candidate-71d32cd9115e9eec1ba409621c8bceaa7a47b070 71d32cd9115e9eec1ba409621c8bceaa7a47b070 && git push origin refs/tags/admin-docker-candidate-71d32cd9115e9eec1ba409621c8bceaa7a47b070:refs/tags/admin-docker-candidate-71d32cd9115e9eec1ba409621c8bceaa7a47b070
- Workflow command: gh workflow run docker-admin.yml --repo alin155/mixlab --ref admin-docker-candidate-71d32cd9115e9eec1ba409621c8bceaa7a47b070 -f push_images=true -f current_image_tag=<current-admin-docker-image-tag> -f rollback_image_tag=<current-admin-docker-image-tag>
- Candidate ref proof command: MIXLAB_ADMIN_DOCKER_CANDIDATE_REF_SHA=71d32cd9115e9eec1ba409621c8bceaa7a47b070 MIXLAB_ADMIN_DOCKER_CANDIDATE_REF_TAG=admin-docker-candidate-71d32cd9115e9eec1ba409621c8bceaa7a47b070 MIXLAB_ADMIN_DOCKER_CANDIDATE_REF_RUN_ID=<tag-ref-push-images-false-run-id> MIXLAB_ADMIN_DOCKER_CANDIDATE_REF_ARTIFACT_DIR=<downloaded-tag-ref-release-gates-artifact-dir> npm run validate:admin-docker-candidate-ref-proof
...
| current-worktree-candidate-ready | candidate | pass | no | no | yes | current_worktree_candidate_ready=true, run=https://github.com/alin155/mixlab/actions/runs/28308542068 |
...
- Before explicit push approval, create or verify the immutable release ref admin-docker-candidate-71d32cd9115e9eec1ba409621c8bceaa7a47b070 points at candidate SHA 71d32cd9115e9eec1ba409621c8bceaa7a47b070.
...
- After explicit approval, rerun the Admin Docker workflow with --ref admin-docker-candidate-71d32cd9115e9eec1ba409621c8bceaa7a47b070, push_images=true, current_image_tag=<current-tag>, rollback_image_tag=<current-tag>, and target image 71d32cd9115e9eec1ba409621c8bceaa7a47b070.
...
- JSON: docs/acceptance/artifacts/admin-docker-prestaging-handoff-20260628T021933Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-prestaging-handoff-20260628T021933Z.md
