...
Generated: 2026-06-27T16:14:07.708Z
...
- API base URL: http://127.0.0.1:3898
- API normalized base URL: http://127.0.0.1:3898
...
- Build: sha local-split-candidate, version local-split-candidate, image tag mixlab-admin:local-split-candidate
- Release gates: overall blocked, allowed false
...
| --- | --- | --- | --- | --- | --- | --- | --- |
admin_web_root | web | http://127.0.0.1:5176 | GET / | 200 | yes | 24.3ms | none
auth_status | api | http://127.0.0.1:3898 | GET /api/admin/auth/status | 200 | yes | 42.2ms | none
library_status | api | http://127.0.0.1:3898 | GET /api/admin/library/status | 200 | yes | 74.1ms | none
release_gates | api | http://127.0.0.1:3898 | GET /api/admin/release-gates | 200 | yes | 145.4ms | none
data_loading_plan | api | http://127.0.0.1:3898 | GET /api/admin/data-loading/plan | 200 | yes | 2.4ms | none
...
candidate-admin-web-root | candidate-api | pass | no | yes | HTTP 200, ok, 24.3ms | GET / must return an Admin Web response from the candidate target.
...
- JSON: docs/acceptance/artifacts/admin-docker-candidate-contract-proof-20260627T161407Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-candidate-contract-proof-20260627T161407Z.md
