# Admin Read Model Reconcile 2026-06-25T23:02:41.989Z
...
| disk-available | pass | disk_available_bytes=674124193792, minimum=1073741824 |
...
| --- | --- | ---: | --- | ---: |
| source_videos_index_required | GET /api/admin/source-videos?status=index-required&limit=20 | 200 | pass | 536.9ms |
| source_videos_queued | GET /api/admin/source-videos?status=queued&limit=20 | 200 | pass | 1471.9ms |
| preprocess_jobs | GET /api/admin/preprocess/jobs?limit=20 | 200 | pass | 1744.6ms |

## Result

- Status: `passed`
- Passed: `true`
- Summary: admin.sqlite was already fresh and safe for page requests.
