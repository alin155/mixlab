...
Generated: 2026-06-29T09:13:24.953Z
...
- Admin Docker local smoke: .local-dev/admin-docker-github-runs/28361098922/mixlab-admin-docker-release-gates/admin-docker-local-smoke-20260629T091051Z.json
- Admin Docker candidate contract proof: .local-dev/admin-docker-github-runs/28361098922/mixlab-admin-docker-release-gates/admin-docker-candidate-contract-proof-20260629T091155Z.json
- Admin Docker live read-only probe: .local-dev/admin-docker-github-runs/28361098922/mixlab-admin-docker-release-gates/admin-docker-release-live-readonly-20260629T091156Z.json
- Admin Docker version parity plan: .local-dev/admin-docker-github-runs/28361098922/mixlab-admin-docker-release-gates/admin-docker-version-parity-plan-20260629T091156Z.json
- Admin worker env proof: .local-dev/admin-docker-github-runs/28361098922/mixlab-admin-docker-release-gates/admin-worker-env-proof-20260629T091157Z.json
- Cutter compatibility proof: .local-dev/admin-docker-github-runs/28361098922/mixlab-admin-docker-release-gates/admin-cutter-compatibility-proof-20260629T091157Z.json
- Admin Docker NAS release-inputs intake: .local-dev/admin-docker-github-runs/28361098922/mixlab-admin-docker-release-gates/admin-docker-nas-release-inputs-intake-20260629T091256Z.json
- Admin Docker staging runbook: .local-dev/admin-docker-github-runs/28361098922/mixlab-admin-docker-release-gates/admin-docker-staging-runbook-20260629T091257Z.json
- Admin Docker release readiness summary: .local-dev/admin-docker-github-runs/28361098922/mixlab-admin-docker-release-gates/admin-docker-release-readiness-summary-20260629T091257Z.json

## Observations

- Local smoke: accepted, passed=true
- Smoked image tag: be81398b3ade1b591122ee36a0a9566a889b1b2a
- Smoked build sha: be81398b3ade1b591122ee36a0a9566a889b1b2a
- Candidate: ready-for-candidate-review, ready=true
- Candidate source: local-smoke-report, local_smoke_passed=true
- Candidate observed image tag: be81398b3ade1b591122ee36a0a9566a889b1b2a
...
| artifact-admin-docker-local-smoke-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28361098922/mixlab-admin-docker-release-gates/admin-docker-local-smoke-20260629T091051Z.json |
| artifact-admin-docker-candidate-contract-proof-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28361098922/mixlab-admin-docker-release-gates/admin-docker-candidate-contract-proof-20260629T091155Z.json |
| artifact-admin-docker-release-live-readonly-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28361098922/mixlab-admin-docker-release-gates/admin-docker-release-live-readonly-20260629T091156Z.json |
| artifact-admin-docker-version-parity-plan-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28361098922/mixlab-admin-docker-release-gates/admin-docker-version-parity-plan-20260629T091156Z.json |
| artifact-admin-worker-env-proof-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28361098922/mixlab-admin-docker-release-gates/admin-worker-env-proof-20260629T091157Z.json |
| artifact-admin-cutter-compatibility-proof-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28361098922/mixlab-admin-docker-release-gates/admin-cutter-compatibility-proof-20260629T091157Z.json |
| artifact-admin-docker-nas-release-inputs-intake-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28361098922/mixlab-admin-docker-release-gates/admin-docker-nas-release-inputs-intake-20260629T091256Z.json |
| artifact-admin-docker-staging-runbook-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28361098922/mixlab-admin-docker-release-gates/admin-docker-staging-runbook-20260629T091257Z.json |
| artifact-admin-docker-release-readiness-summary-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28361098922/mixlab-admin-docker-release-gates/admin-docker-release-readiness-summary-20260629T091257Z.json |
...
| local-smoke-build-identity-current | candidate | pass | yes | yes | yes | image_tag=be81398b3ade1b591122ee36a0a9566a889b1b2a, build_sha=be81398b3ade1b591122ee36a0a9566a889b1b2a |
...
| candidate-build-matches-smoke | candidate | pass | yes | yes | yes | candidate.image_tag=be81398b3ade1b591122ee36a0a9566a889b1b2a, smoke.image_tag=be81398b3ade1b591122ee36a0a9566a889b1b2a, candidate.build_sha=be81398b3ade1b591122ee36a0a9566a889b1b2a, smoke.build_sha=be81398b3ade1b591122ee36a0a9566a889b1b2a |
| target-tag-matches-smoked-image | image | pass | yes | yes | yes | target=be81398b3ade1b591122ee36a0a9566a889b1b2a, smoke.image_tag=be81398b3ade1b591122ee36a0a9566a889b1b2a, runbook.target_tag_matches_local_smoke=true |
...
- JSON: docs/acceptance/artifacts/admin-docker-github-artifact-readiness-20260629T091324Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-github-artifact-readiness-20260629T091324Z.md
