...
Generated: 2026-06-27T15:58:35.266Z
...
- Docker upload blockers: candidate-target-configured, candidate-target-shape, candidate-admin-web-root, candidate-current-admin-api-contract, candidate-version-health-contract, candidate-disk-protection-contract, candidate-usage-events-repair-contract, candidate-processing-recovery-contract, candidate-admin-worker-env-proof-contract, candidate-cutter-compatibility-proof-contract
...
- JSON: docs/acceptance/artifacts/admin-docker-candidate-contract-proof-20260627T155835Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-candidate-contract-proof-20260627T155835Z.md
