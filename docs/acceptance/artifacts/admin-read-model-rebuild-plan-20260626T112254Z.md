# Admin Read Model Rebuild Plan 2026-06-26T11:22:54.827Z
...
| --- | --- | ---: | --- | ---: |
| auth_status | GET /api/admin/auth/status | 200 | pass | 205.0ms |
| library_status | GET /api/admin/library/status | 200 | pass | 35.5ms |
| read_model_status | GET /api/admin/read-model/status | 200 | pass | 82.3ms |
| reconcile_status | GET /api/admin/read-model/reconcile/status | 200 | pass | 2.1ms |
| process_history_readiness | GET /api/admin/preprocess/process-history/readiness | 200 | pass | 285.2ms |
| process_history | GET /api/admin/preprocess/process-history?limit=20&window_days=30 | 200 | pass | 2912.3ms |
