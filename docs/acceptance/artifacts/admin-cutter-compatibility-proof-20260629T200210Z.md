...
Generated: 2026-06-29T20:02:10.160Z
...
- Real cut report: docs/acceptance/artifacts/real_cut_smoke-20260629T200145Z-3f3a86d2/report.json
- Real cut supplement report: not provided
...
- Real cut: status=passed, run_next=done, completion=done, supplement=not provided, output=export-clips/E000051/001-Windows验收剪切-20260629200145-C0728.mp4
...
real-cut-report-provided | input | pass | no | docs/acceptance/artifacts/real_cut_smoke-20260629T200145Z-3f3a86d2/report.json | Provide an archived real_cut_smoke report.json for the same staged candidate.
real-cut-smoke-passed | real-cut | pass | no | status=passed, cut_job_id=CJ20260629-0004, supplement_status=unknown | Run Windows Runner real_cut_smoke and require status=passed, or attach desktop_incident_diagnostics proving the same cut_job_id reached done after an asynchronous queue drain.
real-cut-output-produced | real-cut | pass | no | completion_status=done, output_file=export-clips/E000051/001-Windows验收剪切-20260629200145-C0728.mp4 | real_cut_smoke or its accepted completion supplement must prove status=done and produce an output_file.
...
- JSON: docs/acceptance/artifacts/admin-cutter-compatibility-proof-20260629T200210Z.json
- Markdown: docs/acceptance/artifacts/admin-cutter-compatibility-proof-20260629T200210Z.md
