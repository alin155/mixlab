...
Generated: 2026-06-26T21:41:20.214Z
...
fixture-fallback-legacy-hotspots-reviewed | fallbacks | blocked | yes | 22 files contain fixture/fallback/legacy/mock/deprecated/TODO terms and need classification before cleanup. | Classify each cleanup candidate as test fixture, safe fallback, legacy compatibility, or removable dead code before editing.
...
- path: apps/admin-web/src/api.ts; line_count: 3139
...
- path: apps/admin-web/src/api.ts; count: 22; terms: fixture, fallback
...
- path: apps/admin-web/src/fixtures/admin-fixture-data.ts; count: 7; terms: fixture
...
- JSON: docs/acceptance/artifacts/admin-redundancy-governance-audit-20260626T214120Z.json
- Markdown: docs/acceptance/artifacts/admin-redundancy-governance-audit-20260626T214120Z.md
