# Admin Real NAS Performance Probe 2026-06-27T14:01:23.046Z
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| health | shell | 200 | 2/2 | 2.3ms | 1.6ms | 2.3ms | 2.3ms | pass |
| auth_status | shell | 200 | 2/2 | 1.9ms | 0.9ms | 1.9ms | 1.9ms | pass |
| library_status | shell | 200 | 2/2 | 28.8ms | 5.7ms | 28.8ms | 28.8ms | pass |
| data_loading_plan | shell | 200 | 2/2 | 0.9ms | 0.6ms | 0.9ms | 0.9ms | pass |
| read_model_status | diagnostic | 200 | 2/2 | 92.6ms | 91.4ms | 92.6ms | 92.6ms | pass |
...
| release_gates | route | 200 | 2/2 | 138.8ms | 23.1ms | 138.8ms | 138.8ms | pass |
| preprocess_safety | route | 200 | 2/2 | 1.1ms | 0.5ms | 1.1ms | 1.1ms | pass |
| operations_overview | route | 200 | 2/2 | 101.6ms | 101.6ms | 106.2ms | 106.2ms | pass |
| operation_log | route | 200 | 2/2 | 29.7ms | 0.6ms | 29.7ms | 29.7ms | pass |
| source_videos_first_page | route | 200 | 2/2 | 1.4ms | 0.5ms | 1.4ms | 1.4ms | pass |
| source_videos_processing | route | 200 | 2/2 | 80.7ms | 80.7ms | 81.5ms | 81.5ms | pass |
| source_videos_index_required | route | 200 | 2/2 | 229.1ms | 229.1ms | 230.5ms | 230.5ms | pass |
| source_videos_queued | route | 200 | 2/2 | 196.6ms | 196.2ms | 196.6ms | 196.6ms | pass |
| source_videos_failed | route | 200 | 2/2 | 89.9ms | 88.2ms | 89.9ms | 89.9ms | pass |
| preprocess_jobs | route | 200 | 2/2 | 447.0ms | 197.9ms | 447.0ms | 447.0ms | pass |
| index_versions | route | 200 | 2/2 | 286.2ms | 1.9ms | 286.2ms | 286.2ms | pass |
| cutter_users | route | 200 | 2/2 | 28.1ms | 2.6ms | 28.1ms | 28.1ms | pass |
| dashboard_metrics | background | 200 | 3/3 | 440.3ms | 2.5ms | 440.3ms | 440.3ms | pass |
...
| dashboard_metrics | 3/3 | admin-read-model=3 | status-scan=3 | hit=2, miss=1 | none | none | 0 |

## Runtime Component Timing Summary

| endpoint | component | samples | avg | max | data source | scan mode | cache status | detail |
| --- | --- | ---: | ---: | ---: | --- | --- | --- | --- |
| source_videos_processing | status_store_page | 2 | 79.0ms | 79.0ms | admin-read-model=2 | paged-list=2 | hit=2 | status=processing;offset=0;limit=20;manifests=0=2 |
| source_videos_processing | library_counts | 2 | 0.5ms | 1.0ms | library-manifest=2 | no-scan=2 | not-applicable=2 | video_count=11394;status=processing;offset=0;limit=20=2 |
| source_videos_index_required | status_store_page | 2 | 226.5ms | 227.0ms | admin-read-model=2 | paged-list=2 | hit=2 | status=index-required;offset=0;limit=20;manifests=19=2 |
...
| source_videos_queued | status_store_page | 2 | 192.5ms | 193.0ms | admin-read-model=2 | paged-list=2 | hit=2 | status=queued;offset=0;limit=20;manifests=20=2 |
...
| source_videos_failed | status_store_page | 2 | 86.0ms | 87.0ms | admin-read-model=2 | paged-list=2 | hit=2 | status=failed;offset=0;limit=20;manifests=0=2 |
...
| preprocess_jobs | runtime_load | 2 | 129.5ms | 259.0ms | runtime-telemetry=2 | no-scan=2 | not-applicable=2 | status=blocked=2 |
| preprocess_jobs | preprocess_job_page | 2 | 188.0ms | 195.0ms | admin-read-model=2 | paged-list=2 | hit=2 | offset=0;limit=20;manifests=20;snapshots=0=2 |
...
| dashboard_metrics | production_summary | 1 | 166.0ms | 166.0ms | admin-read-model=1 | no-scan=1 | none | none |
| dashboard_metrics | usage_metrics | 1 | 99.0ms | 99.0ms | admin-read-model=1 | no-scan=1 | none | none |
| dashboard_metrics | status_summary | 1 | 86.0ms | 86.0ms | admin-read-model=1 | no-scan=1 | none | none |
| dashboard_metrics | material_summary | 1 | 83.0ms | 83.0ms | admin-read-model=1 | no-scan=1 | none | none |
| dashboard_metrics | current_index_version | 1 | 1.0ms | 1.0ms | current-index=1 | no-scan=1 | none | none |
| dashboard_metrics | library_manifest | 1 | 1.0ms | 1.0ms | library-manifest=1 | no-scan=1 | none | none |
