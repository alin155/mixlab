...
Generated: 2026-06-27T16:02:18.725Z
...
- Staging runbook: docs/acceptance/artifacts/admin-docker-staging-runbook-20260627T160217Z.json
...
- Staging ready: false; blockers: current-image-tag-provided, target-image-tag-provided, rollback-image-tag-provided, target-differs-from-current, rollback-tag-matches-current, parity-report-blockers-clear, candidate-contract-proof-accepted, worker-env-proof-accepted, cutter-compatibility-proof-accepted
...
staging-runbook-ready | runbook | blocked | yes | staging blockers: current-image-tag-provided, target-image-tag-provided, rollback-image-tag-provided, target-differs-from-current, rollback-tag-matches-current, parity-report-blockers-clear, candidate-contract-proof-accepted, worker-env-proof-accepted, cutter-compatibility-proof-accepted | Regenerate the staging runbook after explicit tags and evidence gates are satisfied.
...
- JSON: docs/acceptance/artifacts/admin-docker-release-readiness-summary-20260627T160218Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-release-readiness-summary-20260627T160218Z.md
