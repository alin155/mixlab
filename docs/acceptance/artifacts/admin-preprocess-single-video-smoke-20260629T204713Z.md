...
Generated: 2026-06-29T20:47:13.656Z
...
- Candidate before: status=queued, visible=false, size=10999356, path=陶矜2/2023年素材/2311北京/17号视频/Clip/XDROOT/Clip/383_0677.Mp4
...
- Snapshot dir: docs/acceptance/artifacts/admin-preprocess-single-video-smoke-20260629T204713Z/pre-smoke-snapshot
...
source-video-manifest | yes | .mixlab-library/videos/V005104/source-video.json | 649
preprocess-job | no | .mixlab-library/videos/V005104/preprocess-job.json | 141
preprocess-log | no | .mixlab-library/logs/V005104.log | 65
...
| --- | --- | --- | --- | --- | --- | --- |
.mixlab-library/videos/V005104/source-video.json | yes | yes | yes | 787 | {"source_video_id":"V005104","preprocess_status":"queued","visible_to_cutters":false,"transcript_path":"","srt_path":"","cover_path":"","keyframes_path":""} | none
.mixlab-library/videos/V005104/preprocess-job.json | yes | yes | yes | 205 | {"source_video_id":"V005104","status":"queued","attempt":3,"worker_id":"admin","claimed_at":"2026-06-24T12:49:15.282Z"} | none
...
| --- | --- | --- | --- | --- | --- |
auth_status | GET /api/admin/auth/status | 200 | yes | 16.1ms | none
library_status_before | GET /api/admin/library/status | 200 | yes | 15.1ms | none
preprocess_safety | GET /api/admin/preprocess/safety | 200 | yes | 1248.2ms | none
supervisor_status_before | GET /api/admin/preprocess/supervisor/status | 200 | yes | 9.4ms | none
source_videos_processing_before | GET /api/admin/source-videos?status=processing&limit=20 | 200 | yes | 16.5ms | none
source_video_before | GET /api/admin/source-videos/V005104 | 200 | yes | 8.7ms | none
supervisor_start | POST /api/admin/preprocess/supervisor/start | 200 | yes | 1174.4ms | none
supervisor_status_poll | GET /api/admin/preprocess/supervisor/status | 200 | yes | 5.7ms | none
supervisor_status_poll | GET /api/admin/preprocess/supervisor/status | 200 | yes | 8.9ms | none
supervisor_status_poll | GET /api/admin/preprocess/supervisor/status | 200 | yes | 9.0ms | none
supervisor_status_poll | GET /api/admin/preprocess/supervisor/status | 200 | yes | 7.5ms | none
supervisor_status_poll | GET /api/admin/preprocess/supervisor/status | 200 | yes | 10.9ms | none
supervisor_status_poll | GET /api/admin/preprocess/supervisor/status | 200 | yes | 9.5ms | none
...
source_videos_processing_after | GET /api/admin/source-videos?status=processing&limit=20 | 200 | yes | 93.6ms | none
source_video_after | GET /api/admin/source-videos/V005104 | 200 | yes | 1110.4ms | none
preprocess_job_log_after | GET /api/admin/preprocess/jobs/J005104/log | 200 | yes | 9.9ms | none

## Gates

| Gate | Category | Status | Blocks Dry-run | Blocks Execute | Evidence | Required Evidence |
| --- | --- | --- | --- | --- | --- | --- |
single-video-scope-only | scope | pass | yes | yes | source_video_id=V005104. | n/a
...
candidate-is-queued-and-hidden | library | pass | yes | yes | status=queued, visible_to_cutters=false, path=陶矜2/2023年素材/2311北京/17号视频/Clip/XDROOT/Clip/383_0677.Mp4, size=10999356. | n/a
...
pre-smoke-snapshot-captured | snapshot | pass | yes | yes | Copied 5 files to docs/acceptance/artifacts/admin-preprocess-single-video-smoke-20260629T204713Z/pre-smoke-snapshot. | n/a
dry-run-does-not-post | execution | needs-follow-up | no | no | Execution mode was explicitly requested. | n/a
execute-body-is-single-target | execution | pass | no | yes | start_body={"limit":1,"source_video_id":"V005104"}. | n/a
...
post-smoke-nas-file-persistence | postcheck | needs-follow-up | no | no | status=checked, attempts=11, wait_ms=30025, refresh_configured=false, refresh_attempted=false, refresh_exit=null, source=queued, source_visible=false, job=queued, direct_ready=10471, direct_processing=0, direct_index_required=42, api_index_required=46, direct_queued=881, no_nul=false, diagnosis=smb-stale-post-file-view-suspected, stale_policy_enabled=true. | API and supervisor evidence passed, but the long-running Mac SMB file view looked stale. Run a fresh-process or container-side NAS file check before increasing batch size.

## Artifacts

- JSON: docs/acceptance/artifacts/admin-preprocess-single-video-smoke-20260629T204713Z.json
- Markdown: docs/acceptance/artifacts/admin-preprocess-single-video-smoke-20260629T204713Z.md
