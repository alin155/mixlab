...
Generated: 2026-06-29T19:50:45.367Z
...
| --- | --- | --- | --- | --- | --- |
admin_web_root | GET / | 200 | yes | 31.0ms | none
health | GET /health | 200 | yes | 12.1ms | none
auth_status | GET /api/admin/auth/status | 200 | yes | 6.4ms | none
library_status | GET /api/admin/library/status | 200 | yes | 7.2ms | none
release_gates | GET /api/admin/release-gates | 200 | yes | 70.0ms | none
data_loading_plan | GET /api/admin/data-loading/plan | 200 | yes | 9.1ms | none
preprocess_safety | GET /api/admin/preprocess/safety | 200 | yes | 6.2ms | none
preprocess_supervisor_status | GET /api/admin/preprocess/supervisor/status | 200 | yes | 5.3ms | none
preprocess_jobs | GET /api/admin/preprocess/jobs?limit=20 | 200 | yes | 36.3ms | none
source_videos_processing | GET /api/admin/source-videos?status=processing&limit=20 | 200 | yes | 13.3ms | none
source_videos_queued | GET /api/admin/source-videos?status=queued&limit=1 | 200 | yes | 13.5ms | none
source_videos_index_required | GET /api/admin/source-videos?status=index-required&limit=1 | 200 | yes | 12.6ms | none
runtime_settings | GET /api/admin/settings/runtime | 200 | yes | 143.0ms | none
...
- JSON: docs/acceptance/artifacts/admin-preprocess-production-readiness-20260629T195045Z.json
- Markdown: docs/acceptance/artifacts/admin-preprocess-production-readiness-20260629T195045Z.md
