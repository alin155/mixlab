...
Generated: 2026-06-29T19:25:34.300Z
...
- Library: root=/data/PublicLibrary, total=11394, ready=10471, queued=900, processing=0, index_required=23, current_index=v010471
...
| --- | --- | --- | --- | --- | --- |
admin_web_root | GET / | 200 | yes | 68.5ms | none
health | GET /health | 200 | yes | 13.0ms | none
auth_status | GET /api/admin/auth/status | 200 | yes | 8.1ms | none
library_status | GET /api/admin/library/status | 200 | yes | 10.2ms | none
release_gates | GET /api/admin/release-gates | 200 | yes | 81.0ms | none
data_loading_plan | GET /api/admin/data-loading/plan | 200 | yes | 13.5ms | none
...
preprocess_jobs | GET /api/admin/preprocess/jobs?limit=20 | 200 | yes | 286.8ms | none
source_videos_processing | GET /api/admin/source-videos?status=processing&limit=20 | 200 | yes | 13.3ms | none
source_videos_queued | GET /api/admin/source-videos?status=queued&limit=1 | 200 | yes | 11.4ms | none
source_videos_index_required | GET /api/admin/source-videos?status=index-required&limit=1 | 200 | yes | 11.9ms | none
runtime_settings | GET /api/admin/settings/runtime | 200 | yes | 151.2ms | none
...
queue-and-index-required-visible | library | pass | yes | yes | library queued=900, index_required=23, queued_probe=1, index_required_probe=1. | The Admin API must expose at least one queued item for the next single-video smoke and must expose index-required items without auto-publish.
...
- JSON: docs/acceptance/artifacts/admin-preprocess-production-readiness-20260629T192534Z.json
- Markdown: docs/acceptance/artifacts/admin-preprocess-production-readiness-20260629T192534Z.md
