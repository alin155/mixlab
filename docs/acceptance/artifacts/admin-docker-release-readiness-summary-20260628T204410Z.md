...
Generated: 2026-06-28T20:44:10.786Z
...
- Live readonly: docs/acceptance/artifacts/admin-docker-release-live-readonly-20260628T203916Z.json
...
- Release inputs intake: docs/acceptance/artifacts/admin-docker-nas-release-inputs-intake-20260628T203810Z.json
...
- Release-inputs intake complete: false; returned_precheck_passed=false; blockers: returned-dir-provided, returned-files-complete, returned-evidence-precheck-passed, nas-image-proof-accepted, admin-worker-proof-accepted, nas-disk-proof-accepted, release-inputs-generated, staging-runbook-generated
- Release inputs ready: false; blockers: returned-dir-provided, returned-files-complete, returned-evidence-precheck-passed, nas-image-proof-accepted, release-inputs-generated, release-inputs-ready
...
release-inputs-ready | release-inputs | blocked | yes | release input blockers: returned-dir-provided, returned-files-complete, returned-evidence-precheck-passed, nas-image-proof-accepted, release-inputs-generated, release-inputs-ready | Release inputs must be regenerated from accepted pre-staging, candidate-ref, and NAS current-image proof.
...
- Regenerate release inputs from accepted pre-staging, candidate-ref, and NAS current-image proof before release review. Current release-input blockers: returned-dir-provided, returned-files-complete, returned-evidence-precheck-passed, nas-image-proof-accepted, release-inputs-generated, release-inputs-ready.
...
- JSON: docs/acceptance/artifacts/admin-docker-release-readiness-summary-20260628T204410Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-release-readiness-summary-20260628T204410Z.md
