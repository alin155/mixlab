...
Generated: 2026-06-29T08:16:35.861Z
...
- Windows acceptance report: docs/acceptance/artifacts/windows_acceptance-20260629T080956Z-fb782766/report.json
- Real cut report: docs/acceptance/artifacts/real_cut_smoke-20260629T081035Z-a7f1268a/report.json
- Real cut supplement report: docs/acceptance/artifacts/desktop_incident_diagnostics-20260629T081206Z-bd79fd9c/report.json
...
- Real cut: status=failed, run_next=unknown, completion=done, supplement=failed, output=export-clips/E000048/001-Windows验收剪切-20260629081035-C0728.mp4
...
windows-acceptance-report-provided | input | pass | no | docs/acceptance/artifacts/windows_acceptance-20260629T080956Z-fb782766/report.json | Provide an archived windows_acceptance or install_latest_and_smoke report.json.
...
real-cut-report-provided | input | pass | no | docs/acceptance/artifacts/real_cut_smoke-20260629T081035Z-a7f1268a/report.json | Provide an archived real_cut_smoke report.json for the same staged candidate.
real-cut-smoke-passed | real-cut | pass | no | status=failed, cut_job_id=CJ20260629-0001, supplement_status=done | Run Windows Runner real_cut_smoke and require status=passed, or attach desktop_incident_diagnostics proving the same cut_job_id reached done after an asynchronous queue drain.
real-cut-output-produced | real-cut | pass | no | completion_status=done, output_file=export-clips/E000048/001-Windows验收剪切-20260629081035-C0728.mp4 | real_cut_smoke or its accepted completion supplement must prove status=done and produce an output_file.
...
- JSON: docs/acceptance/artifacts/admin-cutter-compatibility-proof-20260629T081635Z.json
- Markdown: docs/acceptance/artifacts/admin-cutter-compatibility-proof-20260629T081635Z.md
