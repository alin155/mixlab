...
Generated: 2026-06-29T01:45:12.442Z
...
- Worker proof: docs/acceptance/artifacts/admin-worker-env-proof-20260629T014505Z.json
...
- Release inputs intake: docs/acceptance/artifacts/admin-docker-nas-release-inputs-intake-20260629T014505Z.json
...
- Release-inputs intake complete: false; returned_precheck_passed=true; blockers: admin-worker-proof-accepted, nas-disk-proof-accepted
...
- Staging ready: false; blockers: image-push-explicitly-approved, nas-disk-proof-accepted, pre-staging-execution-blockers-carried-forward, parity-report-blockers-clear, worker-env-proof-accepted, cutter-compatibility-proof-accepted
...
nas-release-inputs-intake-complete | release-inputs | blocked | yes | intake blockers: admin-worker-proof-accepted, nas-disk-proof-accepted | Run the NAS collector, copy admin-docker-release-inputs/ back locally, then run intake:admin-docker-nas-release-inputs until intake_complete=true.
...
- Rerun intake:admin-docker-nas-release-inputs with the generated admin-docker-release-inputs/ directory after collecting returned evidence. Current intake blockers: admin-worker-proof-accepted, nas-disk-proof-accepted.
...
- JSON: docs/acceptance/artifacts/admin-docker-release-readiness-summary-20260629T014512Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-release-readiness-summary-20260629T014512Z.md
