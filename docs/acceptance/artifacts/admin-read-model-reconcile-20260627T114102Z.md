# Admin Read Model Reconcile 2026-06-27T11:41:02.354Z
...
| disk-available | pass | disk_available_bytes=681497096192, minimum=1073741824 |
...
| --- | --- | ---: | --- | ---: |
| source_videos_index_required | GET /api/admin/source-videos?status=index-required&limit=20 | 200 | pass | 832.9ms |
| source_videos_queued | GET /api/admin/source-videos?status=queued&limit=20 | 200 | pass | 270.1ms |
| preprocess_jobs | GET /api/admin/preprocess/jobs?limit=20 | 200 | pass | 554.8ms |
| process_history_readiness | GET /api/admin/preprocess/process-history/readiness | 200 | pass | 703.8ms |
| process_history | GET /api/admin/preprocess/process-history?limit=20&window_days=30 | 200 | pass | 641.1ms |
