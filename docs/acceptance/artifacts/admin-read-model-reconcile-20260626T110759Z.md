# Admin Read Model Reconcile 2026-06-26T11:07:59.257Z
...
| disk-available | pass | disk_available_bytes=674093031424, minimum=1073741824 |
...
| process-history-readiness-ready | fail | ready=false, reason=snapshot_incomplete |
| process-history-no-scan-hit | fail | history_available=false, source=admin-read-model, scan_mode=no-scan |

## Post-Reconcile Probes

| probe | request | status | gate | duration |
| --- | --- | ---: | --- | ---: |
| source_videos_index_required | GET /api/admin/source-videos?status=index-required&limit=20 | 200 | pass | 305.9ms |
| source_videos_queued | GET /api/admin/source-videos?status=queued&limit=20 | 200 | pass | 298.2ms |
| preprocess_jobs | GET /api/admin/preprocess/jobs?limit=20 | 200 | pass | 3596.3ms |
| process_history_readiness | GET /api/admin/preprocess/process-history/readiness | 200 | pass | 245.9ms |
| process_history | GET /api/admin/preprocess/process-history?limit=20&window_days=30 | 200 | pass | 191.4ms |
