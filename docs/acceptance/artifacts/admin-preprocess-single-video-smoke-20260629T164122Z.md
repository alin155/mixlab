...
Generated: 2026-06-29T16:41:22.568Z
...
- Candidate before: status=queued, visible=false, size=20000620, path=陶矜2/2024年素材/2403上海花絮/100CANON/0Q9A2832.MP4
...
- Path: docs/acceptance/artifacts/admin-preprocess-production-readiness-20260629T162427Z.json
...
- Snapshot dir: docs/acceptance/artifacts/admin-preprocess-single-video-smoke-20260629T164122Z/pre-smoke-snapshot
...
| --- | --- | --- | --- |
library-ledger | yes | .mixlab-library/library.json | 378
source-video-manifest | yes | .mixlab-library/videos/V006190/source-video.json | 621
preprocess-job | no | .mixlab-library/videos/V006190/preprocess-job.json | 141
preprocess-log | no | .mixlab-library/logs/V006190.log | 65
...
| --- | --- | --- | --- | --- | --- |
auth_status | GET /api/admin/auth/status | 200 | yes | 33.8ms | none
library_status_before | GET /api/admin/library/status | 200 | yes | 14.3ms | none
preprocess_safety | GET /api/admin/preprocess/safety | 200 | yes | 8.0ms | none
supervisor_status_before | GET /api/admin/preprocess/supervisor/status | 200 | yes | 6.7ms | none
source_videos_processing_before | GET /api/admin/source-videos?status=processing&limit=20 | 200 | yes | 15.4ms | none
source_video_before | GET /api/admin/source-videos/V006190 | 200 | yes | 8.3ms | none

## Gates

| Gate | Category | Status | Blocks Dry-run | Blocks Execute | Evidence | Required Evidence |
| --- | --- | --- | --- | --- | --- | --- |
single-video-scope-only | scope | pass | yes | yes | source_video_id=V006190. | n/a
...
candidate-is-queued-and-hidden | library | pass | yes | yes | status=queued, visible_to_cutters=false, path=陶矜2/2024年素材/2403上海花絮/100CANON/0Q9A2832.MP4, size=20000620. | n/a
...
pre-smoke-snapshot-captured | snapshot | pass | yes | yes | Copied 5 files to docs/acceptance/artifacts/admin-preprocess-single-video-smoke-20260629T164122Z/pre-smoke-snapshot. | n/a
...
- JSON: docs/acceptance/artifacts/admin-preprocess-single-video-smoke-20260629T164122Z.json
- Markdown: docs/acceptance/artifacts/admin-preprocess-single-video-smoke-20260629T164122Z.md
