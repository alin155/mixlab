...
Generated: 2026-06-29T02:58:53.606Z
...
- Artifact: docs/acceptance/artifacts/admin-docker-release-live-readonly-20260629T025836Z.json
...
admin-web-root-observed | live-evidence | pass | no | HTTP 200, ok, 31.7ms | Admin Web root must be reachable before comparing API/image parity.
admin-api-proxy-observed | live-evidence | pass | no | auth=HTTP 404, not_found 路由不存在, 12.1ms; library=HTTP 200, ok, 830.7ms; supervisor=HTTP 200, ok, 6.4ms | At least one Admin API JSON endpoint must respond through Admin Web before diagnosing image/API parity.
...
- JSON: docs/acceptance/artifacts/admin-docker-version-parity-plan-20260629T025853Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-version-parity-plan-20260629T025853Z.md
