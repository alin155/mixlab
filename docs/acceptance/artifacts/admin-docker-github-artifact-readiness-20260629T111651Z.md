...
- Admin Docker local smoke: .local-dev/admin-docker-github-runs/28367816458/mixlab-admin-docker-release-gates/admin-docker-local-smoke-20260629T111321Z.json
- Admin Docker candidate contract proof: .local-dev/admin-docker-github-runs/28367816458/mixlab-admin-docker-release-gates/admin-docker-candidate-contract-proof-20260629T111424Z.json
- Admin Docker live read-only probe: .local-dev/admin-docker-github-runs/28367816458/mixlab-admin-docker-release-gates/admin-docker-release-live-readonly-20260629T111425Z.json
- Admin Docker version parity plan: .local-dev/admin-docker-github-runs/28367816458/mixlab-admin-docker-release-gates/admin-docker-version-parity-plan-20260629T111425Z.json
- Admin worker env proof: .local-dev/admin-docker-github-runs/28367816458/mixlab-admin-docker-release-gates/admin-worker-env-proof-20260629T111425Z.json
- Cutter compatibility proof: .local-dev/admin-docker-github-runs/28367816458/mixlab-admin-docker-release-gates/admin-cutter-compatibility-proof-20260629T111426Z.json
- Admin Docker NAS release-inputs intake: .local-dev/admin-docker-github-runs/28367816458/mixlab-admin-docker-release-gates/admin-docker-nas-release-inputs-intake-20260629T111607Z.json
- Admin Docker staging runbook: .local-dev/admin-docker-github-runs/28367816458/mixlab-admin-docker-release-gates/admin-docker-staging-runbook-20260629T111607Z.json
- Admin Docker release readiness summary: .local-dev/admin-docker-github-runs/28367816458/mixlab-admin-docker-release-gates/admin-docker-release-readiness-summary-20260629T111608Z.json
...
| artifact-admin-docker-local-smoke-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28367816458/mixlab-admin-docker-release-gates/admin-docker-local-smoke-20260629T111321Z.json |
| artifact-admin-docker-candidate-contract-proof-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28367816458/mixlab-admin-docker-release-gates/admin-docker-candidate-contract-proof-20260629T111424Z.json |
| artifact-admin-docker-release-live-readonly-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28367816458/mixlab-admin-docker-release-gates/admin-docker-release-live-readonly-20260629T111425Z.json |
| artifact-admin-docker-version-parity-plan-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28367816458/mixlab-admin-docker-release-gates/admin-docker-version-parity-plan-20260629T111425Z.json |
| artifact-admin-worker-env-proof-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28367816458/mixlab-admin-docker-release-gates/admin-worker-env-proof-20260629T111425Z.json |
| artifact-admin-cutter-compatibility-proof-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28367816458/mixlab-admin-docker-release-gates/admin-cutter-compatibility-proof-20260629T111426Z.json |
| artifact-admin-docker-nas-release-inputs-intake-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28367816458/mixlab-admin-docker-release-gates/admin-docker-nas-release-inputs-intake-20260629T111607Z.json |
| artifact-admin-docker-staging-runbook-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28367816458/mixlab-admin-docker-release-gates/admin-docker-staging-runbook-20260629T111607Z.json |
| artifact-admin-docker-release-readiness-summary-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28367816458/mixlab-admin-docker-release-gates/admin-docker-release-readiness-summary-20260629T111608Z.json |
...
- JSON: docs/acceptance/artifacts/admin-docker-github-artifact-readiness-20260629T111651Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-github-artifact-readiness-20260629T111651Z.md
