# Admin Real NAS Performance Probe 2026-06-27T10:20:45.365Z
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| health | shell | 200 | 2/2 | 1.3ms | 1.1ms | 1.3ms | 1.3ms | pass |
| auth_status | shell | 200 | 2/2 | 1.9ms | 1.1ms | 1.9ms | 1.9ms | pass |
| library_status | shell | 200 | 2/2 | 23.5ms | 5.0ms | 23.5ms | 23.5ms | pass |
| data_loading_plan | shell | 200 | 2/2 | 1.3ms | 0.8ms | 1.3ms | 1.3ms | pass |
| read_model_status | diagnostic | 200 | 2/2 | 82.3ms | 78.0ms | 82.3ms | 82.3ms | pass |
| read_model_reconcile_status | diagnostic | 200 | 2/2 | 0.8ms | 0.4ms | 0.8ms | 0.8ms | pass |
| protection_status | route | 200 | 2/2 | 0.7ms | 0.5ms | 0.7ms | 0.7ms | pass |
| release_gates | route | 200 | 2/2 | 40.5ms | 19.3ms | 40.5ms | 40.5ms | pass |
| preprocess_safety | route | 200 | 2/2 | 1.6ms | 0.7ms | 1.6ms | 1.6ms | pass |
| operations_overview | route | 200 | 2/2 | 87.2ms | 87.2ms | 108.6ms | 108.6ms | pass |
| operation_log | route | 200 | 2/2 | 20.5ms | 0.6ms | 20.5ms | 20.5ms | pass |
| source_videos_first_page | route | 200 | 2/2 | 1.1ms | 0.6ms | 1.1ms | 1.1ms | pass |
| source_videos_processing | route | 200 | 2/2 | 67.6ms | 67.6ms | 74.8ms | 74.8ms | pass |
| source_videos_index_required | route | 200 | 2/2 | 211.6ms | 211.6ms | 216.0ms | 216.0ms | pass |
| source_videos_queued | route | 200 | 2/2 | 204.4ms | 204.4ms | 213.8ms | 213.8ms | pass |
| source_videos_failed | route | 200 | 2/2 | 68.8ms | 66.5ms | 68.8ms | 68.8ms | pass |
| preprocess_jobs | route | 200 | 2/2 | 406.5ms | 150.5ms | 406.5ms | 406.5ms | pass |
| index_versions | route | 200 | 2/2 | 183.5ms | 0.5ms | 183.5ms | 183.5ms | pass |
| cutter_users | route | 200 | 2/2 | 17.3ms | 0.9ms | 17.3ms | 17.3ms | pass |
| dashboard_metrics | background | 200 | 3/3 | 451.2ms | 2.0ms | 451.2ms | 451.2ms | pass |
...
| --- | --- | ---: | ---: | ---: | --- | --- | --- | --- |
| source_videos_processing | status_store_page | 2 | 70.0ms | 74.0ms | admin-read-model=2 | paged-list=2 | hit=2 | status=processing;offset=0;limit=20;manifests=0=2 |
...
| source_videos_index_required | status_store_page | 2 | 213.0ms | 215.0ms | admin-read-model=2 | paged-list=2 | hit=2 | status=index-required;offset=0;limit=20;manifests=19=2 |
...
| source_videos_queued | status_store_page | 2 | 208.0ms | 213.0ms | admin-read-model=2 | paged-list=2 | hit=2 | status=queued;offset=0;limit=20;manifests=20=2 |
...
| source_videos_failed | status_store_page | 2 | 66.5ms | 68.0ms | admin-read-model=2 | paged-list=2 | hit=2 | status=failed;offset=0;limit=20;manifests=0=2 |
...
| preprocess_jobs | preprocess_job_page | 2 | 144.0ms | 146.0ms | admin-read-model=2 | paged-list=2 | hit=2 | offset=0;limit=20;manifests=20;snapshots=0=2 |
...
| index_versions | index_package_validation | 1 | 148.0ms | 148.0ms | index-version-packages=1 | paged-list=1 | not-applicable=1 | versions=8;directory_ms=0;current_ms=0=1 |
| index_versions | current_pointer_fast_page | 1 | 34.0ms | 34.0ms | current-index=1 | paged-list=1 | hit=1 | offset=0;limit=8;result=hit;versions=8=1 |
| index_versions | cache_lookup | 1 | 0.0ms | 0.0ms | current-index=1 | no-scan=1 | hit=1 | offset=0;limit=8=1 |
| dashboard_metrics | production_summary | 1 | 190.0ms | 190.0ms | admin-read-model=1 | no-scan=1 | none | none |
| dashboard_metrics | usage_metrics | 1 | 112.0ms | 112.0ms | admin-read-model=1 | no-scan=1 | none | none |
| dashboard_metrics | material_summary | 1 | 73.0ms | 73.0ms | admin-read-model=1 | no-scan=1 | none | none |
| dashboard_metrics | status_summary | 1 | 72.0ms | 72.0ms | admin-read-model=1 | no-scan=1 | none | none |
