...
Generated: 2026-06-28T22:48:56.405Z
...
- GitHub run: 28338518625
- GitHub run URL: https://github.com/alin155/mixlab/actions/runs/28338518625
...
- Candidate branch: admin-docker-candidate-b945418df2a447fd39bb9c88f781322594fc11c0
- Workflow ref: admin-docker-candidate-b945418df2a447fd39bb9c88f781322594fc11c0
- Release ref setup: git tag admin-docker-candidate-b945418df2a447fd39bb9c88f781322594fc11c0 b945418df2a447fd39bb9c88f781322594fc11c0 && git push origin refs/tags/admin-docker-candidate-b945418df2a447fd39bb9c88f781322594fc11c0:refs/tags/admin-docker-candidate-b945418df2a447fd39bb9c88f781322594fc11c0
- Workflow command: gh workflow run docker-admin.yml --repo alin155/mixlab --ref admin-docker-candidate-b945418df2a447fd39bb9c88f781322594fc11c0 -f push_images=true -f current_image_tag=<current-admin-docker-image-tag> -f rollback_image_tag=<current-admin-docker-image-tag>
- Candidate ref proof command: MIXLAB_ADMIN_DOCKER_CANDIDATE_REF_SHA=b945418df2a447fd39bb9c88f781322594fc11c0 MIXLAB_ADMIN_DOCKER_CANDIDATE_REF_TAG=admin-docker-candidate-b945418df2a447fd39bb9c88f781322594fc11c0 MIXLAB_ADMIN_DOCKER_CANDIDATE_REF_RUN_ID=<tag-ref-push-images-false-run-id> MIXLAB_ADMIN_DOCKER_CANDIDATE_REF_ARTIFACT_DIR=<downloaded-tag-ref-release-gates-artifact-dir> npm run validate:admin-docker-candidate-ref-proof
...
| current-worktree-candidate-ready | candidate | pass | no | no | yes | current_worktree_candidate_ready=true, github_run_candidate_ready=true, immutable_candidate_ref_ready=true, run=https://github.com/alin155/mixlab/actions/runs/28338518625 |
...
- Before explicit push approval, create or verify the immutable release ref admin-docker-candidate-b945418df2a447fd39bb9c88f781322594fc11c0 points at candidate SHA b945418df2a447fd39bb9c88f781322594fc11c0.
...
- After explicit approval, rerun the Admin Docker workflow with --ref admin-docker-candidate-b945418df2a447fd39bb9c88f781322594fc11c0, push_images=true, current_image_tag=<current-tag>, rollback_image_tag=<current-tag>, and target image b945418df2a447fd39bb9c88f781322594fc11c0.
...
- JSON: docs/acceptance/artifacts/admin-docker-prestaging-handoff-20260628T224856Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-prestaging-handoff-20260628T224856Z.md
