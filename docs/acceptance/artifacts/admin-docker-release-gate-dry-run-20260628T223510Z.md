...
Generated: 2026-06-28T22:35:10.294Z
...
image-tag-static-parity | Admin image tag parity is statically declared | static | pass | no | admin-api, admin-worker, and admin-web use the same explicit immutable MIXLAB_IMAGE_TAG contract. | n/a | none
...
- JSON: docs/acceptance/artifacts/admin-docker-release-gate-dry-run-20260628T223510Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-release-gate-dry-run-20260628T223510Z.md
