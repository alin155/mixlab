...
Generated: 2026-06-29T03:19:53.679Z
...
- Source report: .local-dev/admin-docker-release-gates/admin-docker-local-smoke-20260629T031851Z.json
...
- Build: sha 73ab7b355051d7325174111f955cd8356d42787d, version 73ab7b355051d7325174111f955cd8356d42787d, image tag 73ab7b355051d7325174111f955cd8356d42787d
...
| --- | --- | --- | --- | --- | --- | --- | --- |
admin_web_root | web | http://127.0.0.1:18081 | GET / | 200 | yes | 7.4ms | none
auth_status | api | http://127.0.0.1:18081 | GET /api/admin/auth/status | 200 | yes | 7.3ms | none
library_status | api | http://127.0.0.1:18081 | GET /api/admin/library/status | 200 | yes | 5.0ms | none
release_gates | api | http://127.0.0.1:18081 | GET /api/admin/release-gates | 200 | yes | 25.6ms | none
data_loading_plan | api | http://127.0.0.1:18081 | GET /api/admin/data-loading/plan | 200 | yes | 4.5ms | none
...
candidate-proof-source-accepted | safety | pass | no | yes | Derived from local smoke report .local-dev/admin-docker-release-gates/admin-docker-local-smoke-20260629T031851Z.json; local_smoke_passed=true, status=accepted, blockers=none. | n/a
...
candidate-admin-web-root | candidate-api | pass | no | yes | HTTP 200, ok, 7.4ms | GET / must return an Admin Web response from the candidate target.
...
- JSON: .local-dev/admin-docker-release-gates/admin-docker-candidate-contract-proof-20260629T031953Z.json
- Markdown: .local-dev/admin-docker-release-gates/admin-docker-candidate-contract-proof-20260629T031953Z.md
