...
Generated: 2026-06-26T20:10:28.795Z
...
- Worker env proof: docs/acceptance/artifacts/admin-worker-env-proof-20260626T200512Z.json
...
parity-report-present | evidence | pass | no | docs/acceptance/artifacts/admin-docker-version-parity-plan-20260626T195950Z.json | Provide the Docker version/API parity plan artifact.
parity-report-blockers-clear | evidence | blocked | yes | Parity blockers: current-admin-api-contract-parity, nas-disk-risk, admin-worker-env-external-proof, cutter-compatibility-external-proof | Resolve current API contract parity, disk, worker, and Cutter compatibility blockers before staging.
...
- JSON: docs/acceptance/artifacts/admin-docker-staging-runbook-20260626T201028Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-staging-runbook-20260626T201028Z.md
