...
Generated: 2026-06-28T20:36:03.963Z
...
- Work dir: .local-dev/admin-docker-local-smoke/20260628T203603Z
- Compose file: .local-dev/admin-docker-local-smoke/20260628T203603Z/docker-compose.yml
- Public library host path: .local-dev/admin-docker-local-smoke/20260628T203603Z/PublicLibrary
...
- Image tag: 25fe2264de7b391a56e770a8acb6bf40ebec3863
- Build SHA: 25fe2264de7b391a56e770a8acb6bf40ebec3863
- Build version: 25fe2264de7b391a56e770a8acb6bf40ebec3863
- MVP mode: v0.1
...
| --- | --- | --- | --- | --- |
admin_web_root | pass | 200 | 7.3ms | ok
auth_status | pass | 200 | 7.5ms | ok
library_status | pass | 200 | 5.3ms | ok
release_gates | pass | 200 | 30.1ms | ok
data_loading_plan | pass | 200 | 4.3ms | ok
...
admin-runtime-image-built | docker-build | pass | no | no | docker build -f docker/admin-runtime.Dockerfile -t mixlab-admin-runtime:local-mvp-smoke --build-arg MIXLAB_ADMIN_DOCKER_MVP_MODE=v0.1 --build-arg MIXLAB_BUILD_SHA=25fe2264de7b391a56e770a8acb6bf40ebec3863 --build-arg MIXLAB_BUILD_VERSION=25fe2264de7b391a56e770a8acb6bf40ebec3863 --build-arg MIXLAB_IMAGE_TAG=25fe2264de7b391a56e770a8acb6bf40ebec3863 . -> ok | n/a
...
local-compose-up | compose | pass | no | no | docker compose -f .local-dev/admin-docker-local-smoke/20260628T203603Z/docker-compose.yml up -d -> ok | n/a
local-endpoint-probes | probe | pass | no | no | admin_web_root=HTTP 200 ok 7.3ms; auth_status=HTTP 200 ok 7.5ms; library_status=HTTP 200 ok 5.3ms; release_gates=HTTP 200 ok 30.1ms; data_loading_plan=HTTP 200 ok 4.3ms | n/a
...
- JSON: .local-dev/admin-docker-release-gates/admin-docker-local-smoke-20260628T203603Z.json
- Markdown: .local-dev/admin-docker-release-gates/admin-docker-local-smoke-20260628T203603Z.md
