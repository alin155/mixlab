# Admin Read Model Rebuild Plan 2026-06-27T11:25:52.503Z
...
| process_history | missing | missing_metadata | full-reconcile | true | true | 0 | 11394 |
...
- Readiness reason: `projection_incomplete`
- Last error: `none`
...
- Reason: `process_history:projection_incomplete; projection_incomplete:process_history:missing_metadata`
...
| readiness-explains-state | pass | ready=false, reason=projection_incomplete, last_error=none |
| projection-plan-covers-background-reconcile | pass | projection_reasons=projection_incomplete:process_history:missing_metadata, plan_needed=true |
...
| --- | --- | ---: | --- | ---: |
| auth_status | GET /api/admin/auth/status | 200 | pass | 75.3ms |
| library_status | GET /api/admin/library/status | 200 | pass | 78.9ms |
| read_model_status | GET /api/admin/read-model/status | 200 | pass | 115.9ms |
| reconcile_status | GET /api/admin/read-model/reconcile/status | 200 | pass | 1.0ms |
| process_history_readiness | GET /api/admin/preprocess/process-history/readiness | 200 | pass | 267.8ms |
| process_history | GET /api/admin/preprocess/process-history?limit=20&window_days=30 | 200 | pass | 274.5ms |

## Result

- Status: `passed`
- Passed: `true`
- Summary: plan-only rebuild gate passed; reason=process_history:projection_incomplete; projection_incomplete:process_history:missing_metadata; execute separate reconcile runner if proceeding
