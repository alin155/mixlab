...
Generated: 2026-06-27T14:42:09.352Z
...
- Upload blockers: target-url-configured, admin-web-root-live, admin-api-proxy-live, current-admin-api-contract-live, auth-context-live, runtime-path-profile-live, build-version-health, preprocess-disk, usage-events-tolerance, usage-events-repair-contract-live, processing-recovery, processing-recovery-contract-live, current-index, dashboard-metrics-live, data-loading-contract-live, supervisor-status-live, admin-worker-live-flags, cutter-release-compatibility-live
...
- JSON: docs/acceptance/artifacts/admin-docker-release-live-readonly-20260627T144209Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-release-live-readonly-20260627T144209Z.md
