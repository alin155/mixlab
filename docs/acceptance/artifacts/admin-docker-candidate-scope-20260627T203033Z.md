...
Generated: 2026-06-27T20:30:33.301Z
...
- Blockers: current-worktree-dirty, unknown-paths-require-review

## Buckets

| Bucket | Severity | Count | Omitted |
| --- | --- | ---: | ---: |
| mvp_candidate_code | candidate | 351 | 231 |
| planning_docs | evidence | 7 | 0 |
| acceptance_evidence | evidence | 750 | 630 |
| local_generated_artifact | exclude | 0 | 0 |
| cutter_impact_review | review | 0 | 0 |
| unknown_review | review | 1 | 0 |
...
- JSON: docs/acceptance/artifacts/admin-docker-candidate-scope-20260627T203033Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-candidate-scope-20260627T203033Z.md
