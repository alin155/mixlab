...
Generated: 2026-06-29T08:06:00.897Z
...
- Upload blockers: auth-context-live, admin-worker-live-flags, cutter-release-compatibility-live

## Requests

| Probe | Request | HTTP | OK | Duration | Error |
| --- | --- | --- | --- | --- | --- |
admin_web_root | GET / | 200 | yes | 30.9ms | none
auth_status | GET /api/admin/auth/status | 200 | yes | 14.0ms | none
library_status | GET /api/admin/library/status | 200 | yes | 153.5ms | none
release_gates | GET /api/admin/release-gates | 200 | yes | 610.6ms | none
dashboard_metrics | GET /api/admin/dashboard/metrics | 200 | yes | 1062.0ms | none
data_loading_plan | GET /api/admin/data-loading/plan | 200 | yes | 13.0ms | none
preprocess_supervisor_status | GET /api/admin/preprocess/supervisor/status | 200 | yes | 9.0ms | none
...
version-health-parity-contract-live | Version and health parity contract is exposed live | live-docker | pass | no | status=ready, image_tag=9c015b9105e97954240020781f79daae3f954bde, services=admin-web,admin-api,admin-worker | n/a
preprocess-disk | NAS disk protection passes live gate | live-nas | pass | no | 公共素材库磁盘空间通过门禁。 | n/a
disk-space-protection-contract-live | Disk-space protection preflight contract is exposed live | live-nas | pass | no | status=healthy, usage=66%, threshold=92%, scope=preprocess-and-docker-upload | n/a
...
dashboard-metrics-live | Dashboard metrics read does not fail live | live-admin | pass | no | HTTP 200, 10885 bytes | n/a
...
- JSON: docs/acceptance/artifacts/admin-docker-release-live-readonly-20260629T080600Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-release-live-readonly-20260629T080600Z.md
