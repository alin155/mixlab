# Admin Real NAS Performance Probe 2026-06-27T11:55:46.993Z
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| health | shell | 200 | 2/2 | 1.2ms | 1.0ms | 1.2ms | 1.2ms | pass |
| auth_status | shell | 200 | 2/2 | 1.0ms | 1.0ms | 1.5ms | 1.5ms | pass |
| library_status | shell | 200 | 2/2 | 22.5ms | 4.3ms | 22.5ms | 22.5ms | pass |
| data_loading_plan | shell | 200 | 2/2 | 0.8ms | 0.5ms | 0.8ms | 0.8ms | pass |
| read_model_status | diagnostic | 200 | 2/2 | 80.7ms | 80.7ms | 87.9ms | 87.9ms | pass |
| read_model_reconcile_status | diagnostic | 200 | 2/2 | 0.8ms | 0.4ms | 0.8ms | 0.8ms | pass |
| protection_status | route | 200 | 2/2 | 0.8ms | 0.6ms | 0.8ms | 0.8ms | pass |
| release_gates | route | 200 | 2/2 | 53.3ms | 20.0ms | 53.3ms | 53.3ms | pass |
| preprocess_safety | route | 200 | 2/2 | 1.4ms | 0.6ms | 1.4ms | 1.4ms | pass |
| operations_overview | route | 200 | 2/2 | 97.5ms | 97.5ms | 100.0ms | 100.0ms | pass |
| operation_log | route | 200 | 2/2 | 20.8ms | 0.5ms | 20.8ms | 20.8ms | pass |
| source_videos_first_page | route | 200 | 2/2 | 1.0ms | 0.4ms | 1.0ms | 1.0ms | pass |
| source_videos_processing | route | 200 | 2/2 | 87.9ms | 83.3ms | 87.9ms | 87.9ms | pass |
| source_videos_index_required | route | 200 | 2/2 | 238.7ms | 235.9ms | 238.7ms | 238.7ms | pass |
| source_videos_queued | route | 200 | 2/2 | 216.9ms | 191.3ms | 216.9ms | 216.9ms | pass |
| source_videos_failed | route | 200 | 2/2 | 81.9ms | 81.9ms | 82.8ms | 82.8ms | pass |
| preprocess_jobs | route | 200 | 2/2 | 473.7ms | 201.9ms | 473.7ms | 473.7ms | pass |
| index_versions | route | 200 | 2/2 | 223.5ms | 1.5ms | 223.5ms | 223.5ms | pass |
| cutter_users | route | 200 | 2/2 | 24.1ms | 8.7ms | 24.1ms | 24.1ms | pass |
| dashboard_metrics | background | 200 | 3/3 | 457.3ms | 2.1ms | 457.3ms | 457.3ms | pass |
...
| --- | --- | ---: | ---: | ---: | --- | --- | --- | --- |
| source_videos_processing | status_store_page | 2 | 84.5ms | 87.0ms | admin-read-model=2 | paged-list=2 | hit=2 | status=processing;offset=0;limit=20;manifests=0=2 |
...
| source_videos_index_required | status_store_page | 2 | 235.5ms | 238.0ms | admin-read-model=2 | paged-list=2 | hit=2 | status=index-required;offset=0;limit=20;manifests=19=2 |
...
| source_videos_queued | status_store_page | 2 | 201.5ms | 214.0ms | admin-read-model=2 | paged-list=2 | hit=2 | status=queued;offset=0;limit=20;manifests=20=2 |
...
| source_videos_failed | status_store_page | 2 | 80.0ms | 80.0ms | admin-read-model=2 | paged-list=2 | hit=2 | status=failed;offset=0;limit=20;manifests=0=2 |
...
| preprocess_jobs | runtime_load | 2 | 132.0ms | 264.0ms | runtime-telemetry=2 | no-scan=2 | not-applicable=2 | status=blocked=2 |
| preprocess_jobs | preprocess_job_page | 2 | 200.0ms | 202.0ms | admin-read-model=2 | paged-list=2 | hit=2 | offset=0;limit=20;manifests=20;snapshots=0=2 |
...
| index_versions | index_package_validation | 1 | 176.0ms | 176.0ms | index-version-packages=1 | paged-list=1 | not-applicable=1 | versions=8;directory_ms=0;current_ms=0=1 |
| index_versions | current_pointer_fast_page | 1 | 44.0ms | 44.0ms | current-index=1 | paged-list=1 | hit=1 | offset=0;limit=8;result=hit;versions=8=1 |
| index_versions | cache_lookup | 1 | 0.0ms | 0.0ms | current-index=1 | no-scan=1 | hit=1 | offset=0;limit=8=1 |
| dashboard_metrics | production_summary | 1 | 169.0ms | 169.0ms | admin-read-model=1 | no-scan=1 | none | none |
| dashboard_metrics | usage_metrics | 1 | 102.0ms | 102.0ms | admin-read-model=1 | no-scan=1 | none | none |
| dashboard_metrics | status_summary | 1 | 91.0ms | 91.0ms | admin-read-model=1 | no-scan=1 | none | none |
| dashboard_metrics | material_summary | 1 | 84.0ms | 84.0ms | admin-read-model=1 | no-scan=1 | none | none |
