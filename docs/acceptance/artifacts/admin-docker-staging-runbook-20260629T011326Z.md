...
Generated: 2026-06-29T01:13:26.865Z
...
target-differs-from-current | input | blocked | yes | yes | current=missing, target=4cb5b18262e49894d4272b0fc940be6c1d2102b4 | Target tag must differ from current tag so the staging action is explicit.
...
target-tag-matches-release-inputs | input | blocked | yes | yes | runbook target=4cb5b18262e49894d4272b0fc940be6c1d2102b4, release_inputs target=missing | Set MIXLAB_DOCKER_TARGET_IMAGE_TAG from the accepted admin-docker-release-inputs report.
...
- JSON: docs/acceptance/artifacts/admin-docker-staging-runbook-20260629T011326Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-staging-runbook-20260629T011326Z.md
