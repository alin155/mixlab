...
Generated: 2026-06-29T20:45:00.120Z
...
- Snapshot dir: docs/acceptance/artifacts/admin-preprocess-single-video-smoke-20260629T204500Z/pre-smoke-snapshot
...
| --- | --- | --- | --- | --- | --- | --- |
.mixlab-library/videos/V006161/source-video.json | no | no | n/a | n/a | {} | none
.mixlab-library/videos/V006161/preprocess-job.json | no | no | n/a | n/a | {} | none
...
library_status_before | GET /api/admin/library/status | 200 | yes | 8.1ms | none
preprocess_safety | GET /api/admin/preprocess/safety | 200 | yes | 8.4ms | none
supervisor_status_before | GET /api/admin/preprocess/supervisor/status | 200 | yes | 7.4ms | none
source_videos_processing_before | GET /api/admin/source-videos?status=processing&limit=20 | 200 | yes | 15.8ms | none
source_video_before | GET /api/admin/source-videos/V006161 | 200 | yes | 6.5ms | none
...
pre-smoke-snapshot-captured | snapshot | pass | yes | yes | Copied 5 files to docs/acceptance/artifacts/admin-preprocess-single-video-smoke-20260629T204500Z/pre-smoke-snapshot. | n/a
...
- JSON: docs/acceptance/artifacts/admin-preprocess-single-video-smoke-20260629T204500Z.json
- Markdown: docs/acceptance/artifacts/admin-preprocess-single-video-smoke-20260629T204500Z.md
