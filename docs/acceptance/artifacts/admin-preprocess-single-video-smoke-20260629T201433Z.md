...
Generated: 2026-06-29T20:14:33.636Z
...
- Candidate before: status=queued, visible=false, size=16633304, path=陶矜2/2024年素材/2403上海花絮/100CANON/0Q9A2820.MP4
...
- Snapshot dir: docs/acceptance/artifacts/admin-preprocess-single-video-smoke-20260629T201433Z/pre-smoke-snapshot
...
source-video-manifest | yes | .mixlab-library/videos/V006178/source-video.json | 621
preprocess-job | no | .mixlab-library/videos/V006178/preprocess-job.json | 141
preprocess-log | no | .mixlab-library/logs/V006178.log | 65
...
| --- | --- | --- | --- | --- | --- | --- |
.mixlab-library/videos/V006178/source-video.json | no | no | n/a | n/a | {} | none
.mixlab-library/videos/V006178/preprocess-job.json | no | no | n/a | n/a | {} | none
...
| --- | --- | --- | --- | --- | --- |
auth_status | GET /api/admin/auth/status | 200 | yes | 6.5ms | none
library_status_before | GET /api/admin/library/status | 200 | yes | 8.0ms | none
preprocess_safety | GET /api/admin/preprocess/safety | 200 | yes | 7.6ms | none
supervisor_status_before | GET /api/admin/preprocess/supervisor/status | 200 | yes | 5.7ms | none
source_videos_processing_before | GET /api/admin/source-videos?status=processing&limit=20 | 200 | yes | 14.8ms | none
source_video_before | GET /api/admin/source-videos/V006178 | 200 | yes | 10.0ms | none

## Gates

| Gate | Category | Status | Blocks Dry-run | Blocks Execute | Evidence | Required Evidence |
| --- | --- | --- | --- | --- | --- | --- |
single-video-scope-only | scope | pass | yes | yes | source_video_id=V006178. | n/a
...
candidate-is-queued-and-hidden | library | pass | yes | yes | status=queued, visible_to_cutters=false, path=陶矜2/2024年素材/2403上海花絮/100CANON/0Q9A2820.MP4, size=16633304. | n/a
...
pre-smoke-snapshot-captured | snapshot | pass | yes | yes | Copied 5 files to docs/acceptance/artifacts/admin-preprocess-single-video-smoke-20260629T201433Z/pre-smoke-snapshot. | n/a
...
- JSON: docs/acceptance/artifacts/admin-preprocess-single-video-smoke-20260629T201433Z.json
- Markdown: docs/acceptance/artifacts/admin-preprocess-single-video-smoke-20260629T201433Z.md
