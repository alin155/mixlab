# Admin Read Model Reconcile 2026-06-26T11:18:56.534Z
...
| disk-available | pass | disk_available_bytes=674076200960, minimum=1073741824 |
...
| --- | --- | ---: | --- | ---: |
| source_videos_index_required | GET /api/admin/source-videos?status=index-required&limit=20 | 200 | pass | 300.5ms |
| source_videos_queued | GET /api/admin/source-videos?status=queued&limit=20 | 200 | pass | 2982.4ms |
| preprocess_jobs | GET /api/admin/preprocess/jobs?limit=20 | 200 | pass | 3660.7ms |
| process_history_readiness | GET /api/admin/preprocess/process-history/readiness | 200 | pass | 326.7ms |
| process_history | GET /api/admin/preprocess/process-history?limit=20&window_days=30 | 200 | pass | 2867.1ms |
