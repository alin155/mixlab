# Admin Real NAS Performance Probe 2026-06-27T07:29:42.241Z
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| health | shell | 200 | 2/2 | 1.5ms | 1.2ms | 1.5ms | 1.5ms | pass |
| auth_status | shell | 200 | 2/2 | 1.1ms | 1.1ms | 1.6ms | 1.6ms | pass |
| library_status | shell | 200 | 2/2 | 27.7ms | 5.3ms | 27.7ms | 27.7ms | pass |
| data_loading_plan | shell | 200 | 2/2 | 1.0ms | 0.6ms | 1.0ms | 1.0ms | pass |
| read_model_status | diagnostic | 200 | 2/2 | 67.7ms | 67.7ms | 74.0ms | 74.0ms | pass |
| read_model_reconcile_status | diagnostic | 200 | 2/2 | 0.7ms | 0.5ms | 0.7ms | 0.7ms | pass |
| protection_status | route | 200 | 2/2 | 0.7ms | 0.7ms | 0.9ms | 0.9ms | pass |
| release_gates | route | 200 | 2/2 | 61.9ms | 20.7ms | 61.9ms | 61.9ms | pass |
| preprocess_safety | route | 200 | 2/2 | 1.0ms | 0.5ms | 1.0ms | 1.0ms | pass |
| operations_overview | route | 200 | 2/2 | 86.4ms | 86.4ms | 89.0ms | 89.0ms | pass |
| operation_log | route | 200 | 2/2 | 19.4ms | 0.7ms | 19.4ms | 19.4ms | pass |
| source_videos_first_page | route | 200 | 2/2 | 1.2ms | 0.5ms | 1.2ms | 1.2ms | pass |
| source_videos_processing | route | 200 | 2/2 | 72.9ms | 72.9ms | 78.9ms | 78.9ms | pass |
| source_videos_index_required | route | 200 | 2/2 | 231.1ms | 226.7ms | 231.1ms | 231.1ms | pass |
| source_videos_queued | route | 200 | 2/2 | 187.9ms | 179.1ms | 187.9ms | 187.9ms | pass |
| source_videos_failed | route | 200 | 2/2 | 76.7ms | 76.7ms | 78.4ms | 78.4ms | pass |
| preprocess_jobs | route | 200 | 2/2 | 493.9ms | 478.9ms | 493.9ms | 493.9ms | pass |
| index_versions | route | 200 | 2/2 | 282.7ms | 1.7ms | 282.7ms | 282.7ms | pass |
| cutter_users | route | 200 | 2/2 | 35.3ms | 3.0ms | 35.3ms | 35.3ms | pass |
| dashboard_metrics | background | 200 | 3/3 | 1891.6ms | 1.8ms | 1891.6ms | 1891.6ms | pass |
...
| --- | --- | ---: | ---: | ---: | --- | --- | --- |
| dashboard_metrics | production_summary | 1 | 1315.0ms | 1315.0ms | admin-read-model=1 | none | none |
| dashboard_metrics | runtime_load | 1 | 266.0ms | 266.0ms | runtime-telemetry=1 | none | none |
| dashboard_metrics | material_summary | 1 | 133.0ms | 133.0ms | admin-read-model=1 | none | none |
| dashboard_metrics | usage_metrics | 1 | 105.0ms | 105.0ms | admin-read-model=1 | none | none |
| dashboard_metrics | status_summary | 1 | 68.0ms | 68.0ms | admin-read-model=1 | none | none |
