# Admin Real NAS Performance Probe 2026-06-27T14:16:41.461Z
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| health | shell | 200 | 2/2 | 2.0ms | 0.7ms | 2.0ms | 2.0ms | pass |
| auth_status | shell | 200 | 2/2 | 1.1ms | 1.1ms | 1.4ms | 1.4ms | pass |
| library_status | shell | 200 | 2/2 | 26.7ms | 4.9ms | 26.7ms | 26.7ms | pass |
| data_loading_plan | shell | 200 | 2/2 | 1.2ms | 0.8ms | 1.2ms | 1.2ms | pass |
| read_model_status | diagnostic | 200 | 2/2 | 99.2ms | 99.2ms | 105.7ms | 105.7ms | pass |
| read_model_reconcile_status | diagnostic | 200 | 2/2 | 1.5ms | 1.1ms | 1.5ms | 1.5ms | pass |
| protection_status | route | 200 | 2/2 | 1.4ms | 1.0ms | 1.4ms | 1.4ms | pass |
| release_gates | route | 200 | 2/2 | 127.3ms | 20.3ms | 127.3ms | 127.3ms | pass |
| preprocess_safety | route | 200 | 2/2 | 1.0ms | 0.5ms | 1.0ms | 1.0ms | pass |
| operations_overview | route | 200 | 2/2 | 101.3ms | 101.3ms | 108.4ms | 108.4ms | pass |
| operation_log | route | 200 | 2/2 | 33.4ms | 0.7ms | 33.4ms | 33.4ms | pass |
| source_videos_first_page | route | 200 | 2/2 | 1.8ms | 0.6ms | 1.8ms | 1.8ms | pass |
| source_videos_processing | route | 200 | 2/2 | 87.1ms | 83.5ms | 87.1ms | 87.1ms | pass |
| source_videos_index_required | route | 200 | 2/2 | 237.8ms | 230.7ms | 237.8ms | 237.8ms | pass |
| source_videos_queued | route | 200 | 2/2 | 189.7ms | 189.7ms | 196.0ms | 196.0ms | pass |
| source_videos_failed | route | 200 | 2/2 | 83.3ms | 83.3ms | 85.4ms | 85.4ms | pass |
| preprocess_jobs | route | 200 | 2/2 | 472.2ms | 207.6ms | 472.2ms | 472.2ms | pass |
| index_versions | route | 200 | 2/2 | 291.8ms | 1.9ms | 291.8ms | 291.8ms | pass |
| cutter_users | route | 200 | 2/2 | 29.4ms | 3.0ms | 29.4ms | 29.4ms | pass |
| dashboard_metrics | background | 200 | 3/3 | 460.9ms | 2.0ms | 460.9ms | 460.9ms | pass |
...
| --- | --- | ---: | ---: | ---: | --- | --- | --- | --- |
| source_videos_processing | status_store_page | 2 | 83.0ms | 85.0ms | admin-read-model=2 | paged-list=2 | hit=2 | status=processing;offset=0;limit=20;manifests=0=2 |
...
| source_videos_index_required | status_store_page | 2 | 231.0ms | 234.0ms | admin-read-model=2 | paged-list=2 | hit=2 | status=index-required;offset=0;limit=20;manifests=19=2 |
| source_videos_index_required | library_counts | 2 | 0.5ms | 1.0ms | library-manifest=2 | no-scan=2 | not-applicable=2 | video_count=11394;status=index-required;offset=0;limit=20=2 |
| source_videos_queued | status_store_page | 2 | 189.5ms | 192.0ms | admin-read-model=2 | paged-list=2 | hit=2 | status=queued;offset=0;limit=20;manifests=20=2 |
...
| source_videos_failed | status_store_page | 2 | 81.0ms | 82.0ms | admin-read-model=2 | paged-list=2 | hit=2 | status=failed;offset=0;limit=20;manifests=0=2 |
| source_videos_failed | library_counts | 2 | 1.0ms | 1.0ms | library-manifest=2 | no-scan=2 | not-applicable=2 | video_count=11394;status=failed;offset=0;limit=20=2 |
| preprocess_jobs | runtime_load | 2 | 134.5ms | 269.0ms | runtime-telemetry=2 | no-scan=2 | not-applicable=2 | status=blocked=2 |
| preprocess_jobs | preprocess_job_page | 2 | 198.0ms | 200.0ms | admin-read-model=2 | paged-list=2 | hit=2 | offset=0;limit=20;manifests=20;snapshots=0=2 |
...
| index_versions | index_package_validation | 1 | 240.0ms | 240.0ms | index-version-packages=1 | paged-list=1 | not-applicable=1 | versions=8;directory_ms=0;current_ms=0=1 |
| index_versions | current_pointer_fast_page | 1 | 48.0ms | 48.0ms | current-index=1 | paged-list=1 | hit=1 | offset=0;limit=8;result=hit;versions=8=1 |
| index_versions | cache_lookup | 1 | 0.0ms | 0.0ms | current-index=1 | no-scan=1 | hit=1 | offset=0;limit=8=1 |
| dashboard_metrics | production_summary | 1 | 174.0ms | 174.0ms | admin-read-model=1 | no-scan=1 | none | none |
| dashboard_metrics | usage_metrics | 1 | 106.0ms | 106.0ms | admin-read-model=1 | no-scan=1 | hit=1 | usage_projection=summary-hit=1 |
| dashboard_metrics | status_summary | 1 | 88.0ms | 88.0ms | admin-read-model=1 | no-scan=1 | none | none |
