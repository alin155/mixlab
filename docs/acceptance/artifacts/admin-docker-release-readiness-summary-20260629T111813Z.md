...
Generated: 2026-06-29T11:18:13.307Z
...
- Worker proof: docs/acceptance/artifacts/admin-worker-env-proof-20260629T091656Z.json
...
- Staging runbook: docs/acceptance/artifacts/admin-docker-staging-runbook-20260629T111755Z.json
...
- GitHub candidate artifact ready: true; image_tag=5a50922bc82f1b6728f247ed33e5885ab8cf6bef; build_sha=5a50922bc82f1b6728f247ed33e5885ab8cf6bef; staging_handoff_ready=false
- Live blockers: none
...
local-docker-smoke-passed | local-smoke | pass | no | local_smoke_passed=true, github_candidate_artifact_ready=true, image_tag=5a50922bc82f1b6728f247ed33e5885ab8cf6bef | Run validate:admin-docker-local-smoke on a Docker-capable machine, or archive an Admin Docker GitHub artifact readiness report with github_candidate_artifact_ready=true.
...
nas-release-inputs-intake-complete | release-inputs | pass | no | intake_complete=true, release_inputs_ready=true, staging_review_ready=true | Run the NAS collector, copy admin-docker-release-inputs/ back locally, then run intake:admin-docker-nas-release-inputs until intake_complete=true.
...
- JSON: docs/acceptance/artifacts/admin-docker-release-readiness-summary-20260629T111813Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-release-readiness-summary-20260629T111813Z.md
