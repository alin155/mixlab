...
- Admin Docker local smoke: .local-dev/admin-docker-github-runs/28362489637/mixlab-admin-docker-release-gates/admin-docker-local-smoke-20260629T093417Z.json
- Admin Docker candidate contract proof: .local-dev/admin-docker-github-runs/28362489637/mixlab-admin-docker-release-gates/admin-docker-candidate-contract-proof-20260629T093522Z.json
- Admin Docker live read-only probe: .local-dev/admin-docker-github-runs/28362489637/mixlab-admin-docker-release-gates/admin-docker-release-live-readonly-20260629T093523Z.json
- Admin Docker version parity plan: .local-dev/admin-docker-github-runs/28362489637/mixlab-admin-docker-release-gates/admin-docker-version-parity-plan-20260629T093523Z.json
- Admin worker env proof: .local-dev/admin-docker-github-runs/28362489637/mixlab-admin-docker-release-gates/admin-worker-env-proof-20260629T093523Z.json
- Cutter compatibility proof: .local-dev/admin-docker-github-runs/28362489637/mixlab-admin-docker-release-gates/admin-cutter-compatibility-proof-20260629T093524Z.json
- Admin Docker NAS release-inputs intake: .local-dev/admin-docker-github-runs/28362489637/mixlab-admin-docker-release-gates/admin-docker-nas-release-inputs-intake-20260629T093623Z.json
- Admin Docker staging runbook: .local-dev/admin-docker-github-runs/28362489637/mixlab-admin-docker-release-gates/admin-docker-staging-runbook-20260629T093624Z.json
- Admin Docker release readiness summary: .local-dev/admin-docker-github-runs/28362489637/mixlab-admin-docker-release-gates/admin-docker-release-readiness-summary-20260629T093624Z.json

## Observations

- Local smoke: accepted, passed=true
- Smoked image tag: 8a7939c1e8b2220d45d52c5fe329692516c32e4d
- Smoked build sha: 8a7939c1e8b2220d45d52c5fe329692516c32e4d
- Candidate: ready-for-candidate-review, ready=true
- Candidate source: local-smoke-report, local_smoke_passed=true
- Candidate observed image tag: 8a7939c1e8b2220d45d52c5fe329692516c32e4d
- Target image tag: 8a7939c1e8b2220d45d52c5fe329692516c32e4d
...
| artifact-admin-docker-local-smoke-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28362489637/mixlab-admin-docker-release-gates/admin-docker-local-smoke-20260629T093417Z.json |
| artifact-admin-docker-candidate-contract-proof-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28362489637/mixlab-admin-docker-release-gates/admin-docker-candidate-contract-proof-20260629T093522Z.json |
| artifact-admin-docker-release-live-readonly-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28362489637/mixlab-admin-docker-release-gates/admin-docker-release-live-readonly-20260629T093523Z.json |
| artifact-admin-docker-version-parity-plan-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28362489637/mixlab-admin-docker-release-gates/admin-docker-version-parity-plan-20260629T093523Z.json |
| artifact-admin-worker-env-proof-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28362489637/mixlab-admin-docker-release-gates/admin-worker-env-proof-20260629T093523Z.json |
| artifact-admin-cutter-compatibility-proof-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28362489637/mixlab-admin-docker-release-gates/admin-cutter-compatibility-proof-20260629T093524Z.json |
| artifact-admin-docker-nas-release-inputs-intake-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28362489637/mixlab-admin-docker-release-gates/admin-docker-nas-release-inputs-intake-20260629T093623Z.json |
| artifact-admin-docker-staging-runbook-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28362489637/mixlab-admin-docker-release-gates/admin-docker-staging-runbook-20260629T093624Z.json |
| artifact-admin-docker-release-readiness-summary-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28362489637/mixlab-admin-docker-release-gates/admin-docker-release-readiness-summary-20260629T093624Z.json |
...
| local-smoke-build-identity-current | candidate | pass | yes | yes | yes | image_tag=8a7939c1e8b2220d45d52c5fe329692516c32e4d, build_sha=8a7939c1e8b2220d45d52c5fe329692516c32e4d |
...
| candidate-build-matches-smoke | candidate | pass | yes | yes | yes | candidate.image_tag=8a7939c1e8b2220d45d52c5fe329692516c32e4d, smoke.image_tag=8a7939c1e8b2220d45d52c5fe329692516c32e4d, candidate.build_sha=8a7939c1e8b2220d45d52c5fe329692516c32e4d, smoke.build_sha=8a7939c1e8b2220d45d52c5fe329692516c32e4d |
| target-tag-matches-smoked-image | image | pass | yes | yes | yes | target=8a7939c1e8b2220d45d52c5fe329692516c32e4d, smoke.image_tag=8a7939c1e8b2220d45d52c5fe329692516c32e4d, runbook.target_tag_matches_local_smoke=true |
...
- JSON: docs/acceptance/artifacts/admin-docker-github-artifact-readiness-20260629T093703Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-github-artifact-readiness-20260629T093703Z.md
