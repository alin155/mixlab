...
Generated: 2026-06-29T11:19:25.528Z
...
| --- | --- | --- | --- | --- | --- | --- |
| desktop_html | 200 | n/a | none | html | 12.7ms | none |
| verify_is_login | 200 | 1114 | Illegal operation, unauthorized user | object(no-keys) | 14.8ms | none |
| current_user | 200 | 1114 | Illegal operation, unauthorized user | object(no-keys) | 17.5ms | none |
| docker_app_uid | 200 | 200 | success | object(result) | 351.4ms | none |
| docker_container_list | 200 | 9405 | none | object(no-keys) | 286.8ms | none |
| docker_container_list_v2 | 200 | 200 | success | object(originalTotal,result,total) | 460.6ms | none |
| docker_overview | 200 | 1114 | Illegal operation, unauthorized user | object(no-keys) | 351.5ms | none |
| filemgr_share_list | 200 | 1114 | Illegal operation, unauthorized user | object(no-keys) | 58.4ms | none |
| machine_common | 200 | 1114 | Illegal operation, unauthorized user | object(no-keys) | 15.7ms | none |
...
- JSON: docs/acceptance/artifacts/admin-docker-nas-ugos-api-preflight-20260629T111925Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-nas-ugos-api-preflight-20260629T111925Z.md
