# Admin Real NAS Performance Probe 2026-06-27T10:04:55.211Z
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| health | shell | 200 | 2/2 | 2.8ms | 2.4ms | 2.8ms | 2.8ms | pass |
| auth_status | shell | 200 | 2/2 | 3.1ms | 1.4ms | 3.1ms | 3.1ms | pass |
| library_status | shell | 200 | 2/2 | 23.0ms | 5.4ms | 23.0ms | 23.0ms | pass |
| data_loading_plan | shell | 200 | 2/2 | 0.9ms | 0.6ms | 0.9ms | 0.9ms | pass |
| read_model_status | diagnostic | 200 | 2/2 | 67.9ms | 65.2ms | 67.9ms | 67.9ms | pass |
| read_model_reconcile_status | diagnostic | 200 | 2/2 | 0.5ms | 0.3ms | 0.5ms | 0.5ms | pass |
| protection_status | route | 200 | 2/2 | 0.5ms | 0.3ms | 0.5ms | 0.5ms | pass |
| release_gates | route | 200 | 2/2 | 41.3ms | 19.5ms | 41.3ms | 41.3ms | pass |
| preprocess_safety | route | 200 | 2/2 | 1.1ms | 0.5ms | 1.1ms | 1.1ms | pass |
| operations_overview | route | 200 | 2/2 | 87.0ms | 86.0ms | 87.0ms | 87.0ms | pass |
| operation_log | route | 200 | 2/2 | 21.1ms | 0.5ms | 21.1ms | 21.1ms | pass |
| source_videos_first_page | route | 200 | 2/2 | 0.9ms | 0.4ms | 0.9ms | 0.9ms | pass |
| source_videos_processing | route | 200 | 2/2 | 66.5ms | 66.5ms | 67.6ms | 67.6ms | pass |
| source_videos_index_required | route | 200 | 2/2 | 219.0ms | 219.0ms | 222.6ms | 222.6ms | pass |
| source_videos_queued | route | 200 | 2/2 | 173.0ms | 173.0ms | 177.8ms | 177.8ms | pass |
| source_videos_failed | route | 200 | 2/2 | 72.2ms | 71.1ms | 72.2ms | 72.2ms | pass |
| preprocess_jobs | route | 200 | 2/2 | 416.6ms | 147.8ms | 416.6ms | 416.6ms | pass |
| index_versions | route | 200 | 2/2 | 222.0ms | 2.3ms | 222.0ms | 222.0ms | pass |
| cutter_users | route | 200 | 2/2 | 23.7ms | 3.0ms | 23.7ms | 23.7ms | pass |
| dashboard_metrics | background | 200 | 3/3 | 650.0ms | 2.0ms | 650.0ms | 650.0ms | pass |
...
| --- | --- | ---: | ---: | ---: | --- | --- | --- | --- |
| source_videos_processing | status_store_page | 2 | 66.5ms | 67.0ms | admin-read-model=2 | paged-list=2 | hit=2 | status=processing;offset=0;limit=20;manifests=0=2 |
...
| source_videos_index_required | status_store_page | 2 | 219.5ms | 221.0ms | admin-read-model=2 | paged-list=2 | hit=2 | status=index-required;offset=0;limit=20;manifests=19=2 |
...
| source_videos_queued | status_store_page | 2 | 172.0ms | 174.0ms | admin-read-model=2 | paged-list=2 | hit=2 | status=queued;offset=0;limit=20;manifests=20=2 |
...
| source_videos_failed | status_store_page | 2 | 69.0ms | 69.0ms | admin-read-model=2 | paged-list=2 | hit=2 | status=failed;offset=0;limit=20;manifests=0=2 |
...
| preprocess_jobs | preprocess_job_page | 2 | 147.5ms | 150.0ms | admin-read-model=2 | paged-list=2 | hit=2 | offset=0;limit=20;manifests=20;snapshots=0=2 |
...
| index_versions | index_package_validation | 1 | 177.0ms | 177.0ms | index-version-packages=1 | paged-list=1 | not-applicable=1 | versions=8;directory_ms=0;current_ms=0=1 |
...
| dashboard_metrics | production_summary | 1 | 337.0ms | 337.0ms | admin-read-model=1 | no-scan=1 | none | none |
| dashboard_metrics | material_summary | 1 | 141.0ms | 141.0ms | admin-read-model=1 | no-scan=1 | none | none |
| dashboard_metrics | usage_metrics | 1 | 94.0ms | 94.0ms | admin-read-model=1 | no-scan=1 | none | none |
| dashboard_metrics | status_summary | 1 | 71.0ms | 71.0ms | admin-read-model=1 | no-scan=1 | none | none |
| dashboard_metrics | current_index_version | 1 | 2.0ms | 2.0ms | current-index=1 | no-scan=1 | none | none |
