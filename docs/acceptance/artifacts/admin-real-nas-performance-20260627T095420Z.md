# Admin Real NAS Performance Probe 2026-06-27T09:54:20.606Z
...
| auth_status | shell | 200 | 2/2 | 1.4ms | 0.8ms | 1.4ms | 1.4ms | pass |
| library_status | shell | 200 | 2/2 | 23.0ms | 4.6ms | 23.0ms | 23.0ms | pass |
| data_loading_plan | shell | 200 | 2/2 | 1.3ms | 0.8ms | 1.3ms | 1.3ms | pass |
| read_model_status | diagnostic | 200 | 2/2 | 70.6ms | 70.2ms | 70.6ms | 70.6ms | pass |
...
| release_gates | route | 200 | 2/2 | 40.5ms | 19.8ms | 40.5ms | 40.5ms | pass |
| preprocess_safety | route | 200 | 2/2 | 1.2ms | 0.6ms | 1.2ms | 1.2ms | pass |
| operations_overview | route | 200 | 2/2 | 85.7ms | 85.7ms | 87.4ms | 87.4ms | pass |
| operation_log | route | 200 | 2/2 | 20.6ms | 0.7ms | 20.6ms | 20.6ms | pass |
| source_videos_first_page | route | 200 | 2/2 | 1.1ms | 0.4ms | 1.1ms | 1.1ms | pass |
| source_videos_processing | route | 200 | 2/2 | 75.2ms | 74.8ms | 75.2ms | 75.2ms | pass |
| source_videos_index_required | route | 200 | 2/2 | 225.1ms | 209.7ms | 225.1ms | 225.1ms | pass |
| source_videos_queued | route | 200 | 2/2 | 172.1ms | 172.1ms | 179.8ms | 179.8ms | pass |
| source_videos_failed | route | 200 | 2/2 | 73.1ms | 72.3ms | 73.1ms | 73.1ms | pass |
| preprocess_jobs | route | 200 | 2/2 | 471.6ms | 214.1ms | 471.6ms | 471.6ms | pass |
| index_versions | route | 200 | 2/2 | 200.3ms | 1.6ms | 200.3ms | 200.3ms | pass |
| cutter_users | route | 200 | 2/2 | 19.5ms | 1.9ms | 19.5ms | 19.5ms | pass |
| dashboard_metrics | background | 200 | 3/3 | 674.5ms | 0.8ms | 674.5ms | 674.5ms | pass |
...
| preprocess_jobs | preprocess_job_page | 2 | 213.0ms | 213.0ms | admin-read-model=2 | paged-list=2 | hit=2 | offset=0;limit=20;manifests=20;snapshots=0=2 |
...
| index_versions | index_package_validation | 1 | 158.0ms | 158.0ms | index-version-packages=1 | paged-list=1 | not-applicable=1 | versions=8;directory_ms=0;current_ms=0=1 |
...
| dashboard_metrics | production_summary | 1 | 365.0ms | 365.0ms | admin-read-model=1 | no-scan=1 | none | none |
...
| dashboard_metrics | status_summary | 1 | 64.0ms | 64.0ms | admin-read-model=1 | no-scan=1 | none | none |
