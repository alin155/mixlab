...
Generated: 2026-06-27T19:47:19.575Z
...
- Work dir: .local-dev/admin-docker-local-smoke/20260627T194719Z
- Compose file: .local-dev/admin-docker-local-smoke/20260627T194719Z/docker-compose.yml
- Public library host path: .local-dev/admin-docker-local-smoke/20260627T194719Z/PublicLibrary
...
- Image tag: local-admin-docker-mvp-v0.1
- Build SHA: local-docker-smoke
- Build version: admin-docker-mvp-v0.1
- MVP mode: v0.1
...
- JSON: docs/acceptance/artifacts/admin-docker-local-smoke-20260627T194719Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-local-smoke-20260627T194719Z.md
