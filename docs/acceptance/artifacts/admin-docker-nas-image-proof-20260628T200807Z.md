...
Generated: 2026-06-28T20:08:07.397Z
...
- Env file: docs/acceptance/artifacts/admin-docker-nas-desktop-returned-evidence-20260628T200756Z/admin-docker-release-inputs/admin-docker-current.env
- Inspect JSON: docs/acceptance/artifacts/admin-docker-nas-desktop-returned-evidence-20260628T200756Z/admin-docker-release-inputs/admin-docker-current.inspect.json
...
| nas-env-file-provided | evidence | pass | no | docs/acceptance/artifacts/admin-docker-nas-desktop-returned-evidence-20260628T200756Z/admin-docker-release-inputs/admin-docker-current.env |
| nas-inspect-json-provided | evidence | pass | no | docs/acceptance/artifacts/admin-docker-nas-desktop-returned-evidence-20260628T200756Z/admin-docker-release-inputs/admin-docker-current.inspect.json |
...
- JSON: docs/acceptance/artifacts/admin-docker-nas-image-proof-20260628T200807Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-nas-image-proof-20260628T200807Z.md
