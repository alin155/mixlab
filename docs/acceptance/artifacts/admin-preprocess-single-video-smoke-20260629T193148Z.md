...
Generated: 2026-06-29T19:31:48.832Z
...
- Snapshot dir: docs/acceptance/artifacts/admin-preprocess-single-video-smoke-20260629T193148Z/pre-smoke-snapshot
...
| --- | --- | --- | --- | --- | --- | --- |
.mixlab-library/videos/V000421/source-video.json | no | no | n/a | n/a | {} | none
.mixlab-library/videos/V000421/preprocess-job.json | no | no | n/a | n/a | {} | none
...
- Execute blockers: execute-body-is-single-target, single-video-execution-succeeded, post-smoke-baseline-preserved, post-smoke-nas-file-persistence

## Requests

| Probe | Request | HTTP | OK | Duration | Error |
| --- | --- | --- | --- | --- | --- |
auth_status | GET /api/admin/auth/status | 200 | yes | 35.7ms | none
library_status_before | GET /api/admin/library/status | 200 | yes | 12.3ms | none
preprocess_safety | GET /api/admin/preprocess/safety | 200 | yes | 15.5ms | none
supervisor_status_before | GET /api/admin/preprocess/supervisor/status | 200 | yes | 5.5ms | none
source_videos_processing_before | GET /api/admin/source-videos?status=processing&limit=20 | 200 | yes | 35.3ms | none
source_video_before | GET /api/admin/source-videos/V000421 | 200 | yes | 8.4ms | none
...
pre-smoke-snapshot-captured | snapshot | pass | yes | yes | Copied 5 files to docs/acceptance/artifacts/admin-preprocess-single-video-smoke-20260629T193148Z/pre-smoke-snapshot. | n/a
...
post-smoke-nas-file-persistence | postcheck | needs-follow-up | no | yes | Dry-run only; direct NAS post-file persistence check runs after execute. | After execute, direct source-video.json, preprocess-job.json, and library.json on the NAS mount must match API postcheck and contain no NUL padding.

## Artifacts

- JSON: docs/acceptance/artifacts/admin-preprocess-single-video-smoke-20260629T193148Z.json
- Markdown: docs/acceptance/artifacts/admin-preprocess-single-video-smoke-20260629T193148Z.md
