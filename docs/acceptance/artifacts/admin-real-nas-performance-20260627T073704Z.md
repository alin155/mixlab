# Admin Real NAS Performance Probe 2026-06-27T07:37:04.319Z
...
| auth_status | shell | 200 | 2/2 | 1.9ms | 0.8ms | 1.9ms | 1.9ms | pass |
| library_status | shell | 200 | 2/2 | 24.4ms | 5.4ms | 24.4ms | 24.4ms | pass |
| data_loading_plan | shell | 200 | 2/2 | 0.9ms | 0.6ms | 0.9ms | 0.9ms | pass |
| read_model_status | diagnostic | 200 | 2/2 | 73.4ms | 73.4ms | 76.2ms | 76.2ms | pass |
...
| release_gates | route | 200 | 2/2 | 53.5ms | 20.0ms | 53.5ms | 53.5ms | pass |
| preprocess_safety | route | 200 | 2/2 | 1.0ms | 0.5ms | 1.0ms | 1.0ms | pass |
| operations_overview | route | 200 | 2/2 | 90.4ms | 90.4ms | 92.1ms | 92.1ms | pass |
| operation_log | route | 200 | 2/2 | 18.6ms | 0.6ms | 18.6ms | 18.6ms | pass |
| source_videos_first_page | route | 200 | 2/2 | 1.3ms | 0.5ms | 1.3ms | 1.3ms | pass |
| source_videos_processing | route | 200 | 2/2 | 74.5ms | 71.4ms | 74.5ms | 74.5ms | pass |
| source_videos_index_required | route | 200 | 2/2 | 224.2ms | 224.2ms | 231.1ms | 231.1ms | pass |
| source_videos_queued | route | 200 | 2/2 | 184.5ms | 184.5ms | 191.3ms | 191.3ms | pass |
| source_videos_failed | route | 200 | 2/2 | 80.2ms | 72.8ms | 80.2ms | 80.2ms | pass |
| preprocess_jobs | route | 200 | 2/2 | 476.1ms | 473.4ms | 476.1ms | 476.1ms | pass |
| index_versions | route | 200 | 2/2 | 216.3ms | 1.5ms | 216.3ms | 216.3ms | pass |
| cutter_users | route | 200 | 2/2 | 23.8ms | 2.5ms | 23.8ms | 23.8ms | pass |
| dashboard_metrics | background | 200 | 3/3 | 925.0ms | 2.3ms | 925.0ms | 925.0ms | pass |
...
| --- | --- | ---: | ---: | ---: | --- | --- | --- |
| dashboard_metrics | production_summary | 1 | 345.0ms | 345.0ms | admin-read-model=1 | none | none |
| dashboard_metrics | runtime_load | 1 | 261.0ms | 261.0ms | runtime-telemetry=1 | none | none |
| dashboard_metrics | material_summary | 1 | 140.0ms | 140.0ms | admin-read-model=1 | none | none |
