# Admin Process History Live Browser QA 2026-06-26T11:40:00.924Z
...
| --- | ---: | ---: | ---: | ---: | --- |
| desktop | 1440x960 | 5719.4ms | 20 | 0px | `docs/acceptance/artifacts/admin-process-history-live-browser-qa-20260626T114000Z-desktop.png` |
| mobile | 390x844 | 3697.8ms | 20 | 0px | `docs/acceptance/artifacts/admin-process-history-live-browser-qa-20260626T114000Z-mobile.png` |

## Direct API Probes

| path | status | result | duration | bytes |
| --- | ---: | --- | ---: | ---: |
| `/api/admin/library/status` | 200 | ok | 47.7ms | 732 |
| `/api/admin/preprocess/process-history/readiness` | 200 | ok | 302.1ms | 789 |
| `/api/admin/preprocess/process-history?limit=20&window_days=30` | 200 | ok | 2821.0ms | 6686 |
