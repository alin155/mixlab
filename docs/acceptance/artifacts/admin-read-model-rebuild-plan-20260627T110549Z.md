# Admin Read Model Rebuild Plan 2026-06-27T11:05:49.994Z
...
| request-success | fail | process_history:timeout |
...
| --- | --- | ---: | --- | ---: |
| auth_status | GET /api/admin/auth/status | 200 | pass | 60.7ms |
| library_status | GET /api/admin/library/status | 200 | pass | 59.5ms |
| read_model_status | GET /api/admin/read-model/status | 200 | pass | 94.9ms |
| reconcile_status | GET /api/admin/read-model/reconcile/status | 200 | pass | 0.8ms |
| process_history_readiness | GET /api/admin/preprocess/process-history/readiness | 200 | pass | 273.7ms |
| process_history | GET /api/admin/preprocess/process-history?limit=20&window_days=30 | n/a | fail | 8004.3ms |

## Result

- Status: `failed`
- Passed: `false`
- Summary: failed gates: request-success, process-history-currently-no-scan
