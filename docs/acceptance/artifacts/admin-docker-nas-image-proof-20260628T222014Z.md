...
- Env file: docs/acceptance/artifacts/admin-docker-nas-ugos-returned-evidence-20260628T221951Z/admin-docker-release-inputs/admin-docker-current.env
- Inspect JSON: docs/acceptance/artifacts/admin-docker-nas-ugos-returned-evidence-20260628T221951Z/admin-docker-release-inputs/admin-docker-current.inspect.json
...
| nas-env-file-provided | evidence | pass | no | docs/acceptance/artifacts/admin-docker-nas-ugos-returned-evidence-20260628T221951Z/admin-docker-release-inputs/admin-docker-current.env |
| nas-inspect-json-provided | evidence | pass | no | docs/acceptance/artifacts/admin-docker-nas-ugos-returned-evidence-20260628T221951Z/admin-docker-release-inputs/admin-docker-current.inspect.json |
...
- JSON: docs/acceptance/artifacts/admin-docker-nas-image-proof-20260628T222014Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-nas-image-proof-20260628T222014Z.md
