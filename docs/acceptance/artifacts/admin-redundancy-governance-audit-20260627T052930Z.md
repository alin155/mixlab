...
Generated: 2026-06-27T05:29:30.935Z
...
fixture-fallback-legacy-hotspots-reviewed | fallbacks | blocked | yes | 26 files contain fixture/fallback/legacy/mock/deprecated/TODO terms and need classification before cleanup. | Classify each cleanup candidate as test fixture, safe fallback, legacy compatibility, or removable dead code before editing.
...
- path: packages/admin-api/src/admin-read-model-store.ts; line_count: 2477
- path: apps/admin-web/src/app/AdminApp.tsx; line_count: 2400
- path: packages/admin-api/src/admin-read-model-store.test.ts; line_count: 1808
...
- path: packages/admin-api/src/index.ts; line_count: 1034
...
- path: packages/admin-api/src/admin-source-video-status-page-query.test.ts; count: 2; terms: fallback

## Artifacts

- JSON: docs/acceptance/artifacts/admin-redundancy-governance-audit-20260627T052930Z.json
- Markdown: docs/acceptance/artifacts/admin-redundancy-governance-audit-20260627T052930Z.md
