...
Generated: 2026-06-29T09:16:31.661Z
...
nas-release-inputs-intake-complete | release-inputs | pass | no | intake_complete=true, release_inputs_ready=false, staging_review_ready=false | Run the NAS collector, copy admin-docker-release-inputs/ back locally, then run intake:admin-docker-nas-release-inputs until intake_complete=true.
...
- JSON: docs/acceptance/artifacts/admin-docker-release-readiness-summary-20260629T091631Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-release-readiness-summary-20260629T091631Z.md
