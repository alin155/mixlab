...
Generated: 2026-06-29T03:22:43.482Z
...
- GitHub run: 28346369749
- GitHub run URL: https://github.com/alin155/mixlab/actions/runs/28346369749
...
- Candidate branch: admin-docker-candidate-73ab7b355051d7325174111f955cd8356d42787d
- Workflow ref: admin-docker-candidate-73ab7b355051d7325174111f955cd8356d42787d
- Release ref setup: git tag admin-docker-candidate-73ab7b355051d7325174111f955cd8356d42787d 73ab7b355051d7325174111f955cd8356d42787d && git push origin refs/tags/admin-docker-candidate-73ab7b355051d7325174111f955cd8356d42787d:refs/tags/admin-docker-candidate-73ab7b355051d7325174111f955cd8356d42787d
- Workflow command: gh workflow run docker-admin.yml --repo alin155/mixlab --ref admin-docker-candidate-73ab7b355051d7325174111f955cd8356d42787d -f push_images=true -f current_image_tag=<current-admin-docker-image-tag> -f rollback_image_tag=<current-admin-docker-image-tag>
- Candidate ref proof command: MIXLAB_ADMIN_DOCKER_CANDIDATE_REF_SHA=73ab7b355051d7325174111f955cd8356d42787d MIXLAB_ADMIN_DOCKER_CANDIDATE_REF_TAG=admin-docker-candidate-73ab7b355051d7325174111f955cd8356d42787d MIXLAB_ADMIN_DOCKER_CANDIDATE_REF_RUN_ID=<tag-ref-push-images-false-run-id> MIXLAB_ADMIN_DOCKER_CANDIDATE_REF_ARTIFACT_DIR=<downloaded-tag-ref-release-gates-artifact-dir> npm run validate:admin-docker-candidate-ref-proof
...
| current-worktree-candidate-ready | candidate | pass | no | no | yes | current_worktree_candidate_ready=true, github_run_candidate_ready=true, immutable_candidate_ref_ready=true, run=https://github.com/alin155/mixlab/actions/runs/28346369749 |
...
| nas-disk-risk-carried-forward | live-baseline | blocked | no | yes | yes | disk_usage=65%, disk_status=healthy, live_upload_blockers=current-admin-api-contract-live, auth-context-live, build-version-health, version-health-parity-contract-live, preprocess-disk, disk-space-protection-contract-live, usage-events-tolerance, usage-events-repair-contract-live, processing-recovery, processing-recovery-contract-live, current-index, data-loading-contract-live, admin-worker-env-proof-contract-live, admin-worker-live-flags, cutter-compatibility-proof-contract-live, cutter-release-compatibility-live |
...
- Staging execution blockers: nas-disk-risk-carried-forward, explicit-push-approval-required, current-and-rollback-tags-required
...
- Before explicit push approval, create or verify the immutable release ref admin-docker-candidate-73ab7b355051d7325174111f955cd8356d42787d points at candidate SHA 73ab7b355051d7325174111f955cd8356d42787d.
...
- After explicit approval, rerun the Admin Docker workflow with --ref admin-docker-candidate-73ab7b355051d7325174111f955cd8356d42787d, push_images=true, current_image_tag=<current-tag>, rollback_image_tag=<current-tag>, and target image 73ab7b355051d7325174111f955cd8356d42787d.
...
- JSON: docs/acceptance/artifacts/admin-docker-prestaging-handoff-20260629T032243Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-prestaging-handoff-20260629T032243Z.md
