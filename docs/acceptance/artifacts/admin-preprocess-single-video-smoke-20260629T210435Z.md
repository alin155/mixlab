...
Generated: 2026-06-29T21:04:35.875Z
...
- Candidate before: status=queued, visible=false, size=12364556, path=陶矜2/2024年素材/2403上海花絮/100CANON/0Q9A2921.MP4
...
- Snapshot dir: docs/acceptance/artifacts/admin-preprocess-single-video-smoke-20260629T210435Z/pre-smoke-snapshot
...
source-video-manifest | yes | .mixlab-library/videos/V006278/source-video.json | 621
preprocess-job | no | .mixlab-library/videos/V006278/preprocess-job.json | 141
preprocess-log | no | .mixlab-library/logs/V006278.log | 65
...
| --- | --- | --- | --- | --- | --- | --- |
.mixlab-library/videos/V006278/source-video.json | yes | yes | yes | 753 | {"source_video_id":"V006278","preprocess_status":"queued","visible_to_cutters":false,"transcript_path":"","srt_path":"","cover_path":"","keyframes_path":""} | none
.mixlab-library/videos/V006278/preprocess-job.json | yes | yes | yes | 205 | {"source_video_id":"V006278","status":"queued","attempt":3,"worker_id":"admin","claimed_at":"2026-06-24T12:49:15.282Z"} | none
...
| --- | --- | --- | --- | --- | --- |
auth_status | GET /api/admin/auth/status | 200 | yes | 15.2ms | none
library_status_before | GET /api/admin/library/status | 200 | yes | 14.7ms | none
preprocess_safety | GET /api/admin/preprocess/safety | 200 | yes | 1135.5ms | none
supervisor_status_before | GET /api/admin/preprocess/supervisor/status | 200 | yes | 5.2ms | none
source_videos_processing_before | GET /api/admin/source-videos?status=processing&limit=20 | 200 | yes | 13.2ms | none
source_video_before | GET /api/admin/source-videos/V006278 | 200 | yes | 6.0ms | none
supervisor_start | POST /api/admin/preprocess/supervisor/start | 200 | yes | 14.4ms | none
...
supervisor_status_poll | GET /api/admin/preprocess/supervisor/status | 200 | yes | 103.9ms | none
supervisor_status_poll | GET /api/admin/preprocess/supervisor/status | 200 | yes | 13.7ms | none
...
source_videos_processing_after | GET /api/admin/source-videos?status=processing&limit=20 | 200 | yes | 62.0ms | none
source_video_after | GET /api/admin/source-videos/V006278 | 200 | yes | 8.9ms | none
preprocess_job_log_after | GET /api/admin/preprocess/jobs/J006278/log | 200 | yes | 7.9ms | none

## Gates

| Gate | Category | Status | Blocks Dry-run | Blocks Execute | Evidence | Required Evidence |
| --- | --- | --- | --- | --- | --- | --- |
single-video-scope-only | scope | pass | yes | yes | source_video_id=V006278. | n/a
...
candidate-is-queued-and-hidden | library | pass | yes | yes | status=queued, visible_to_cutters=false, path=陶矜2/2024年素材/2403上海花絮/100CANON/0Q9A2921.MP4, size=12364556. | n/a
...
pre-smoke-snapshot-captured | snapshot | pass | yes | yes | Copied 5 files to docs/acceptance/artifacts/admin-preprocess-single-video-smoke-20260629T210435Z/pre-smoke-snapshot. | n/a
dry-run-does-not-post | execution | needs-follow-up | no | no | Execution mode was explicitly requested. | n/a
execute-body-is-single-target | execution | pass | no | yes | start_body={"limit":1,"source_video_id":"V006278"}. | n/a
...
- JSON: docs/acceptance/artifacts/admin-preprocess-single-video-smoke-20260629T210435Z.json
- Markdown: docs/acceptance/artifacts/admin-preprocess-single-video-smoke-20260629T210435Z.md
