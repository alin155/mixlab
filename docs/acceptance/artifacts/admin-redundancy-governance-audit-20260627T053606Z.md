...
Generated: 2026-06-27T05:36:06.886Z
...
fixture-fallback-legacy-hotspots-reviewed | fallbacks | blocked | yes | 27 files contain fixture/fallback/legacy/mock/deprecated/TODO terms and need classification before cleanup. | Classify each cleanup candidate as test fixture, safe fallback, legacy compatibility, or removable dead code before editing.
...
- path: apps/admin-web/src/api.ts; line_count: 2715
- path: apps/admin-web/src/admin-app.test.ts; line_count: 2619
- path: packages/admin-api/src/admin-read-model-store.ts; line_count: 2543
- path: apps/admin-web/src/app/AdminApp.tsx; line_count: 2400
- path: packages/admin-api/src/admin-read-model-store.test.ts; line_count: 1892
...
- JSON: docs/acceptance/artifacts/admin-redundancy-governance-audit-20260627T053606Z.json
- Markdown: docs/acceptance/artifacts/admin-redundancy-governance-audit-20260627T053606Z.md
