# Admin Isolated No-Repair Performance Probe 2026-06-27T06:40:02.390Z
...
- Temporary server: `127.0.0.1:61171`, health wait `372.1ms`
- Performance artifacts: `docs/acceptance/artifacts/admin-real-nas-performance-20260627T064002Z.json`, `docs/acceptance/artifacts/admin-real-nas-performance-20260627T064002Z.md`

## Summary

- Endpoints: `20`
- Failed endpoint samples: `0`
- Slow endpoint gates: `1`
...
| performance-targets-met | blocked | operation_log p95=3932.2 target=1000 |
