...
Generated: 2026-06-28T00:37:59.008Z
...
- Pre-staging handoff: docs/acceptance/artifacts/admin-docker-prestaging-handoff-20260628T003744Z.json
...
prestaging-handoff-provided | handoff | pass | no | yes | yes | docs/acceptance/artifacts/admin-docker-prestaging-handoff-20260628T003744Z.json
...
handoff-staging-blockers-carried-forward | handoff | blocked | no | yes | yes | staging blockers=nas-disk-risk-carried-forward, explicit-push-approval-required, current-and-rollback-tags-required, staged-live-readonly-required, admin-worker-env-proof-required, cutter-compatibility-proof-required
...
target-image-tag-present | release-input | pass | no | yes | yes | target_image_tag=5c0e8dfe5d1e8621a8bdb1e14524349a283af28d
...
target-tag-differs-from-current | release-input | blocked | yes | yes | yes | target=5c0e8dfe5d1e8621a8bdb1e14524349a283af28d, current=missing
...
- JSON: docs/acceptance/artifacts/admin-docker-release-inputs-20260628T003759Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-release-inputs-20260628T003759Z.md
