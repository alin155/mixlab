# Admin Read Model Rebuild Plan 2026-06-26T11:07:36.084Z
...
| --- | --- | ---: | --- | ---: |
| auth_status | GET /api/admin/auth/status | 200 | pass | 61.1ms |
| library_status | GET /api/admin/library/status | 200 | pass | 188.9ms |
| read_model_status | GET /api/admin/read-model/status | 200 | pass | 127.5ms |
| reconcile_status | GET /api/admin/read-model/reconcile/status | 200 | pass | 0.8ms |
| process_history_readiness | GET /api/admin/preprocess/process-history/readiness | 200 | pass | 173.2ms |
| process_history | GET /api/admin/preprocess/process-history?limit=20&window_days=30 | 200 | pass | 136.5ms |
