...
Generated: 2026-06-29T02:58:36.447Z
...
| --- | --- | --- | --- | --- | --- |
admin_web_root | GET / | 200 | yes | 31.7ms | none
auth_status | GET /api/admin/auth/status | 404 | no | 12.1ms | not_found
library_status | GET /api/admin/library/status | 200 | yes | 830.7ms | none
release_gates | GET /api/admin/release-gates | 404 | no | 7.9ms | not_found
dashboard_metrics | GET /api/admin/dashboard/metrics | 200 | yes | 5867.1ms | none
data_loading_plan | GET /api/admin/data-loading/plan | 404 | no | 13.4ms | not_found
preprocess_supervisor_status | GET /api/admin/preprocess/supervisor/status | 200 | yes | 6.4ms | none
...
dashboard-metrics-live | Dashboard metrics read does not fail live | live-admin | pass | no | HTTP 200, 7425 bytes | n/a
...
- JSON: docs/acceptance/artifacts/admin-docker-release-live-readonly-20260629T025836Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-release-live-readonly-20260629T025836Z.md
