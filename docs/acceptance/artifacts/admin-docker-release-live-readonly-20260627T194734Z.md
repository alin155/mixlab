...
Generated: 2026-06-27T19:47:34.564Z
...
- Safe to probe: no
- Target classification: MIXLAB_ADMIN_DOCKER_LIVE_BASE_URL is not set.
- Target notes: Set the variable to the NAS Docker admin-web URL, for example http://<nas-ip>:8080.; Do not use the NAS desktop URL as Docker release evidence.
...
target-url-admin-web-shape | Target URL is the NAS Docker admin-web root | target | blocked | yes | not-configured: MIXLAB_ADMIN_DOCKER_LIVE_BASE_URL is not set. | Set MIXLAB_ADMIN_DOCKER_LIVE_BASE_URL to the NAS Docker admin-web root, not Mac localhost, NAS desktop, or a subpath.
...
- JSON: docs/acceptance/artifacts/admin-docker-release-live-readonly-20260627T194734Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-release-live-readonly-20260627T194734Z.md
