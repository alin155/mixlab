...
Generated: 2026-06-29T03:54:03.283Z
...
| --- | --- | --- | --- | --- | --- | --- |
| desktop_html | 200 | n/a | none | html | 5.1ms | none |
| verify_is_login | 200 | 1114 | Illegal operation, unauthorized user | object(no-keys) | 10.8ms | none |
| current_user | 200 | 1114 | Illegal operation, unauthorized user | object(no-keys) | 10.8ms | none |
| docker_app_uid | 200 | 200 | success | object(result) | 10.7ms | none |
| docker_container_list | 200 | 9405 | none | object(no-keys) | 25.7ms | none |
| docker_container_list_v2 | 200 | 200 | success | object(originalTotal,result,total) | 13.9ms | none |
| docker_overview | 200 | 1114 | Illegal operation, unauthorized user | object(no-keys) | 25.3ms | none |
| filemgr_share_list | 200 | 1114 | Illegal operation, unauthorized user | object(no-keys) | 10.7ms | none |
| machine_common | 200 | 1114 | Illegal operation, unauthorized user | object(no-keys) | 10.3ms | none |
...
- JSON: docs/acceptance/artifacts/admin-docker-nas-ugos-api-preflight-20260629T035403Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-nas-ugos-api-preflight-20260629T035403Z.md
