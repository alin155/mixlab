...
Generated: 2026-06-28T22:08:35.235Z
...
- Worker proof: docs/acceptance/artifacts/admin-worker-env-proof-20260628T220358Z.json
...
- Release inputs intake: docs/acceptance/artifacts/admin-docker-nas-release-inputs-intake-20260628T220358Z.json
- NAS access preflight: docs/acceptance/artifacts/admin-docker-nas-access-preflight-20260628T220827Z.json
- NAS handoff kit: docs/acceptance/artifacts/admin-docker-nas-handoff-kit-latest.json
- Staging runbook: docs/acceptance/artifacts/admin-docker-staging-runbook-20260628T220358Z.json
...
- NAS handoff kit ready: true; archive: dist/acceptance/admin-docker-nas-handoff-kit.tar.gz; sha256=6e73f0867694a5578baf6fb895d33e8edabe993e10f1fa44e982a4d459891fca; blockers: none
...
- Transfer dist/acceptance/admin-docker-nas-handoff-kit.tar.gz to the NAS desktop or NAS shell host, verify sha256=6e73f0867694a5578baf6fb895d33e8edabe993e10f1fa44e982a4d459891fca, run the kit self-check, then collect returned release inputs.
...
- Run the NAS release-inputs collector, copy admin-docker-release-inputs/ back to the Mac repo, then rerun intake:admin-docker-nas-release-inputs. Current intake blockers: nas-image-proof-accepted, admin-worker-proof-accepted, nas-disk-proof-accepted.
...
- JSON: docs/acceptance/artifacts/admin-docker-release-readiness-summary-20260628T220835Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-release-readiness-summary-20260628T220835Z.md
