# Admin Isolated No-Repair Performance Probe 2026-06-27T14:09:58.517Z
...
- Temporary server: `127.0.0.1:60765`, health wait `379ms`
- Performance artifacts: `docs/acceptance/artifacts/admin-real-nas-performance-20260627T140959Z.json`, `docs/acceptance/artifacts/admin-real-nas-performance-20260627T140959Z.md`
...
| --- | ---: | ---: | ---: | ---: | --- | --- | --- | --- | --- | --- | --- |
| source_videos_processing | 2/2 | 2/2 | 82.6ms | 1000.0ms | admin-read-model=2 | paged-list=2 | hit=2 | none | none | status_store_page max 82.0ms, library_counts max 0.0ms | complete |
| source_videos_index_required | 2/2 | 2/2 | 232.2ms | 1000.0ms | admin-read-model=2 | paged-list=2 | hit=2 | none | none | status_store_page max 229.0ms, library_counts max 0.0ms | complete |
| preprocess_jobs | 2/2 | 2/2 | 475.6ms | 1000.0ms | admin-read-model=2 | status-scan=2 | hit=2 | none | none | runtime_load max 263.0ms, preprocess_job_page max 205.0ms, concurrency_policy max 1.0ms, library_counts max 0.0ms | complete |
| index_versions | 2/2 | 2/2 | 212.1ms | 1000.0ms | current-index=2 | paged-list=2 | hit=1, miss=1 | none | none | index_package_validation max 169.0ms, current_pointer_fast_page max 39.0ms, cache_lookup max 0.0ms | complete |
...
| --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- | --- | --- | --- | --- |
| dashboard_metrics | background | 3/3 | 3/3 | 452.1ms | 8000.0ms | admin-read-model=3 | no-scan=3 | hit=2, miss=1 | none | none | production_summary max 171.0ms, usage_metrics max 112.0ms, status_summary max 81.0ms, material_summary max 78.0ms, current_index_version max 4.0ms, transcript_metrics max 2.0ms, dashboard_metrics_cache max 0.0ms, library_manifest max 0.0ms, preprocess_jobs max 0.0ms, runtime_load max 0.0ms | complete |
