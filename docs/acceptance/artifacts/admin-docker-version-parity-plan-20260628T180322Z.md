...
Generated: 2026-06-28T18:03:22.116Z
...
- Artifact: docs/acceptance/artifacts/admin-docker-release-live-readonly-20260628T180312Z.json
...
admin-web-root-observed | live-evidence | pass | no | HTTP 200, ok, 29.6ms | Admin Web root must be reachable before comparing API/image parity.
admin-api-proxy-observed | live-evidence | pass | no | auth=HTTP 404, not_found 路由不存在, 11.3ms; library=HTTP 200, ok, 886.6ms; supervisor=HTTP 200, ok, 5.8ms | At least one Admin API JSON endpoint must respond through Admin Web before diagnosing image/API parity.
...
- JSON: docs/acceptance/artifacts/admin-docker-version-parity-plan-20260628T180322Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-version-parity-plan-20260628T180322Z.md
