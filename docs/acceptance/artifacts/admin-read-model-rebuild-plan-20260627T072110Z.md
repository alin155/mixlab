# Admin Read Model Rebuild Plan 2026-06-27T07:21:10.635Z
...
| --- | --- | ---: | --- | ---: |
| auth_status | GET /api/admin/auth/status | 200 | pass | 54.8ms |
| library_status | GET /api/admin/library/status | 200 | pass | 60.1ms |
| read_model_status | GET /api/admin/read-model/status | 200 | pass | 111.5ms |
| reconcile_status | GET /api/admin/read-model/reconcile/status | 200 | pass | 0.7ms |
| process_history_readiness | GET /api/admin/preprocess/process-history/readiness | 200 | pass | 274.7ms |
| process_history | GET /api/admin/preprocess/process-history?limit=20&window_days=30 | 200 | pass | 3129.4ms |
