...
Generated: 2026-06-29T07:57:51.871Z
...
- Env file: .local-dev/admin-docker-staging/20260629T065634Z/returned-evidence-from-staging-poll/admin-worker.env
- Inspect JSON: .local-dev/admin-docker-staging/20260629T065634Z/returned-evidence-from-staging-poll/admin-worker.inspect.json
...
- Image: ghcr.io/alin155/mixlab-admin-runtime:9c015b9105e97954240020781f79daae3f954bde
...
env-file-provided | evidence | pass | no | Read .local-dev/admin-docker-staging/20260629T065634Z/returned-evidence-from-staging-poll/admin-worker.env. | Provide a sanitized admin-worker.env file from the NAS host containing only the required MVP worker flags.
inspect-json-provided | evidence | pass | no | Read .local-dev/admin-docker-staging/20260629T065634Z/returned-evidence-from-staging-poll/admin-worker.inspect.json. | Provide sanitized docker inspect JSON for the running admin-worker container without full Config.Env secrets.
...
admin-worker-image-observed | image | pass | no | image=ghcr.io/alin155/mixlab-admin-runtime:9c015b9105e97954240020781f79daae3f954bde, container=mixlab-server-admin-worker-1 | docker inspect evidence must include the running admin-worker image.

## Artifacts

- JSON: docs/acceptance/artifacts/admin-worker-env-proof-20260629T075751Z.json
- Markdown: docs/acceptance/artifacts/admin-worker-env-proof-20260629T075751Z.md
