...
| release-inputs-generated | release-inputs | pass | no | no | yes | yes | docs/acceptance/artifacts/admin-docker-release-inputs-20260629T021804Z.json |
| release-inputs-ready | release-inputs | pass | no | no | yes | yes | status=ready-for-release-decision, blockers=none |
| staging-runbook-generated | runbook | pass | no | no | no | yes | docs/acceptance/artifacts/admin-docker-staging-runbook-20260629T021804Z.json |
...
- JSON: docs/acceptance/artifacts/admin-docker-nas-release-inputs-intake-20260629T021804Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-nas-release-inputs-intake-20260629T021804Z.md
