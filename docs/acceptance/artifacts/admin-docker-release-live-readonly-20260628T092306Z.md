...
Generated: 2026-06-28T09:23:06.079Z
...
| --- | --- | --- | --- | --- | --- |
admin_web_root | GET / | n/a | no | 129.0ms | request_failed
auth_status | GET /api/admin/auth/status | n/a | no | 35.4ms | request_failed
library_status | GET /api/admin/library/status | n/a | no | 34.3ms | request_failed
release_gates | GET /api/admin/release-gates | n/a | no | 34.4ms | request_failed
dashboard_metrics | GET /api/admin/dashboard/metrics | n/a | no | 34.3ms | request_failed
data_loading_plan | GET /api/admin/data-loading/plan | n/a | no | 33.8ms | request_failed
preprocess_supervisor_status | GET /api/admin/preprocess/supervisor/status | n/a | no | 35.1ms | request_failed
...
- JSON: docs/acceptance/artifacts/admin-docker-release-live-readonly-20260628T092306Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-release-live-readonly-20260628T092306Z.md
