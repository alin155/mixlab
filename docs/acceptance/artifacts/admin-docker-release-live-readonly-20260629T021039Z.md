...
Generated: 2026-06-29T02:10:39.967Z
...
| --- | --- | --- | --- | --- | --- |
admin_web_root | GET / | 200 | yes | 56.6ms | none
auth_status | GET /api/admin/auth/status | 404 | no | 13.9ms | not_found
library_status | GET /api/admin/library/status | 200 | yes | 6451.5ms | none
release_gates | GET /api/admin/release-gates | 404 | no | 11.6ms | not_found
dashboard_metrics | GET /api/admin/dashboard/metrics | n/a | no | 10003.5ms | timeout
data_loading_plan | GET /api/admin/data-loading/plan | 404 | no | 13.2ms | not_found
preprocess_supervisor_status | GET /api/admin/preprocess/supervisor/status | 200 | yes | 12.6ms | none
...
dashboard-metrics-live | Dashboard metrics read does not fail live | live-admin | blocked | yes | Dashboard metrics not proven: HTTP n/a, timeout This operation was aborted | Run GET /api/admin/dashboard/metrics successfully against the NAS Docker target.
...
- JSON: docs/acceptance/artifacts/admin-docker-release-live-readonly-20260629T021039Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-release-live-readonly-20260629T021039Z.md
