...
Generated: 2026-06-26T21:16:14.852Z
...
- Large file candidates: 20
- Term hotspot candidates: 19
...
large-admin-files-reviewed | code-size | blocked | yes | 20 files meet or exceed 700 lines and need targeted ownership decisions. | Large files should be split only along established query/command/page/component boundaries with focused tests.
fixture-fallback-legacy-hotspots-reviewed | fallbacks | blocked | yes | 19 files contain fixture/fallback/legacy/mock/deprecated/TODO terms and need classification before cleanup. | Classify each cleanup candidate as test fixture, safe fallback, legacy compatibility, or removable dead code before editing.
...
- path: apps/admin-web/src/styles.css; line_count: 6166
- path: packages/admin-api/src/index.test.ts; line_count: 4430
- path: apps/admin-web/src/api.ts; line_count: 3746
- path: packages/admin-api/src/index.ts; line_count: 3007
- path: apps/admin-web/src/admin-app.test.ts; line_count: 2619
- path: packages/admin-api/src/admin-read-model-store.ts; line_count: 2469
- path: apps/admin-web/src/app/AdminApp.tsx; line_count: 2400
- path: packages/admin-api/src/admin-read-model-store.test.ts; line_count: 1742
- path: apps/admin-web/src/api.test.ts; line_count: 1446
...
- path: apps/admin-web/src/features/dashboard/DashboardPage.tsx; line_count: 923
...
- path: apps/admin-web/src/features/preprocess-jobs/PreprocessJobsPage.tsx; line_count: 842
- path: apps/admin-web/src/fixtures/admin-fixture-data.ts; line_count: 819
- path: packages/library-fs/src/usage-events.test.ts; line_count: 796
- path: apps/admin-web/src/features/operation-log/OperationLogPage.tsx; line_count: 769

## Term Hotspots

- path: apps/admin-web/src/api.ts; count: 39; terms: fixture, fallback
- path: apps/admin-web/src/fixtures/admin-data-loading-plan.ts; count: 34; terms: fixture, fallback
- path: apps/admin-web/src/api.test.ts; count: 31; terms: fixture
- path: apps/admin-web/src/admin-app.test.ts; count: 17; terms: fixture, fallback, legacy
...
- path: packages/admin-api/src/index.test.ts; count: 2; terms: fixture
- path: packages/admin-api/src/index.ts; count: 2; terms: fallback
- path: apps/admin-web/src/admin-reference.css; count: 1; terms: legacy
- path: packages/admin-api/src/admin-auth-routes.test.ts; count: 1; terms: fallback
- path: packages/admin-api/src/admin-source-video-default-page-query.test.ts; count: 1; terms: fallback
- path: packages/admin-api/src/admin-source-video-status-page-query.test.ts; count: 1; terms: fallback

## Artifacts

- JSON: docs/acceptance/artifacts/admin-redundancy-governance-audit-20260626T211614Z.json
- Markdown: docs/acceptance/artifacts/admin-redundancy-governance-audit-20260626T211614Z.md
