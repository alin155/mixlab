...
Generated: 2026-06-29T01:06:29.442Z
...
- Live readonly: docs/acceptance/artifacts/admin-docker-release-live-readonly-20260628T225611Z.json
- Parity plan: docs/acceptance/artifacts/admin-docker-version-parity-plan-20260628T203710Z.json
- Worker proof: docs/acceptance/artifacts/admin-worker-env-proof-20260628T225559Z.json
...
- Release inputs intake: docs/acceptance/artifacts/admin-docker-nas-release-inputs-intake-20260628T225559Z.json
- NAS access preflight: docs/acceptance/artifacts/admin-docker-nas-access-preflight-20260628T225549Z.json
- NAS handoff kit: docs/acceptance/artifacts/admin-docker-nas-handoff-kit-latest.json
- Staging runbook: docs/acceptance/artifacts/admin-docker-staging-runbook-20260629T010621Z.json
...
- Staging ready: false; blockers: current-image-tag-provided, rollback-image-tag-provided, target-differs-from-current, rollback-tag-matches-current, image-push-explicitly-approved, release-inputs-ready-for-decision, current-tag-matches-release-inputs, target-tag-matches-release-inputs, rollback-tag-matches-release-inputs, nas-disk-proof-accepted, pre-staging-execution-blockers-carried-forward, parity-report-blockers-clear, worker-env-proof-accepted, cutter-compatibility-proof-accepted
...
- JSON: docs/acceptance/artifacts/admin-docker-release-readiness-summary-20260629T010629Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-release-readiness-summary-20260629T010629Z.md
