...
Generated: 2026-06-28T22:21:27.743Z
...
| --- | --- | --- | --- | --- | --- | --- |
| desktop_html | 200 | n/a | none | html | 4.7ms | none |
| verify_is_login | 200 | 1114 | Illegal operation, unauthorized user | object(no-keys) | 14.4ms | none |
| current_user | 200 | 1114 | Illegal operation, unauthorized user | object(no-keys) | 14ms | none |
| docker_app_uid | 200 | 200 | success | object(result) | 13.6ms | none |
| docker_container_list | 200 | 9405 | none | object(no-keys) | 27ms | none |
| docker_container_list_v2 | 200 | 200 | success | object(originalTotal,result,total) | 14.9ms | none |
| docker_overview | 200 | 1114 | Illegal operation, unauthorized user | object(no-keys) | 13ms | none |
| filemgr_share_list | 200 | 1114 | Illegal operation, unauthorized user | object(no-keys) | 13.7ms | none |
| machine_common | 200 | 1114 | Illegal operation, unauthorized user | object(no-keys) | 13.1ms | none |
...
- JSON: docs/acceptance/artifacts/admin-docker-nas-ugos-api-preflight-20260628T222127Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-nas-ugos-api-preflight-20260628T222127Z.md
