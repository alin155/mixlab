...
Generated: 2026-06-27T16:13:06.280Z
...
| --- | --- | --- | --- | --- | --- | --- | --- |
admin_web_root | web | http://127.0.0.1:5176 | GET / | 200 | yes | 25.7ms | none
auth_status | api | http://127.0.0.1:3889 | GET /api/admin/auth/status | 200 | yes | 42.6ms | none
library_status | api | http://127.0.0.1:3889 | GET /api/admin/library/status | 401 | no | 1.1ms | login_required
release_gates | api | http://127.0.0.1:3889 | GET /api/admin/release-gates | 401 | no | 0.7ms | login_required
...
candidate-admin-web-root | candidate-api | pass | no | yes | HTTP 200, ok, 25.7ms | GET / must return an Admin Web response from the candidate target.
candidate-current-admin-api-contract | candidate-api | blocked | yes | yes | auth=HTTP 200, ok, 42.6ms; release_gates=HTTP 401, login_required 请先登录管理端, 0.7ms; data_loading=HTTP 401, login_required 请先登录管理端, 0.5ms | Candidate must expose /api/admin/auth/status, /api/admin/release-gates, and /api/admin/data-loading/plan.
...
- JSON: docs/acceptance/artifacts/admin-docker-candidate-contract-proof-20260627T161306Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-candidate-contract-proof-20260627T161306Z.md
