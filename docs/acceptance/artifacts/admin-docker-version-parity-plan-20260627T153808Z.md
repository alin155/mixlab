...
Generated: 2026-06-27T15:38:08.851Z
...
- Artifact: docs/acceptance/artifacts/admin-docker-release-live-readonly-20260627T153801Z.json
- Target: http://192.168.1.27:9999/desktop
- Normalized target: http://192.168.1.27:9999/desktop
- Target kind: nas-desktop-url
- Target safe to probe: no
...
- Live target: nas-desktop-url, safe=no
...
- Upload blockers: live-artifact-targeted, admin-web-root-observed, admin-api-proxy-observed, current-admin-api-contract-parity, version-health-parity-contract, admin-worker-env-proof-contract, cutter-compatibility-proof-contract, docker-library-root-parity, admin-worker-env-external-proof, cutter-compatibility-external-proof
...
live-artifact-targeted | live-evidence | blocked | yes | The source live-readonly artifact used a target that is not safe admin-web evidence: http://192.168.1.27:9999/desktop (nas-desktop-url). | Run MIXLAB_ADMIN_DOCKER_LIVE_BASE_URL=<target> npm run validate:admin-docker-release-live-readonly before parity planning.
...
- JSON: docs/acceptance/artifacts/admin-docker-version-parity-plan-20260627T153808Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-version-parity-plan-20260627T153808Z.md
