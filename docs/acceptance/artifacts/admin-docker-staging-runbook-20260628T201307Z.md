...
Generated: 2026-06-28T20:13:07.523Z
...
- Worker env proof: docs/acceptance/artifacts/admin-worker-env-proof-20260628T200807Z.json
- Cutter compatibility proof: docs/acceptance/artifacts/admin-cutter-compatibility-proof-20260627T194754Z.json
- Release inputs: docs/acceptance/artifacts/admin-docker-release-inputs-20260628T201259Z.json
- NAS disk proof: docs/acceptance/artifacts/admin-docker-nas-disk-proof-20260628T200807Z.json
...
- GitHub candidate image tag: f9aa9bc7dea187dc3029c90389d5c3c08938dd58
- GitHub candidate build sha: f9aa9bc7dea187dc3029c90389d5c3c08938dd58
...
local-docker-smoke-passed | evidence | pass | no | no | local_smoke_passed=false, github_candidate_artifact_ready=true, image_tag=f9aa9bc7dea187dc3029c90389d5c3c08938dd58 | Run validate:admin-docker-local-smoke on a Docker-capable machine, or archive an Admin Docker GitHub artifact readiness report with github_candidate_artifact_ready=true before staging.
target-tag-matches-smoked-image | input | blocked | yes | yes | target=missing, smoked_image_tag=f9aa9bc7dea187dc3029c90389d5c3c08938dd58 | Set MIXLAB_DOCKER_TARGET_IMAGE_TAG to the exact image tag from the accepted local smoke or GitHub candidate artifact.
...
- JSON: docs/acceptance/artifacts/admin-docker-staging-runbook-20260628T201307Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-staging-runbook-20260628T201307Z.md
