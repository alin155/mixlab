...
Generated: 2026-06-28T20:38:48.016Z
...
- Admin Docker local smoke: .local-dev/admin-docker-github-runs/28335143445/mixlab-admin-docker-release-gates/admin-docker-local-smoke-20260628T203603Z.json
- Admin Docker candidate contract proof: .local-dev/admin-docker-github-runs/28335143445/mixlab-admin-docker-release-gates/admin-docker-candidate-contract-proof-20260628T203710Z.json
- Admin Docker live read-only probe: .local-dev/admin-docker-github-runs/28335143445/mixlab-admin-docker-release-gates/admin-docker-release-live-readonly-20260628T203710Z.json
- Admin Docker version parity plan: .local-dev/admin-docker-github-runs/28335143445/mixlab-admin-docker-release-gates/admin-docker-version-parity-plan-20260628T203710Z.json
- Admin worker env proof: .local-dev/admin-docker-github-runs/28335143445/mixlab-admin-docker-release-gates/admin-worker-env-proof-20260628T203711Z.json
- Cutter compatibility proof: .local-dev/admin-docker-github-runs/28335143445/mixlab-admin-docker-release-gates/admin-cutter-compatibility-proof-20260628T203711Z.json
- Admin Docker NAS release-inputs intake: .local-dev/admin-docker-github-runs/28335143445/mixlab-admin-docker-release-gates/admin-docker-nas-release-inputs-intake-20260628T203810Z.json
- Admin Docker staging runbook: .local-dev/admin-docker-github-runs/28335143445/mixlab-admin-docker-release-gates/admin-docker-staging-runbook-20260628T203811Z.json
- Admin Docker release readiness summary: .local-dev/admin-docker-github-runs/28335143445/mixlab-admin-docker-release-gates/admin-docker-release-readiness-summary-20260628T203811Z.json

## Observations

- Local smoke: accepted, passed=true
- Smoked image tag: 25fe2264de7b391a56e770a8acb6bf40ebec3863
- Smoked build sha: 25fe2264de7b391a56e770a8acb6bf40ebec3863
- Candidate: ready-for-candidate-review, ready=true
- Candidate source: local-smoke-report, local_smoke_passed=true
- Candidate observed image tag: 25fe2264de7b391a56e770a8acb6bf40ebec3863
- Target image tag: 25fe2264de7b391a56e770a8acb6bf40ebec3863
...
| artifact-admin-docker-local-smoke-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28335143445/mixlab-admin-docker-release-gates/admin-docker-local-smoke-20260628T203603Z.json |
| artifact-admin-docker-candidate-contract-proof-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28335143445/mixlab-admin-docker-release-gates/admin-docker-candidate-contract-proof-20260628T203710Z.json |
| artifact-admin-docker-release-live-readonly-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28335143445/mixlab-admin-docker-release-gates/admin-docker-release-live-readonly-20260628T203710Z.json |
| artifact-admin-docker-version-parity-plan-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28335143445/mixlab-admin-docker-release-gates/admin-docker-version-parity-plan-20260628T203710Z.json |
| artifact-admin-worker-env-proof-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28335143445/mixlab-admin-docker-release-gates/admin-worker-env-proof-20260628T203711Z.json |
| artifact-admin-cutter-compatibility-proof-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28335143445/mixlab-admin-docker-release-gates/admin-cutter-compatibility-proof-20260628T203711Z.json |
| artifact-admin-docker-nas-release-inputs-intake-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28335143445/mixlab-admin-docker-release-gates/admin-docker-nas-release-inputs-intake-20260628T203810Z.json |
| artifact-admin-docker-staging-runbook-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28335143445/mixlab-admin-docker-release-gates/admin-docker-staging-runbook-20260628T203811Z.json |
| artifact-admin-docker-release-readiness-summary-present | artifact | pass | yes | yes | yes | .local-dev/admin-docker-github-runs/28335143445/mixlab-admin-docker-release-gates/admin-docker-release-readiness-summary-20260628T203811Z.json |
...
| local-smoke-build-identity-current | candidate | pass | yes | yes | yes | image_tag=25fe2264de7b391a56e770a8acb6bf40ebec3863, build_sha=25fe2264de7b391a56e770a8acb6bf40ebec3863 |
...
| candidate-build-matches-smoke | candidate | pass | yes | yes | yes | candidate.image_tag=25fe2264de7b391a56e770a8acb6bf40ebec3863, smoke.image_tag=25fe2264de7b391a56e770a8acb6bf40ebec3863, candidate.build_sha=25fe2264de7b391a56e770a8acb6bf40ebec3863, smoke.build_sha=25fe2264de7b391a56e770a8acb6bf40ebec3863 |
| target-tag-matches-smoked-image | image | pass | yes | yes | yes | target=25fe2264de7b391a56e770a8acb6bf40ebec3863, smoke.image_tag=25fe2264de7b391a56e770a8acb6bf40ebec3863, runbook.target_tag_matches_local_smoke=true |
...
- JSON: docs/acceptance/artifacts/admin-docker-github-artifact-readiness-20260628T203848Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-github-artifact-readiness-20260628T203848Z.md
