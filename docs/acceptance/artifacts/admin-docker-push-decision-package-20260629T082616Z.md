...
Generated: 2026-06-29T08:26:16.287Z
...
- Readiness release-review blockers: none
...
image-tags-present | evidence | pass | yes | yes | yes | current=latest, target=9c015b9105e97954240020781f79daae3f954bde, rollback=latest
workflow-command-ready | release-decision | pass | yes | yes | yes | gh workflow run docker-admin.yml --repo alin155/mixlab --ref admin-docker-candidate-9c015b9105e97954240020781f79daae3f954bde -f push_images=true -f current_image_tag=latest -f rollback_image_tag=latest
...
staging-ready-for-release-decision | staging | pass | yes | yes | yes | staging_execution_ready=true, staging_review_ready=true, staging_execution_blockers=none
...
post-staging-proofs-remain-required | staging | pass | no | no | no | worker_proof_accepted=true, cutter_proof_accepted=true, staging_review_ready=true

## Next Actions

- Have the release owner review this package, the staging runbook, and release inputs before any workflow dispatch.
- If explicitly approved, run exactly: gh workflow run docker-admin.yml --repo alin155/mixlab --ref admin-docker-candidate-9c015b9105e97954240020781f79daae3f954bde -f push_images=true -f current_image_tag=latest -f rollback_image_tag=latest
...
- JSON: docs/acceptance/artifacts/admin-docker-push-decision-package-20260629T082616Z.json
- Markdown: docs/acceptance/artifacts/admin-docker-push-decision-package-20260629T082616Z.md
