...
| NAS access preflight | SSH/DSM/Docker TCP/`8080` 关闭；`18080`/`9999` 打开；SMB `/Volumes/MixLab` 已挂载但未发现 compose/.env 或 returned evidence；最新证据 `docs/acceptance/artifacts/admin-docker-nas-access-preflight-20260628T190321Z.json` | 当前只能做只读观测，不能直接从 Mac 收集 NAS Docker release inputs。 |
