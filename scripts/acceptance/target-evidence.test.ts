...
test("packages a standalone target evidence kit with drafts and collectors", async () => {
  ...
  try {
    ...
    assert.match(testerChecklist, /nas-disk-risk-carried-forward/);
    ...
    assert.match(adminDockerNasReleaseInputsCollectorScript, /nas-disk-risk-carried-forward/);
    ...
    assert.match(nasReadme, /nas-disk-risk-carried-forward/);
