...
const REQUIRED_FILES = [
  ...
  "scripts/acceptance/admin-docker-nas-disk-proof.ts",
  ...
  "scripts/acceptance/admin-docker-nas-access-preflight.ts",
...
const REQUIRED_SCRIPTS = [
  ...
  "validate:admin-docker-candidate-ref-proof",
  ...
  "preflight:admin-docker-nas-access",
...
function auditEvidenceAutomation(errors: string[]): void {
  ...
  requireText(
    ...
    "Admin Docker workflow must verify TypeScript, searchd, acceptance tooling, delivery readiness, evidence-kit manifest, draft metadata, packaged self-check, local Docker smoke, release-gate evidence reports, image build, NAS release-input intake, staging runbook, release readiness summary, and GitHub artifact readiness before publishing NAS images",
    errors
  );
  requireText(
    ".github/workflows/docker-admin.yml",
